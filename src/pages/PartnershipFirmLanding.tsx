...
// 6 Accordion FAQs (adapted from the Indian Partnership Act, 1932 framework)
const FAQ_ITEMS = [
  {
    q: 'Is registration of a Partnership Firm mandatory under Indian law?',
    a: 'No. Under the Indian Partnership Act, 1932, registration is optional. However, an unregistered firm cannot sue a third party or a fellow partner to enforce a contractual right, so registration is strongly recommended for legal protection and business credibility.'
  },
  {
    q: 'How many partners are required to form a Partnership Firm?',
    a: 'A Partnership Firm requires a minimum of 2 partners and can have a maximum of 20 partners, as prescribed under the Indian Partnership Act, 1932 read with the Companies Act, 2013.'
  },
  {
    q: 'How is income tax calculated and paid for a Partnership Firm?',
    a: 'Unlike a Sole Proprietorship, a Partnership Firm is taxed as a separate entity at a flat rate of 30% plus applicable surcharge and cess under the Income Tax Act, 1961. Partner remuneration and interest on capital, within prescribed limits, are deductible business expenses.'
  },
  {
    q: 'Can a Partnership Firm be converted into an LLP or Private Limited Company later?',
    a: 'Yes, as your business grows, a Partnership Firm can be formally converted into a Limited Liability Partnership (LLP) or a Private Limited Company through the applicable conversion provisions, allowing partners to gain limited liability protection.'
  },
  {
    q: 'How long does the complete Partnership Firm registration take?',
    a: 'With our streamlined digital process at akshayb2bsolutions, deed drafting, PAN application, and Registrar of Firms filing are typically completed within 7 to 15 working days, subject to state Registrar processing timelines.'
  },
  {
    q: 'Does akshayb2bsolutions handle deed drafting and Registrar filing end-to-end?',
    a: 'Yes, our Noida-based compliance team drafts a legally sound partnership deed, prepares all supporting documents, files the application with the Registrar of Firms, and follows up until you receive your registration certificate.'
  }
];

// Related services cross-linking items — sourced from partnership-adjacent structures
const RELATED_SERVICES = [
  {
    title: 'Limited Liability Partnership (LLP)',
    desc: 'Hybrid structure combining partnership flexibility with limited liability protection for partners.',
  ...
  },
  {
    ...
    desc: 'The simplest single-owner business structure with minimal compliance and fast registration.',
  ...
  },
  {
    ...
    desc: 'Formal registration for charitable and private trusts under applicable state trust laws.',
    img: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=600&auto=format&fit=crop&q=80',
    price: '₹4,999'
  },
  {
    title: 'NGO Registration',
    desc: 'Society, Trust, or Section 8 structuring for non-profit and social welfare organizations.',
  ...
  },
  {
    ...
    desc: 'Protect your firm name, logo, and brand identity against trademark infringement.',
    img: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?w=600&auto=format&fit=crop&q=80',
    price: '₹1,499'
  },
  {
    title: 'Partnership Deed Modification',
    desc: 'Amend profit-sharing ratios, admit new partners, or update deed clauses with Registrar filing.',
...
export const PartnershipFirmLanding: React.FC<PartnershipFirmLandingProps> = ({
  ...
  const [businessType, setBusinessType] = useState('Partnership Firm');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Basic Package (₹2,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Partnership Firm Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Register your Partnership Firm at just{' '}
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  A Partnership Firm is a business entity formed when two or more individuals agree to share profits and responsibilities under a partnership deed, governed by the Indian Partnership Act, 1932. It combines low compliance overhead with shared capital, pooled expertise, and rapid Registrar of Firms certification to launch your collaborative venture legally.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>2-20 Partners Allowed</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Legal Deed Drafting</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Registrar of Firms Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based Partnership Firm specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                State jurisdiction determines the applicable Registrar of Firms and stamp duty on the deed.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete Partnership Deed drafting, PAN application, and Registrar of Firms resolution kit prepared with zero visit to government offices.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Authorized Partner PAN Number (Optional for quote)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              ...
                              >
                                <option value="Basic Package (₹2,999)">Basic Package — ₹2,999 (Deed + PAN + Registrar Filing)</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your Partnership Firm Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                All packages include verified deed drafting, Registrar of Firms filings, and direct Chartered Accountant support from our Noida headquarters.
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mb-6">
                    Essential statutory registration for two or more partners to commence trade.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Partnership Deed Drafting & Vetting',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Basic Package (₹2,999)');
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A Partnership Firm is a business entity formed when two or more individuals agree to share profits and responsibilities. It operates on the basis of a partnership deed, a legal document defining rights, duties, capital contribution, and profit-sharing ratios. In India, partnership firms are governed by the Indian Partnership Act, 1932, and remain a preferred choice for small and medium businesses due to their simplicity and minimal compliance requirements.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for co-founders, family businesses, professional consultancies, trading houses, and small manufacturing units seeking to pool capital and expertise without excessive statutory overheads.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A well-drafted partnership deed lets partners define capital contributions, profit-sharing ratios, and operational roles clearly, allowing the firm to adapt quickly to market changes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Because the firm has no separate legal identity from its partners, personal assets of every partner remain liable, jointly and severally, for commercial debts and contractual liabilities.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration under the Indian Partnership Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow partners in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Cannot raise venture capital equity or issue shares to the public, making partner contributions and debt finance the primary mechanisms for scaling operations.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, a Partnership Firm provides a collaborative launchpad for co-founders who value shared responsibility and combined expertise. The experienced team at akshayb2bsolutions ensures your firm launches on solid legal footing with a verified deed and Registrar credentials.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Partnership Firm Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Partnership Firm registration is the legal process of making a partnership official under the Indian Partnership Act, 1932. While not mandatory, registration gives the firm legal recognition and the ability to enforce contractual rights in court. The process involves submitting an application to the Registrar of Firms in the respective state, along with the partnership deed and other required documents.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              Once approved, the Registrar records the firm's details in the Register of Firms and issues a certificate of registration. Registered firms enjoy higher credibility with clients, banks, and vendors, which simplifies tasks such as opening a current bank account or applying for loans.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our Noida legal desk drafts a legally sound partnership deed, prepares all documentation with zero errors, and interfaces directly with the state Registrar of Firms to secure your certificate in record time.
              </p>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  desc: 'A registered firm can enforce agreements in court and sue clients, suppliers, or competitors for breach of contract or non-payment.'
                },
                {
                  title: 'Shared Capital & Combined Expertise',
                  desc: 'Partners pool resources, skills, and networks, enabling faster growth than a single-owner structure with minimal capital constraints.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Many government schemes and MSME incentives are available to registered firms, enabling growth with financial support.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Registering Your Partnership Firm
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique Firm Name Selection',
                ...
                {
                  title: 'Finalized Profit-Sharing Ratio Among Partners',
                  desc: 'Agree in advance on each partner\'s capital contribution and profit/loss sharing ratio to avoid disputes after registration.'
                },
                {
                  title: 'Valid Identity and Address Proofs of All Partners',
                  desc: 'Ensure every partner\'s PAN Card and Aadhaar Card details match identically and are linked to an active mobile number for OTP verification.'
                },
                {
                ...
                {
                  title: 'Draft Partnership Deed Clauses',
                  desc: 'Outline rules for admission, retirement, dissolution, and dispute resolution among partners within the deed itself.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Our compliance officers conduct a preliminary pre-audit of all partner details to eliminate discrepancies and guarantee first-time registration approval.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To register a Partnership Firm in India, there must be a minimum of two partners and a maximum of twenty. All partners must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The firm requires at least two partners to form, with a statutory ceiling of twenty partners under applicable Indian company law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Every partner must be 18 years or older, of sound mind, and not declared an undischarged insolvent under Indian insolvency laws.'
                },
                {
                  title: 'Unique Firm Name Requirement',
                  desc: 'The firm must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written Partnership Deed',
                  desc: 'A partnership deed must be prepared, clearly stating the nature of business, partner details, profit-sharing ratios, and individual responsibilities.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The firm must have a verifiable physical business address within Indian territorial jurisdiction.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a partnership.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates every partner\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your Partnership Firm registration smoothly, only basic identity, address, and premises ownership documents from each partner are needed. All documents are collected 100% digitally through our secure cloud portal.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: 'Aadhaar Card, Voter ID, or Passport of every partner linked to an active mobile number for digital OTP verification.'
                },
                {
                ...
                {
                  title: 'Signed Partnership Deed',
                  desc: 'A stamped and notarized partnership deed signed by all partners, detailing capital contribution and profit-sharing terms.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our legal drafting team prepares the deed, NOC drafts, and affidavits, ensuring document formatting matches Registrar of Firms parameters.'
                }
              ].map((item, idx) => (
              ...
              {[
                {
                  ...
                  desc: 'We prepare a written deed detailing partner names, profit-sharing ratio, business nature, capital contribution, and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Partners',
                  desc: 'Upload scanned copies of PAN, Aadhaar, business address proof, and photographs of every partner to our encrypted platform.'
                },
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique Firm Name',
                  desc: 'Our Noida legal team confirms name availability under state guidelines and checks it does not infringe existing trademarks.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to Registrar of Firms',
                  desc: 'We file Form 1, the stamped partnership deed, and supporting documents with the state\'s Registrar of Firms on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'Firm PAN Application & GST Registration',
                  desc: 'We apply for the firm\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive your verified registration certificate, deed copies, and bank kit to immediately open your current account.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  A partnership firm does not possess a separate legal personality distinct from its partners; the partners and the firm are treated as one collective legal entity under Indian law.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Compliance is restricted to active tax returns (GST and firm Income Tax) and deed amendment filings without mandatory MCA disclosures or board filings.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Partners bear joint and several liability for operational debts, commercial loans, supplier obligations, and damages resulting from legal suits against the firm.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on liability safeguards, deed drafting, partner exit clauses, and help you recognize the optimal milestone to convert into an LLP or Private Limited Company as turnover expands.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, partnership firms must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Firm PAN & GST Registration',
                  desc: 'Apply for a Permanent Account Number (PAN) in the firm\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a current bank account for conducting business transactions in the registered firm name.'
                },
                {
                  title: 'Annual Firm Income Tax Return',
                  desc: 'File the firm\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                  title: 'Report Changes to the Registrar of Firms',
                  desc: 'Report any changes in the partnership deed, such as admission, retirement, or removal of a partner, to the Registrar of Firms.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the firm employs staff.'
                },
                {
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-slate-900 border-r border-slate-200">
                      Co-Founders, Family &amp; Traditional Trades
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for Partnership Firms in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Partnership firms are taxed as separate entities under the Income Tax Act, 1961. The current income tax rate for firms is a flat 30% plus applicable surcharge and cess — distinct from the personal slab rates applied to a Sole Proprietorship.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Flat 30% Firm-Level Tax Rate',
                  desc: 'Net business profits of the firm are taxed at a flat 30% rate plus applicable surcharge and cess, regardless of the amount of profit earned.'
                },
                {
                  title: 'Partner Profit Share is Tax-Exempt',
                  desc: 'A partner\'s share of profit is exempt from tax in their personal hands, since it has already been taxed at the firm level.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working partners are taxable in the partner\'s hands but deductible for the firm, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Firms must maintain proper accounts and undergo a mandatory tax audit if turnover exceeds the specified limits under Section 44AB.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our in-house Chartered Accountants review your business expenses and structure partner remuneration to maximize legitimate deductions.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              While partnership firms cannot issue equity shares to external investors, partner capital contributions combined with a wide variety of debt financing and government-sponsored schemes are available to fund growth.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Additional Partner Capital Contribution',
                  desc: 'Admit new partners or increase existing capital contributions per the amended partnership deed to raise growth capital.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Access working capital loans and secured overdraft facilities from commercial banks against trade turnover and partner collateral.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'External venture capital and angel funding are restricted; partners planning institutional rounds should convert to an LLP or Private Limited Company.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound partnership deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                  title: 'Direct Liaison & Registrar Follow-Ups',
                  desc: 'We manage all interactions with the state Registrar of Firms, GST authorities, and local licensing bodies, resolving queries proactively.'
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your Partnership Firm with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their partnership firm with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
