...
// 6 Accordion FAQs (adapted from the Indian OPC Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is a One Person Company (OPC) in India?', a: 'A One Person Company is a company structure under the Companies Act, 2013 that allows a single eligible individual to form a company with limited liability and a separate legal identity, while nominating another eligible person to step in on death or incapacity.' },
  { q: 'Who can register an OPC?', a: 'An eligible natural person can incorporate a One Person Company subject to the conditions prescribed under the Companies Act and applicable rules. The proposed member and nominee must satisfy the current eligibility requirements.' },
  { q: 'Is a nominee mandatory for OPC registration?', a: 'Yes. An OPC must name a nominee with prior consent. The nominee is intended to become the member if the sole member dies or becomes incapable of contracting, subject to applicable filing requirements.' },
  { q: 'What documents are generally required?', a: 'Typical documents include PAN and identity/address proof of the sole member and nominee, photographs, registered-office proof, NOC where applicable, business-object details and incorporation documents such as MOA and AOA.' },
  { q: 'Can an OPC be converted into a private or public company?', a: 'Yes. Under the current MCA framework, an OPC may convert into a private or public company by meeting the applicable member/director and filing requirements. Earlier mandatory turnover and paid-up-capital thresholds were removed by the 2021 amendment.' },
  { q: 'What is included in the ₹1,999 package?', a: 'The package includes OPC incorporation guidance, name and document review, incorporation-document support, nominee documentation guidance, MCA filing coordination and post-incorporation basic guidance. Government fees and other statutory charges are separate.' }
]

// Related services cross-linking items — sourced from OPC-adjacent structures
const RELATED_SERVICES = [
  { title: 'Private Limited Company Registration', desc: 'Incorporate a private limited company with professional documentation and MCA filing support.', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'LLP Registration', desc: 'Set up a Limited Liability Partnership with structured incorporation and compliance support.', img: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Sole Proprietorship Registration', desc: 'Start a simple owner-led business structure with applicable registration and setup guidance.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'GST Registration', desc: 'Get GST registration support for eligible businesses with documentation and application guidance.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible micro, small and medium enterprises in India.', img: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Trademark Registration', desc: 'Protect your company name, logo and brand identity through trademark registration support.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Company PAN & TAN Support', desc: 'Get post-incorporation guidance for company tax identifiers and related documentation.', img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Company Compliances', desc: 'Ongoing compliance support for annual filings, registers, resolutions and other company obligations.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Company Address Change', desc: 'Professional support for changing the registered office of a company with applicable MCA filings.', img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80', price: 'View Service' }
]
...
export const OPCLanding: React.FC<OPCLandingProps> = ({
  ...
  const [businessType, setBusinessType] = useState('One Person Company');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('OPC Registration Package (₹1,999 + Govt. Feess)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">One Person Company Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India MCA Company Registration Desk</span>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  One Person Company Registration in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an OPC may be registered as a One Person Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Single Member Company</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Handshake className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Mandatory Nominee Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Limited Liability Structure</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                ...
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <h3 className="text-xl font-bold text-slate-900">OPC Registration Request Received!</h3>
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our company-registration specialist has been assigned to your OPC incorporation request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of One Person Company Registration *
                              </label>
                              <select
                                value={selectedState}
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get name and document review, nominee-document guidance, MOA/AOA support, MCA incorporation filing coordination and post-registration basics in one clear process.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Sole Member / Director Full Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Sole Member PAN Number (Optional for quote)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select One Person Company Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="One Person Company Registration Package (₹2,999)">One Person Company Registration Package — ₹2,999 + Govt. Feess</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One complete OPC incorporation support package for solo entrepreneurs who want limited liability, corporate credibility and a clean MCA setup.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">OPC Registration Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Built for individual founders who want to register a company without adding a second shareholder.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      ...
                      'Company Name Availability Review',
                      'Nominee Documentation Guidance',
                      'Dedicated OPC Registration Specialist'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('OPC Registration Package (₹1,999 + Govt. Feess)');
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              An OPC gives a solo entrepreneur a separate corporate identity while allowing one person to remain the sole member. The company is governed by its MOA, AOA, Companies Act requirements and the applicable MCA rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Properly drafted MOA, AOA, or company rules clearly define the OPC's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The legal identity and liability framework depends on whether the OPC is formed as a One Person Company; the governing documents and applicable law determine the responsibilities of members, trustees, directors, and office bearers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration under the Indian OPC Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow member / nominee in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An OPC is not formed for distributing profits to members. Eligible organizations can pursue donations, grants, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, OPC registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How One Person Company Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              OPC incorporation is completed through the MCA framework using prescribed incorporation forms, KYC documents, nominee details, registered-office proof, MOA/AOA and other required declarations.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the OPC Certificate of Incorporation or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of One Person Company
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'The OPC is a separate legal entity, helping keep the owner’s personal liability generally limited to the extent permitted by law.'
                },
                {
                  title: '100% Ownership & Control',
                  desc: 'Run the company as the sole member while enjoying the structure and credibility of a registered company.'
                },
                {
                  title: 'Separate Legal Identity',
                  desc: 'The company can own assets, enter contracts and operate in its own legal name, distinct from the individual member.'
                },
                {
                  title: 'Higher Business Credibility',
                  desc: 'A registered company structure can improve confidence with clients, banks, vendors and enterprise customers.'
                },
                {
                  title: 'Easy Continuity through Nominee',
                  desc: 'The nominee mechanism helps provide continuity if the sole member dies or becomes incapable of contracting.'
                },
                {
                  title: 'Future Conversion Flexibility',
                  desc: 'An OPC can be converted into a private or public company by meeting the applicable MCA requirements when the business grows.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Choose a Strong Company Name',
                  desc: 'Keep suitable name options ready and avoid names that conflict with existing companies, trademarks or restricted expressions.'
                },
                {
                  title: 'Confirm Sole Member Eligibility',
                  desc: 'Ensure the proposed sole member meets the current eligibility conditions applicable to OPC incorporation.'
                },
                {
                  title: 'Select an Eligible Nominee',
                  desc: 'Choose a nominee who is willing and eligible to act, and obtain the prescribed consent and supporting documents.'
                },
                {
                  title: 'Define Business Objects',
                  desc: 'Clearly describe the main business activities so the MOA objects reflect what the company intends to do.'
                },
                {
                  title: 'Prepare Registered Office Proof',
                  desc: 'Keep recent utility bill, ownership proof or rent agreement and NOC ready where applicable.'
                },
                {
                  title: 'Arrange DSC & Director Details',
                  desc: 'Digital-signature and director-related details are needed for electronic MCA incorporation filing.'
                },
                {
                  title: 'Finalize Capital Structure',
                  desc: 'Decide authorised and subscribed capital based on your business requirements and applicable filing/stamp-duty implications.'
                },
                {
                  title: 'Review All KYC Before Filing',
                  desc: 'Check PAN, Aadhaar/address details, names and dates carefully to reduce avoidable resubmission or clarification.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To register a OPC in India, there must be a minimum of two member / nominee and a maximum of twenty. All member / nominee must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Single Eligible Individual Member',
                  desc: 'OPC is designed for one eligible natural person who becomes the sole member of the company.'
                },
                {
                  title: 'Nominee Required',
                  desc: 'A nominee with prior consent must be identified for continuity in the event of death or incapacity of the sole member.'
                },
                {
                  title: 'One or More Directors',
                  desc: 'The sole member can also be the director, subject to the minimum and maximum director requirements under company law.'
                },
                {
                  title: 'Valid Indian Registered Office',
                  desc: 'The company must maintain a registered-office address in India with acceptable supporting proof.'
                },
                {
                  title: 'Lawful Business Objects',
                  desc: 'The proposed business activity must be lawful and compatible with the OPC structure and applicable sectoral rules.'
                },
                {
                  title: 'Unique Company Name',
                  desc: 'The proposed name must satisfy MCA naming rules and should not conflict with existing companies or trademarks.'
                },
                {
                  title: 'Current MCA Rules Apply',
                  desc: 'Older mandatory paid-up-capital and turnover conversion thresholds were removed; current incorporation and conversion rules should be followed.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your OPC registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'PAN & Identity Proof of Sole Member',
                  desc: 'PAN and accepted identity proof of the proposed sole member/director.'
                },
                {
                  title: 'Address Proof of Sole Member',
                  desc: 'Recent address proof such as Aadhaar, voter ID, passport, driving licence or other accepted document as applicable.'
                },
                {
                  title: 'Nominee KYC & Consent',
                  desc: 'Identity/address documents and prescribed consent of the proposed nominee.'
                },
                {
                  title: 'Registered Office Proof',
                  desc: 'Recent utility bill plus ownership proof or rent agreement and NOC where the premises are not owned by the company/member.'
                },
                {
                  title: 'Business Objects & Name Options',
                  desc: 'Proposed company names and a clear description of the main business activities.'
                },
                {
                  title: 'Incorporation Documents',
                  desc: 'MOA, AOA, declarations, consent forms and other attachments required for MCA incorporation filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  title: 'Name & Eligibility Review',
                  desc: 'We review the proposed company name, sole-member details, nominee eligibility and business objects.'
                },
                {
                  title: 'DSC & Incorporation Preparation',
                  desc: 'Prepare the required digital-signature and incorporation information for electronic MCA filing.'
                },
                {
                  title: 'Nominee & KYC Documentation',
                  desc: 'Collect and verify sole-member, director, nominee and registered-office documents.'
                },
                {
                  title: 'MOA / AOA & Filing Preparation',
                  desc: 'Draft the incorporation documents and prepare the MCA filing with the selected business objects and capital details.'
                },
                {
                  title: 'MCA / ROC Submission & Follow-Up',
                  desc: 'Submit the incorporation application and coordinate responses if the Registrar raises clarification or resubmission requirements.'
                },
                {
                  title: 'Certificate & Post-Incorporation Guidance',
                  desc: 'After approval, receive the Certificate of Incorporation and proceed with PAN/TAN, bank-account and applicable post-incorporation actions.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Status of a One Person Company
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an OPC depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the OPC structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a sole member\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate OPC structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the OPC\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered OPC name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual OPC Compliance & Tax Filing',
                  desc: 'File the OPC\'s annual tax return at the applicable corporate income-tax rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the OPC employs staff.'
                },
                {
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Member / Nominee
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Member / Nominee</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on OPC structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Member / Nominee
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              OPC tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Corporate Tax Treatment',
                  desc: 'An OPC is taxed as a company under the applicable Income-tax framework rather than as a sole proprietorship.'
                },
                {
                  title: 'Books & Financial Statements',
                  desc: 'Maintain proper books of account and prepare company financial statements as required under the Companies Act.'
                },
                {
                  title: 'Annual MCA Filings',
                  desc: 'File applicable annual returns and financial statements with the Registrar within prescribed timelines.'
                },
                {
                  title: 'Income-Tax Return',
                  desc: 'File the company’s income-tax return and comply with applicable tax-audit, TDS and other requirements based on facts.'
                },
                {
                  title: 'GST & Other Registrations',
                  desc: 'Take GST, professional tax, shops-and-establishment or sector-specific registrations where applicable.'
                },
                {
                  title: 'Director & Company Records',
                  desc: 'Maintain statutory registers, resolutions, director disclosures and other corporate records required for ongoing compliance.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
              ...
              {[
                {
                  ...
                  desc: 'Operate through a dedicated company bank account for cleaner accounting and stronger financial discipline.'
                },
                {
                  title: 'Loans & Working Capital',
                  desc: 'A company structure can support discussions with banks and lenders, subject to creditworthiness and lender policies.'
                },
                {
                  title: 'Enterprise Client Onboarding',
                  desc: 'Many larger clients prefer dealing with incorporated entities for contracts, vendor registration and procurement.'
                },
                {
                  title: 'Reinvest Profits into Growth',
                  desc: 'Use company profits for hiring, marketing, technology, inventory or expansion subject to corporate and tax rules.'
                },
                {
                  title: 'Convert When You Need More Owners',
                  desc: 'If you later want additional shareholders or a broader company structure, conversion can be considered under current MCA rules.'
                },
                {
                  title: 'Build a Long-Term Corporate Brand',
                  desc: 'Use the OPC structure as a foundation for contracts, intellectual property, vendor relationships and future expansion.'
                },
                {
                  title: 'Bring in Investors After Restructuring',
                  desc: 'OPC itself has a single-member structure, so external equity investment generally requires an appropriate restructuring or conversion first.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-slate-200">
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your member / nominee\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound OPC deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your member / nominee\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Turn Your Solo Business into a Real Company
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their OPC with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
