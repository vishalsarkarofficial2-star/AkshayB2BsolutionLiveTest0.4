...
const FAQ_ITEMS = [
  { q: 'What is NGO Registration in India?', a: 'NGO registration is the legal process of establishing a non-governmental organization under an appropriate structure such as a Society, Trust, or Section 8 Company. Registration gives the organization legal recognition and helps it operate, open a bank account, enter agreements, and seek eligible grants or donations.' },
  { q: 'Which types of NGO can be registered in India?', a: 'Common structures include Society Registration, Trust Registration, and Section 8 Company Registration. The suitable structure depends on the NGO objectives, members, governance model, and compliance requirements.' },
  { q: 'What documents are generally required for NGO registration?', a: 'Typical documents include the proposed NGO name, PAN and identity/address proofs of founders or trustees, registered-office address proof, NOC where applicable, photographs, and the applicable MOA, Trust Deed, or Society Rules.' },
  { q: 'How long does NGO registration take?', a: 'The timeline depends on the NGO structure, state, government verification, and document readiness. A practical estimate can range from a few weeks to around 30–45 days, subject to the relevant authority.' },
  { q: 'Can a registered NGO apply for 12A and 80G?', a: 'Eligible NGOs can apply for tax-exemption and donor-benefit registrations such as 12A/12AB and 80G, subject to the applicable Income Tax rules and approval requirements.' },
  { q: 'Can an NGO receive foreign donations?', a: 'An NGO generally needs to meet the applicable eligibility and compliance requirements and obtain FCRA registration or prior permission before receiving foreign contributions under Indian law.' }
]
...
const RELATED_SERVICES = [
  {
    ...
    desc: 'Register a charitable or public trust with professionally prepared trust deed and filing support.',
    img: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=600&auto=format&fit=crop&q=80',
    price: '₹4,999'
  },
  {
    title: 'Society Registration',
    desc: 'Set up a society for charitable, educational, cultural, or social-welfare activities in India.',
    img: 'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=600&auto=format&fit=crop&q=80',
    price: '₹4,999'
  },
  {
    title: 'Section 8 Company Registration',
    desc: 'Create a not-for-profit company structure for charitable and social-impact objectives.',
    img: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=600&auto=format&fit=crop&q=80',
    price: '₹9,999'
  },
  {
    title: '12A & 80G Registration',
    desc: 'Tax-exemption and donor-benefit registration support for eligible charitable organizations.',
    img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80',
    price: '₹4,999'
  },
  {
    title: 'NGO Darpan Registration',
    desc: 'Government NGO Darpan registration support to help eligible NGOs access government opportunities.',
    img: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=600&auto=format&fit=crop&q=80',
    price: '₹1,999'
  },
  {
    title: 'CSR-1 Registration',
    desc: 'CSR-1 registration assistance for eligible NGOs seeking to participate in CSR implementation.',
    img: 'https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=600&auto=format&fit=crop&q=80',
    price: '₹2,999'
  },
  {
    title: 'FCRA Registration',
    desc: 'Compliance and application support for eligible organizations seeking foreign contribution approval.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: '₹9,999'
  },
  {
    title: 'MSME Udyam Registration',
    desc: 'Udyam registration support for eligible activities and organizations requiring MSME recognition.',
    img: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?w=600&auto=format&fit=crop&q=80',
    price: '₹499'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your NGO name, logo, and brand identity through trademark registration support.',
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">NGO Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  NGO Registration in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an NGO may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based NGO specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of NGO Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The applicable registration authority and documentation depend on whether your NGO is formed as a Society, Trust, or Section 8 Company.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete NGO name-check, MOA / Trust Deed / Society Rules drafting, government filing support, and registration guidance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select NGO Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="NGO Registration Package (₹2,999)">NGO Registration Package — ₹2,999 + Govt. Fees</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your NGO Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional NGO registration guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      ...
                      'Basic NGO Name Availability Check',
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Properly drafted MOA, Trust Deed, or Society Rules clearly define the NGO's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The legal identity and liability framework depends on whether the NGO is formed as a Society, Trust, or Section 8 Company; the governing documents and applicable law determine the responsibilities of members, trustees, directors, and office bearers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration under the Indian NGO Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow members / trustees in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An NGO is not formed for distributing profits to members. Eligible organizations can pursue donations, grants, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How NGO Registration Works in India
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Legal recognition helps the NGO operate through a defined legal structure, enter agreements, maintain records, and pursue its stated charitable or social objectives.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Get professional documentation and registration support with transparent professional fees; the final timeline depends on NGO structure, state, authority, and government verification.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible NGOs may access government schemes, grants, CSR opportunities, and donor programs subject to the relevant eligibility and compliance requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Registering Your NGO
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique NGO Name Selection',
                ...
                {
                  title: 'Clearly Defined NGO Objectives and Governance',
                ...
                },
                {
                  ...
                  desc: 'Clearly state the NGO objectives, governance, membership or trusteeship, powers, duties, meetings, accounts, and dissolution provisions in the governing document.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: 'The applicable governing document signed/executed by the required founders, trustees, members, or directors, covering NGO objectives and governance rules.'
                },
                {
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Draft MOA / Trust Deed / Society Rules',
                  desc: 'We prepare the appropriate governing document detailing the NGO objectives, founders/trustees, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                ...
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique NGO Name',
                  desc: 'Our team helps check the proposed NGO name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped NGO deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the NGO\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the NGO registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the NGO bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                NGO vs Other Business Structures
              </h2>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for NGOs in India
              </h2>
            </div>
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your NGO with Confidence
            </h2>
