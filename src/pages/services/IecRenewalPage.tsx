...
// 6 Accordion FAQs (adapted from the DGFT IEC Profile Management framework)
const FAQ_ITEMS = [
  { q: 'What is IEC Renewal in India?', a: 'IEC Renewal commonly refers to the annual online update or confirmation of Importer Exporter Code details on the DGFT portal. IEC holders should keep their profile current so the code remains ready for import-export transactions and DGFT services.' },
  { q: 'Is IEC renewal required every year?', a: 'DGFT requires IEC holders to update or confirm their IEC details electronically every year during the April-June period, even when there is no change in the particulars.' },
  { q: 'What happens if IEC details are not updated?', a: 'An IEC that is not updated as required may be deactivated by DGFT. Updating the IEC profile can help restore or maintain active status, subject to portal validation and applicable DGFT rules.' },
  { q: 'What documents are generally needed for IEC Renewal?', a: 'The exact requirement depends on the changes being made. Commonly required information may include IEC/PAN details, firm information, registered address, bank details, email/mobile access and supporting proof where a modification is requested.' },
  { q: 'Can IEC details be modified during renewal?', a: 'Yes. If business details have changed, the IEC profile can be updated with the revised information and supporting documents as required. If there is no change, the existing details can be confirmed online.' },
  { q: 'How long does IEC Renewal take?', a: 'Straightforward annual confirmation can often be completed quickly after documents and portal access are ready. Cases involving modifications, validation issues or reactivation may take longer depending on DGFT processing and verification.' }
]
...
const RELATED_SERVICES = [
  {
    ...
    desc: 'Apply for a fresh Importer Exporter Code for starting import or export business in India.',
  ...
  },
  {
    ...
    desc: 'Register your bank AD Code with customs for export shipping bill processing and port transactions.',
    img: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'RCMC Registration',
    desc: 'Get Registration-Cum-Membership Certificate support for eligible exporters and export promotion benefits.',
    img: 'https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration assistance for businesses engaged in domestic and international trade.',
    img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'LUT Filing',
    desc: 'File Letter of Undertaking for eligible export of goods or services without payment of IGST.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your export brand name and logo with trademark application support in India.',
  ...
  },
  {
    ...
    desc: 'Compliance guidance for exporters and importers dealing with DGFT, customs and documentation requirements.',
    img: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Digital Signature Certificate',
    desc: 'DSC assistance for businesses that need secure digital signing for government and trade filings.',
    img: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  }
]

export const IecRenewalPage: React.FC<IecRenewalPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Exporter / Importer');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('IEC Renewal Package (₹1,250)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">IEC Renewal</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Professional assistance package • DGFT charges, if any, extra
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  IEC Renewal is the annual DGFT update or confirmation of your Importer Exporter Code details. Keeping the IEC profile current helps exporters and importers maintain active status, access DGFT services and avoid unnecessary disruption in trade documentation.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Annual IEC Update Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <RotateCcw className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>DGFT Profile Verification</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>IEC Update / Reactivation</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our IEC compliance specialist has been assigned to your renewal request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Select the state where your business is registered. Our team will verify your IEC profile and guide you through the annual DGFT update or modification process.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why renew with akshayb2bsolutions?</span>
                              </div>
                              <p className="text-[11px]">
                                Get IEC status review, profile verification, annual confirmation or modification assistance, DGFT submission support and follow-up with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              ...
                              >
                                <option value="IEC Renewal Package (₹1,250)">IEC Renewal Package — ₹1,250</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'post-compliance', label: 'After Renewal' },
                { id: 'comparison', label: 'IEC vs Related Services' },
                { id: 'tax-implications', label: 'Trade & Tax Notes' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your IEC Renewal Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One simple package for IEC annual update/confirmation, profile verification, DGFT filing assistance and support for modifications or reactivation where applicable.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    ...
                    <span className="px-3 py-1 rounded bg-yellow-100 text-yellow-900 text-[10px] font-black uppercase tracking-wide">
                      IEC COMPLIANCE SUPPORT
                    </span>
                  </div>

                  <h3 className="text-2xl font-bold text-[#0D47A1]">Basic Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for existing IEC holders who need annual confirmation, profile update or assistance restoring active IEC status.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-lg text-slate-400 line-through">₹1,999</span>
                      <span className="text-4xl font-extrabold text-[#0D47A1]">₹1,250</span>
                    </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'IEC Status & Profile Review',
                      'Annual IEC Details Confirmation',
                      'IEC Update / Reactivation Support',
                      'Business & Contact Details Verification',
                      'Bank / Branch Details Update Guidance',
                      'Dedicated IEC Renewal Specialist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('IEC Renewal Package (₹1,250)');
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is IEC Renewal in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              IEC Renewal commonly means updating or confirming the details of an existing Importer Exporter Code on the DGFT portal. It is meant for businesses that already hold an IEC and want to keep their profile accurate, current and ready for import-export activity.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for exporters, importers, manufacturers, traders, service exporters and businesses that already hold an IEC and need annual confirmation, profile modification or reactivation support.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Your IEC profile should reflect the correct firm name, address, contact details, branch information and other particulars available on the DGFT portal.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  IEC is linked to the PAN of the business/entity and is used as the primary importer-exporter identification for DGFT related trade services.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Annual IEC update/confirmation is important because DGFT has prescribed periodic electronic updation of IEC details, and non-updated IECs may face deactivation under applicable rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  If your business details have changed, the renewal process can also be used to update relevant IEC particulars so your DGFT profile remains aligned with current business records.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In short, IEC Renewal helps keep your import-export profile compliant and current. Our team assists with profile review, annual confirmation, modifications, reactivation guidance and DGFT submission support.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How IEC Renewal Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              IEC holders are required to periodically confirm or update their details electronically on the DGFT portal. The exact steps depend on whether the existing information is unchanged or needs modification.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              Once the update is submitted successfully, the IEC profile reflects the current particulars subject to DGFT validation. If an IEC was deactivated for non-updation, the required update can support reactivation as per applicable DGFT process.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#0B3D91] flex items-center gap-1.5">
                ...
                <span>How akshayb2bsolutions Streamlines Your IEC Renewal:</span>
              </h4>
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk reviews your IEC profile, checks the information to be confirmed or changed, assists with supporting documents and guides the online DGFT submission from start to finish.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Benefits of Timely IEC Renewal
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Maintain Active IEC Status',
                  desc: 'Keep your IEC profile current and reduce the risk of disruption caused by non-updation or deactivation.'
                },
                {
                  title: 'Smooth Import-Export Operations',
                  desc: 'An updated IEC supports smoother access to DGFT-linked trade processes and exporter/importer documentation.'
                },
                {
                  title: 'Fast Online Assistance',
                  desc: 'Get professional support for annual confirmation or IEC modification with a simple digital process and transparent pricing.'
                },
                {
                  title: 'Keep Business Details Accurate',
                  desc: 'Update changes in business particulars so your DGFT IEC profile matches your current records.'
                },
                {
                  title: 'Avoid Last-Minute Compliance Issues',
                  desc: 'Timely IEC confirmation helps reduce avoidable compliance delays when you need the code for trade-related work.'
                },
                {
                  title: 'Dedicated Renewal Support',
                  desc: 'Get guided support for IEC update, modification and reactivation queries from a dedicated compliance specialist.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Renewing Your IEC
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Keep Existing IEC Details Ready',
                  desc: 'Keep your IEC number, PAN-linked business details and current DGFT profile information available for verification.'
                },
                {
                  title: 'Check Firm & Contact Information',
                  desc: 'Review firm name, address, email, mobile number and other profile details before submitting the annual update.'
                },
                {
                  title: 'Identify Any Changes Before Filing',
                  desc: 'Confirm whether any IEC particulars need modification or whether the existing details can simply be confirmed.'
                },
                {
                  title: 'Keep PAN & KYC Details Consistent',
                  desc: 'Ensure PAN-linked entity details and authorized contact information are consistent with the records used for DGFT access.'
                },
                {
                  title: 'Updated Address Proof if Modified',
                  desc: 'If the registered address is being changed, keep suitable supporting address documents ready for the modification request.'
                },
                {
                  title: 'Review Existing IEC Status',
                  desc: 'Review bank or branch-related particulars in the IEC profile and arrange supporting documents if an update is required.'
                },
                {
                  title: 'DGFT Login / Verification Access',
                  desc: 'Keep access to the registered mobile/email or other required verification method available for the online process.'
                },
                {
                  title: 'akshayb2bsolutions Verification Role',
                  desc: 'Our compliance team reviews the available IEC information and flags likely discrepancies before the DGFT submission.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for IEC Renewal
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              IEC Renewal is meant for businesses or entities that already hold an IEC. The IEC should be linked to valid PAN-based entity details, and the authorized person should have access to the information required for DGFT verification.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Existing IEC Holder',
                  desc: 'The applicant should already have an IEC issued for the business/entity and require annual confirmation, modification or reactivation support.'
                },
                {
                  title: 'Valid PAN-linked Entity Details',
                  desc: 'The IEC profile should correspond with the PAN-linked legal entity and its current business information.'
                },
                {
                  title: 'Authorized Person Access',
                  desc: 'An authorized person should have access to the registered contact or verification method needed for online processing.'
                },
                {
                  title: 'Accurate Current Information',
                  desc: 'Current firm, address, contact, branch and other IEC particulars should be reviewed before confirmation.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The business should maintain a valid current address and supporting proof where a change is being requested.'
                },
                {
                  title: 'DGFT Compliance Readiness',
                  desc: 'Any pending profile discrepancy or deactivation issue should be identified so the correct DGFT update route can be followed.'
                },
                {
                  title: 'Pre-Renewal Compliance Verification',
                  desc: 'akshayb2bsolutions reviews the IEC details and supporting information before submission to reduce avoidable errors.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              For IEC Renewal, the exact documents depend on whether you are only confirming existing details or making changes. Most information can be reviewed and shared digitally for online processing.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'IEC Number / IEC Certificate',
                  desc: 'Existing IEC details or certificate copy for profile identification and status review.'
                },
                {
                  title: 'PAN of Business / Entity',
                  desc: 'PAN-linked entity details used for validating the IEC profile and business identity.'
                },
                {
                  title: 'Business Address Proof (if changed)',
                  desc: 'Current supporting address document may be required when the registered business address is being modified.'
                },
                {
                  title: 'Registered Email & Mobile Access',
                  desc: 'Access to current contact details can help complete verification and communication during the DGFT process.'
                },
                {
                  title: 'Bank Details / Cancelled Cheque if Applicable',
                  desc: 'Bank-related proof may be needed if banking particulars are being added or modified in the IEC profile.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our team helps organize and review the documents required for the specific IEC confirmation or modification request.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step IEC Renewal Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Review Existing IEC Status',
                  desc: 'We first review whether your IEC is active and identify whether you need annual confirmation, modification or reactivation support.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Required IEC Details',
                  desc: 'Share your IEC number, PAN-linked business information, contact details and supporting documents required for any changes.'
                },
                {
                  step: 'Step 3',
                  title: 'Verify Existing Profile Information',
                  desc: 'We verify the current IEC profile and identify any details that need to be corrected or updated before submission.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Update on DGFT Portal',
                  desc: 'The annual confirmation or modification request is prepared and submitted through the applicable DGFT online IEC service.'
                },
                {
                  step: 'Step 5',
                  title: 'Complete Verification & Validation',
                  desc: 'Complete the required online verification and address any portal validation issue that may arise during the update.'
                },
                {
                  step: 'Step 6',
                  title: 'Receive Updated IEC Confirmation',
                  desc: 'After successful processing, keep the updated IEC profile/certificate available for future import-export and DGFT related use.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                DGFT Compliance Position
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                IEC Renewal & DGFT Compliance Status
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  IEC is a PAN-linked importer-exporter identification maintained through DGFT. Renewal/update keeps the IEC profile current; it does not create a new legal entity.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  IEC holders should keep their profile details updated as prescribed by DGFT and promptly modify particulars when business information changes.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Annual confirmation is an online compliance step. Where details are unchanged, the profile can be confirmed; where details changed, the relevant particulars should be updated.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The IEC holder is responsible for ensuring that information submitted to DGFT is accurate and supported by appropriate records.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our compliance team explains the IEC update process, checks profile details, identifies required modifications and assists with DGFT submission or reactivation support.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                After Renewal Compliance Checklist
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              After IEC renewal/update, keep your DGFT profile aligned with current business details and update changes promptly to reduce future trade-compliance interruptions.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Keep IEC Profile Details Current',
                  desc: 'Review firm name, address, contacts, branches and other IEC particulars whenever business information changes.'
                },
                {
                  title: 'Maintain Current Bank Information',
                  desc: 'Keep bank-related information and supporting records current where such details are maintained or modified for trade processes.'
                },
                {
                  title: 'Complete Annual IEC Confirmation',
                  desc: 'Complete the prescribed annual electronic IEC update/confirmation during the DGFT update period.'
                },
                {
                  title: 'Update Changes on DGFT',
                  desc: 'Modify relevant IEC particulars on the DGFT portal when the business name, address, contacts or other profile details change.'
                },
                {
                  title: 'Keep Export Compliance Documents Aligned',
                  desc: 'Keep IEC information consistent with other applicable business, GST, customs and banking records used for import-export transactions.'
                },
                {
                  title: 'Monitor IEC Active Status',
                  desc: 'Check IEC status periodically, especially before important import-export filings or applications on DGFT.'
                },
                {
                  title: 'akshayb2bsolutions Ongoing Compliance Support',
                  desc: 'Our team can help with future IEC updates, profile modifications, status review and related import-export compliance services.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                IEC Renewal vs Related Export Services
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold border-r border-blue-800">New IEC Registration</th>
                    <th className="p-3.5 font-bold border-r border-blue-800">AD Code Registration</th>
                    <th className="p-3.5 font-bold">RCMC Registration</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">DGFT IEC Application</td>
                    <td className="p-3.5 border-r border-slate-200">Customs / Bank Linking</td>
                    <td className="p-3.5">Export Promotion Council</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">New Importer / Exporter</td>
                    <td className="p-3.5 border-r border-slate-200">Existing IEC + Bank AD Code</td>
                    <td className="p-3.5">Eligible Exporter / Member</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-rose-700 border-r border-slate-200">
                      Keeps Existing IEC Updated
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Creates Fresh IEC</td>
                    <td className="p-3.5 border-r border-slate-200">Supports Export Shipping Bills</td>
                    <td className="p-3.5 text-orange-800 font-semibold">Supports EPC Membership / Benefits</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      No separate tax status created
                    </td>
                    <td className="p-3.5 border-r border-slate-200">No separate tax status created</td>
                    <td className="p-3.5 border-r border-slate-200">No separate tax status created</td>
                    <td className="p-3.5 text-orange-800 font-semibold">No separate tax status created</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">5. Decision-Making</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Authorized online confirmation
                    </td>
                    <td className="p-3.5 border-r border-slate-200">DGFT application by authorized person</td>
                    <td className="p-3.5 border-r border-slate-200">Customs/port process with bank AD Code</td>
                    <td className="p-3.5">EPC/commodity board process</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">6. Compliance Burden</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Simple periodic online update
                    </td>
                    <td className="p-3.5 border-r border-slate-200">One-time registration + future updates</td>
                    <td className="p-3.5 border-r border-slate-200">Port/customs-specific setup</td>
                    <td className="p-3.5">Periodic renewal as applicable</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">7. Credibility &amp; Trust</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Maintains current DGFT profile
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Essential for starting import/export</td>
                    <td className="p-3.5 border-r border-slate-200">High</td>
                    <td className="p-3.5 text-orange-800 font-semibold">Useful for eligible exporters</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Businesses starting import/export</td>
                    <td className="p-3.5 border-r border-slate-200">Exporters registering bank AD Code</td>
                    <td className="p-3.5">Exporters seeking EPC/RCMC support</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                IEC Renewal: Tax & Trade Compliance Notes
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              IEC Renewal itself does not change the tax treatment of your business. However, your IEC profile should remain consistent with the business records used for GST, banking, customs and other applicable trade compliance.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'IEC Renewal Does Not Change Tax Status',
                  desc: 'Renewing or updating IEC keeps DGFT particulars current but does not create a separate income-tax or GST status.'
                },
                {
                  title: 'Keep GST & Business Records Consistent',
                  desc: 'Where applicable, keep the business name, PAN-linked details and address aligned across IEC, GST and other official records.'
                },
                {
                  title: 'Export Documentation Consistency',
                  desc: 'Accurate IEC particulars help reduce mismatches across export documentation, customs and banking processes.'
                },
                {
                  title: 'GST Compliance Is Separate',
                ...
                {
                  title: 'Maintain Supporting Business Records',
                  desc: 'Keep PAN, address, bank and entity records available to support any IEC modification requested on the DGFT portal.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our team can coordinate IEC renewal with related GST, LUT, AD Code and export compliance assistance where required.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              An active, updated IEC is one foundational compliance item for import-export businesses. Depending on your trade model, you may also need banking, customs, export-promotion and GST-related registrations or filings.
            </p>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'AD Code Registration',
                  desc: 'Link the bank Authorized Dealer Code with customs where required for export shipping bill and port-related processes.'
                },
                {
                  title: 'RCMC Registration',
                  desc: 'Eligible exporters can obtain Registration-Cum-Membership Certificate from the relevant Export Promotion Council or authority.'
                },
                {
                  title: 'LUT Filing for Eligible Exporters',
                  desc: 'Eligible GST-registered exporters can file LUT for export of goods or services without payment of IGST, subject to applicable GST rules.'
                },
                {
                  title: 'GST Registration & Export Compliance',
                  desc: 'Maintain applicable GST registration, invoicing and return compliance alongside import-export operations.'
                },
                {
                  title: 'Export Documentation Support',
                  desc: 'Organize essential export-import documentation for customs, banking and routine trade workflows.'
                },
                {
                  title: 'IEC Modification & Reactivation',
                  desc: 'Update changed IEC particulars or resolve deactivation-related issues through the applicable DGFT profile management process.'
                },
                {
                  title: 'akshayb2bsolutions Export Compliance Support',
                  desc: 'Get coordinated assistance for IEC, AD Code, RCMC, LUT, GST and other related export compliance requirements.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-slate-200">
              ...
              {[
                {
                  ...
                  desc: 'We review your current IEC status and identify whether annual confirmation, modification or reactivation support is required.'
                },
                {
                  title: 'Accurate Profile Review & Digital Verification',
                  desc: 'Our compliance specialists review profile information and supporting documents before the DGFT update is submitted.'
                },
                {
                  title: 'DGFT Portal Filing Support',
                ...
                {
                  title: 'Modification & Reactivation Guidance',
                ...
                {
                  title: 'Related Export Compliance Advisory',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Simple ₹1,250 IEC Renewal assistance package with clear scope and no confusing service tiers.',
                  icon: Tag
                },
                {
                  title: 'Trusted by Thousands',
                  desc: 'Pan-India online assistance for businesses seeking fast and guided compliance support.',
                  icon: Users
                },
                {
                  title: 'Automated Compliance Alerts',
                  desc: 'Get reminders and guidance for future IEC profile updates and related compliance requirements.',
                  icon: Zap
                },
                {
                  title: 'Secure and Confidential',
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your IEC, KYC and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            <span className="text-xs font-black uppercase tracking-widest text-[#FF5A00] bg-white/10 px-3 py-1 rounded-full border border-white/20">
              Keep Your IEC Active & Updated
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Renew Your IEC with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Avoid last-minute trade disruptions. Get guided IEC annual update, profile modification or reactivation support with a simple online process and transparent ₹1,250 package.
            </p>
