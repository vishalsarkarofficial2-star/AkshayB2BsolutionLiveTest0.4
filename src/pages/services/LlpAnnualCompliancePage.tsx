...
interface LlpAnnualCompliancePageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — LLP annual compliance in India
const FAQ_ITEMS = [
  { q: 'What is LLP Firm Annual Compliance in India?', a: 'Every registered LLP must complete prescribed annual filings and income-tax compliance even when business activity is low or nil. Key filings commonly include LLP Form 11 (Annual Return), LLP Form 8 (Statement of Account & Solvency), and ITR-5, subject to applicability.' },
  { q: 'Is annual compliance mandatory for an LLP with no business?', a: 'Yes. MCA annual filings are generally required for registered LLPs even when there is no turnover or business activity. Timely filing helps keep the LLP compliant and avoids additional filing fees and penalties.' },
  { q: 'What is included in the ₹7,999 package?', a: 'The package covers annual compliance review, Form 11 filing support, Form 8 filing support, ITR-5 filing support, partner and LLP master-data checks, document checklist support, and a dedicated compliance executive. Statutory or government fees, late fees, audit, and other special filings are extra where applicable.' },
  { q: 'What documents are required for LLP annual compliance?', a: 'Commonly required records include LLP PAN, LLPIN, incorporation documents, partner details, contribution details, bank statements, books or financial statements, expense and income records, DSC access where required, and prior-year filing information.' },
  { q: 'Does an LLP need an audit every year?', a: 'Audit applicability depends on the limits and conditions prescribed under the LLP Act, Income-tax law, and other applicable rules. Our team reviews the LLP facts and informs you if an audit or certification is required.' },
  { q: 'What happens if LLP annual forms are filed late?', a: 'Late filing can result in additional government fees, penalties, compliance notices, and difficulty with future changes or closures. Early preparation helps reduce last-minute risk.' }
]

// Related services cross-linking items — LLP and business-compliance services
const RELATED_SERVICES = [
  {
    title: 'LLP Registration',
    desc: 'Start a Limited Liability Partnership with incorporation, partner documentation, and MCA filing support.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: '₹6,999'
  },
  {
    title: 'LLP Agreement Filing',
    desc: 'Professional support for drafting and filing LLP Agreement details with the MCA.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: '₹2,499'
  },
  {
    title: 'Income Tax Return Filing',
    desc: 'Income-tax return filing support for businesses and professionals with document review and computation assistance.',
    img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80',
    price: '₹999'
  },
  {
    title: 'TDS Returns',
    desc: 'Monthly and quarterly TDS compliance support for deductions, challans, and return filing.',
    img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80',
    price: '₹599/month'
  },
  {
    title: 'GST Return Filing',
    desc: 'Regular GST return preparation and filing support for eligible businesses across India.',
  ...
  },
  {
    ...
    desc: 'Annual ROC, financial statement, and income-tax compliance support for private limited companies.',
    img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Us'
  },
  {
    title: 'Accounting & Bookkeeping',
    desc: 'Organize ledgers, bank entries, expenses, invoices, and year-end books for smoother statutory filing.',
    img: 'https://images.unsplash.com/photo-1554224155-1696413565d3?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Us'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration assistance with application preparation and end-to-end filing support.',
    img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    price: '₹699'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your LLP name, logo, and brand identity through trademark application support.',
    img: 'https://images.unsplash.com/photo-1589578527966-fdac0f44566c?w=600&auto=format&fit=crop&q=80',
    price: '₹1,499'
  }
]

export const LlpAnnualCompliancePage: React.FC<LlpAnnualCompliancePageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('LLP Annual Compliance Package (₹7,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">LLP Firm Annual Compliance</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India LLP Compliance Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Expert MCA & Tax Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Keep your LLP compliant at just{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Professional compliance package • Govt./late fees extra if applicable
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  LLP Firm Annual Compliance is the yearly statutory process of keeping a registered Limited Liability Partnership compliant with MCA and Income-tax requirements. The service covers filing preparation, partner and contribution checks, financial data review, annual return support, statement of account and solvency support, and ITR-5 coordination.
                </p>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our LLP compliance specialist has been assigned to your annual filing case. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of LLP Firm Annual Compliance *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your registered state helps us map the correct ROC jurisdiction and compliance workflow for the LLP.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get one coordinated annual-compliance workflow covering MCA forms, tax-return support, document checks, and deadline tracking with minimal follow-up.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Designated Partner / Authorized Person Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select LLP Firm Annual Compliance Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="LLP Annual Compliance Package (₹7,999)">LLP Annual Compliance Package — ₹7,999</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start Annual Compliance</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'Annual Filing' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One conversion-focused package for LLPs that want annual MCA and Income-tax compliance handled through a single professional support desk.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">LLP Annual Compliance Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    A complete annual-compliance support package designed to help active or low-activity LLPs stay filing-ready and reduce late-compliance risk.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-lg text-slate-400 line-through">₹10,999</span>
                      <span className="text-4xl font-extrabold text-[#0D47A1]">₹7,999</span>
                    </div>
                    <span className="text-xs text-slate-500 font-medium block mt-1">
                      Professional fee • Govt./late fees extra only if applicable
                    </span>
                  </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'LLP Form 11 Annual Return Filing Support',
                      'LLP Form 8 Statement of Account & Solvency Support',
                      'ITR-5 Income Tax Return Filing Support',
                      'LLPIN, Partner & Master Data Compliance Review',
                      'Financial & Document Checklist Verification',
                      'Dedicated LLP Compliance Executive'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('LLP Annual Compliance Package (₹7,999)');
                ...
                >
                  Get Started with LLP Annual Compliance Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              LLP annual compliance keeps the statutory and tax records of an already-registered LLP current for each financial year. It combines partner and contribution information, annual-return data, accounts and solvency information, tax-return preparation, and supporting records into a structured filing workflow.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for registered LLPs across consulting, trading, services, technology, professional, manufacturing, and other lawful business activities that need annual MCA and Income-tax compliance support.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Clean books, updated partner details, contribution records, bank statements, and reconciled financial information make annual filing faster and reduce correction or resubmission risk.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The LLP remains a separate legal entity under the Limited Liability Partnership Act, 2008. Its designated partners are responsible for ensuring prescribed annual filings, records, and tax compliances are completed as applicable.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Mandatory Annual Compliance:</strong>
                  Annual compliance is not optional merely because an LLP has low turnover or no business activity. Applicable annual forms and tax filings should still be reviewed and completed on time.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Timely compliance supports cleaner due diligence, banking, tenders, funding conversations, partner changes, closure applications, and future MCA transactions.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, annual compliance keeps your LLP's statutory and tax records organized. Our team helps collect information, review documents, prepare filings, coordinate signatures, and track submission status through one support desk.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How LLP Firm Annual Compliance Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              LLP annual compliance is the recurring process of preparing and filing prescribed LLP and tax information for each financial year. Requirements vary based on turnover, contribution, activity, audit applicability, partner changes, and filing history.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              The annual workflow commonly includes Form 11 for annual return information, Form 8 for statement of account and solvency, and ITR-5 for income-tax reporting, together with any other applicable compliance based on the LLP's facts.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#0B3D91] flex items-center gap-1.5">
                ...
                <span>How akshayb2bsolutions Streamlines Your Annual Compliance:</span>
              </h4>
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk reviews the LLP's master data, partner information, books and financial records, prepares the required filing data, coordinates DSC/signature requirements, and supports submission and acknowledgement tracking.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Timely LLP Annual Compliance Matters
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Avoid Late Fees & Compliance Risk',
                  desc: 'Timely annual filing reduces exposure to additional filing fees, notices, and avoidable follow-up with MCA or tax authorities.'
                },
                {
                  title: 'Keep LLP Master Data Updated',
                  desc: 'Annual filings help maintain an up-to-date statutory trail for partners, contribution, business activity, and financial information.'
                },
                {
                  title: 'Stronger Banking & Due Diligence Readiness',
                  desc: 'Clean annual compliance records are useful when banks, customers, investors, vendors, or counterparties ask for recent filings.'
                },
                {
                  title: 'Easier Future MCA Changes',
                  desc: 'A compliant LLP is better positioned for partner changes, registered-office updates, agreement changes, conversion, or closure-related work.'
                },
                {
                  title: 'Coordinated MCA + Income Tax Support',
                  desc: 'Handle annual-return, account-and-solvency, and income-tax filing support through one coordinated professional workflow.'
                },
                {
                  title: 'Less Last-Minute Stress',
                  desc: 'A structured checklist, document review, and dedicated executive help identify missing records before filing deadlines approach.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                LLP Annual Compliance Readiness Checklist
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Financial Books Ready',
                  desc: 'Keep sales, purchase, expense, bank, loan, capital, and partner-current-account records updated for the financial year.'
                },
                {
                  title: 'Bank Reconciliation Completed',
                  desc: 'Match LLP bank statements with books and identify unexplained credits, charges, or missing entries before finalization.'
                },
                {
                  title: 'Partner & Contribution Details Verified',
                  desc: 'Confirm designated partner details, partner contribution, profit-sharing ratio, and changes made during the year.'
                },
                {
                  title: 'LLPIN & MCA Master Data Checked',
                  desc: 'Verify LLPIN, registered office, email, business activity, and current MCA master data before preparing annual forms.'
                },
                {
                  title: 'DSC & Authorized Signatory Access Ready',
                  desc: 'Ensure required digital-signature access is active for the designated partner or professional certification workflow, where applicable.'
                },
                {
                  title: 'Prior-Year Filings Available',
                  desc: 'Keep previous Form 11, Form 8, ITR, audit report, and acknowledgement records available for consistency checks.'
                },
                {
                  title: 'Tax & TDS/GST Reconciliations Reviewed',
                  desc: 'Reconcile applicable GST, TDS, advance tax, and income-tax data with books before ITR preparation.'
                },
                {
                  title: 'Compliance Review by akshayb2bsolutions',
                  desc: 'Our team checks the filing data, identifies gaps, and provides a clear action list before submission.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for LLP Firm Annual Compliance
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Every Registered LLP',
                  desc: 'Annual compliance review applies to registered LLPs, including LLPs with low turnover or no business activity, subject to applicable filing rules.'
                },
                {
                  title: 'Active and Dormant-Activity LLPs',
                  desc: 'Even where business activity is minimal, mandatory annual forms and income-tax filing requirements should be reviewed.'
                },
                {
                  title: 'LLPs with Partner or Contribution Changes',
                  desc: 'Changes during the year should be reflected consistently in annual filing data and supporting records.'
                },
                {
                  title: 'LLPs with Business Income or Expenses',
                  desc: 'Books, bank records, invoices, expenses, and tax data should be finalized before annual tax and MCA filings.'
                },
                {
                  title: 'LLPs Requiring Audit or Certification',
                  desc: 'Where statutory or tax audit/certification becomes applicable, the relevant professional review must be completed before or alongside filing.'
                },
                {
                  title: 'LLPs Planning Loans, Tenders or Closure',
                  desc: 'Up-to-date annual filings improve readiness for banking, due diligence, contractual onboarding, and future closure/conversion processes.'
                },
                {
                  title: 'Pre-Filing Compliance Verification',
                  desc: 'akshayb2bsolutions reviews filing history, partner data, books, and supporting records before preparing the annual compliance set.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for LLP Firm Annual Compliance
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process LLP annual compliance smoothly, keep LLP master data, partner details, bank statements, books, prior filings, tax records, and DSC access ready. Documents can be shared digitally for review.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'LLP PAN, LLPIN & Incorporation Details',
                  desc: 'LLP PAN, LLPIN, certificate of incorporation, registered-office details, and basic MCA master data.'
                },
                {
                  title: 'Partner & Designated Partner Details',
                  desc: 'PAN and basic KYC details of partners/designated partners, contribution details, and changes made during the year.'
                },
                {
                  title: 'Bank Statements',
                  desc: 'Complete LLP bank statements for the relevant financial year, including loan or current-account statements where applicable.'
                },
                {
                  title: 'Books & Financial Records',
                  desc: 'Sales, purchases, expenses, assets, liabilities, capital, partner accounts, and trial balance or finalized financial statements.'
                },
                {
                  title: 'Tax Compliance Records',
                  desc: 'Previous ITR, TDS details, GST returns, challans, Form 26AS/AIS-related information, and other tax records where applicable.'
                },
                {
                  title: 'DSC & Prior Filing Acknowledgements',
                  desc: 'Required DSC access and copies of previous Form 11, Form 8, ITR acknowledgements, audit reports, or notices for continuity checks.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step LLP Firm Annual Compliance Process
              </h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  title: 'Collect LLP & Financial Records',
                  desc: 'Share LLPIN, partner details, bank statements, books, prior filings, tax records, and relevant supporting documents.'
                },
                {
                  title: 'Review MCA Master Data & Filing History',
                  desc: 'We check the LLP master data, prior annual forms, partner information, and pending compliance items.'
                },
                {
                  title: 'Finalize Accounts & Compliance Data',
                  desc: 'Books and financial figures are organized for Form 8 and tax-return preparation, with inconsistencies flagged for correction.'
                },
                {
                  title: 'Prepare LLP Form 11 Annual Return',
                  desc: 'Annual-return details are prepared for filing based on partner, contribution, and LLP information.'
                },
                {
                  title: 'Prepare LLP Form 8 & ITR-5',
                  desc: 'Statement of Account & Solvency and income-tax return data are prepared, subject to audit/certification applicability.'
                },
                {
                  title: 'DSC, Filing & Acknowledgement Support',
                  desc: 'We coordinate signature requirements, filing, payment guidance for statutory fees if applicable, and provide filing acknowledgements/status support.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                LLP Annual Filing & Legal Compliance Status
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  An LLP has a separate legal identity from its partners under the Limited Liability Partnership Act, 2008. Annual compliance helps maintain an updated statutory record of the LLP and its designated partners.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Annual compliance may include Form 11, Form 8, ITR-5, books and tax reconciliations, audit or certification where applicable, and updates linked to changes in partner or LLP particulars.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Designated partners carry statutory responsibilities for compliance and filing, while partner rights and obligations continue to be governed by the LLP Agreement and applicable law.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our compliance advisors help you understand the annual filing set, required documents, partner information, tax records, DSC requirements, and any additional compliance triggered by your LLP's facts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Ongoing LLP Compliance Checklist
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Beyond Form 11, Form 8, and ITR-5, an LLP should also review event-based, tax, payroll, GST, TDS, and other compliances that may apply during the year.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'PAN / TAN & Tax Profile Review',
                ...
                },
                {
                  ...
                  desc: 'Reconcile the LLP bank accounts with books and supporting records before annual financial and tax filing.'
                },
                {
                  title: 'Annual MCA & Income Tax Filing',
                ...
                },
                {
                  ...
                  desc: 'Report applicable changes to partners, designated partners, registered office, LLP Agreement, or other particulars through the prescribed MCA forms.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                LLP Annual Compliance vs Common Business Filings
              </h2>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax & Filing Considerations for LLPs in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              An LLP is generally taxed under the Income-tax Act based on its taxable business income and applicable provisions. Annual compliance should align the LLP's books, tax deductions, partner remuneration or interest where applicable, and ITR-5 with the underlying financial records.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'LLP Income-tax Return Filing',
                  desc: 'LLPs generally file ITR-5 and should ensure taxable income, deductions, depreciation, partner-related items, and taxes paid are correctly reflected.'
                },
                {
                  title: 'Books & Tax Reconciliation',
                  desc: 'Bank entries, expenses, revenue, TDS, GST where applicable, and tax records should be reconciled before final tax filing.'
                },
                {
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              A compliant LLP is better prepared for bank finance, vendor onboarding, tenders, investor or lender due diligence, and future restructuring. Annual filings create a cleaner compliance record for these business needs.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Up-to-date filings can support loan, OD/CC, and banking documentation where financial institutions request recent statutory records.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'LLPs seeking investment or strategic funding should maintain clean accounts, tax records, and annual filings to simplify financial and legal due diligence.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We review your LLP master data, partner details, turnover, filing history, tax status, and document readiness before starting the annual filing work.'
                },
                {
                  title: 'Financial & Filing Data Verification',
                  desc: 'Our compliance specialists organize annual filing data, financial records, declarations, and supporting documents to reduce filing errors and avoidable resubmission risk.'
                },
                {
                  title: 'MCA & Tax Filing Coordination',
                  desc: 'We coordinate MCA filing data, tax-return preparation, signature requirements, and filing acknowledgements through a single support workflow.'
                },
                {
                  title: 'Clear Document Checklist',
                  desc: 'Receive a practical checklist of bank statements, books, partner details, prior filings, tax records, and other documents needed for your LLP.'
                },
                {
                  title: 'Dedicated Compliance Executive',
                  desc: 'Get one point of contact for document follow-up, filing status, pending clarifications, and annual compliance coordination.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why LLPs Choose akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Zero hidden costs, crystal-clear pricing with a single ₹7,999 annual-compliance package, and transparent separate government fee breakdowns.',
                  icon: Tag
                },
                {
                  title: 'Trusted by Thousands',
                  desc: 'Experienced support team serving businesses across India with registration, tax, and compliance assistance.',
                  icon: Users
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            <span className="text-xs font-black uppercase tracking-widest text-[#FF5A00] bg-white/10 px-3 py-1 rounded-full border border-white/20">
              Stay Compliant. Stay Business-Ready.
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Complete Your LLP Annual Compliance with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Keep your LLP filing-ready with a simple digital compliance workflow, clear documentation support, and one dedicated team for MCA and tax coordination.
            </p>
            ...
            <div className="bg-gradient-to-r from-[#0B3D91] via-[#0D47A1] to-[#082a66] text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-4 max-w-md relative z-10">
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
                  Track Your LLP Compliance in Real-Time
                </h3>
                <p className="text-xs text-slate-200 leading-relaxed">
                  Download the akshayb2bsolutions mobile application for iOS &amp; Android. Access compliance documents, filing acknowledgements, and direct support from your dashboard.
                </p>
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  <a
