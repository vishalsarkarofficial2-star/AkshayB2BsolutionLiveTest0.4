...
interface CleRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — Council for Leather Exports (CLE) / RCMC focused
const FAQ_ITEMS = [
  { q: 'What is Council for Leather Exports (CLE) Registration?', a: 'Council for Leather Exports (CLE) membership is for eligible Indian exporters in the leather, leather products and footwear sector. Registered exporters can obtain/maintain the applicable Registration-cum-Membership Certificate (RCMC) and access export-promotion support subject to CLE and DGFT rules.' },
  { q: 'Who should apply for CLE membership?', a: 'Leather, footwear, leather goods, garments, saddlery, harness and related product exporters whose principal line of business falls under the Council for Leather Exports may need CLE membership/RCMC. Eligibility depends on product category and current export-policy requirements.' },
  { q: 'Why is there no fixed price on this page?', a: 'CLE membership charges can vary according to the applicant category and previous-year export FOB value, with applicable entrance fee, membership fee and GST. We first review your exporter profile and then provide the applicable quote before filing.' },
  ...
  { q: 'What is RCMC and why does it matter?', a: 'RCMC is the Registration-cum-Membership Certificate linked with the relevant Export Promotion Council. For eligible leather-sector exporters, CLE membership/RCMC can support access to Foreign Trade Policy benefits, schemes and export-promotion services subject to applicable rules.' },
  { q: 'Can you help with renewal as well as new membership?', a: 'Yes. Our service can assist with new CLE membership/RCMC applications, document review, category assessment, renewal guidance and follow-up support, subject to authority approval.' }
]

// Related export-compliance services for leather exporters
const RELATED_SERVICES = [
  ...
  { title: 'Trademark Registration', desc: 'Protect your leather, footwear or accessories brand in India.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible leather and footwear MSMEs.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
...
export const CleRegistrationPage: React.FC<CleRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Leather Exporter');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('CLE Registration & RCMC Assistance — Custom Quote');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Council for Leather Exports (CLE) Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Council for Leather Exports (CLE) is the Export Promotion Council for India's leather and leather-products sector. Eligible exporters can apply for CLE membership and the applicable RCMC to align their export profile with the relevant council and access export-promotion support under applicable Government of India policies.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Authority-Based Processing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Handshake className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Leather & Footwear Exporters</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>CLE / RCMC Filing Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our leather-export compliance specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Council for Leather Exports (CLE) Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your applicable CLE category and documents depend on exporter type, product profile and previous-year export FOB value. We review these first so you know the likely official fee category before filing.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                We pre-check IEC, GST, business KYC, leather/footwear product category and export-performance details before CLE filing to reduce avoidable errors and back-and-forth.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>
                                <label className="block text-xs font-bold text-slate-700 mb-1">
                                  Leather / Footwear Export Activity *
                                </label>
                                <select
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Council for Leather Exports (CLE) Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Council for Leather Exports (CLE) Registration Package (Custom Quote)">Council for Leather Exports (CLE) Registration Package — Custom Quote + Govt. Fees</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Start Your CLE Membership & RCMC Application
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused package: category assessment, document pre-check, CLE membership/RCMC filing guidance and application follow-up. Pricing is shared after reviewing your exporter category because official CLE charges vary by category and export FOB value.
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mb-6">
                    A conversion-focused assistance package for leather and footwear exporters who want the correct CLE membership category, cleaner documentation and confident RCMC filing support.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      ...
                      'CLE / RCMC Filing Support Support',
                      'Leather / Footwear Product Category Mapping',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Council for Leather Exports (CLE) Registration Package (Custom Quote)');
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is Council for Leather Exports (CLE) in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              CLE membership connects eligible Indian leather-sector exporters with the sector's designated Export Promotion Council. The associated RCMC helps establish the exporter’s council membership for applicable Foreign Trade Policy benefits and export-promotion services, subject to current rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for merchant exporters, manufacturer exporters and eligible businesses exporting leather, footwear, leather goods, garments, saddlery, harness and related products from India.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Correct product mapping, exporter classification and export-performance details help determine the appropriate CLE membership category and supporting documentation.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  CLE membership does not change your business constitution; it supports your recognition with the relevant Export Promotion Council for applicable RCMC and export-promotion purposes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration under the Indian CLE members Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow exporters / authorized applicants in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An CLE members is not formed for distributing profits to members. Eligible organizations can pursue donations, grants, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, CLE membership/RCMC helps eligible leather and footwear exporters align with the relevant Export Promotion Council. Our team supports category assessment, document readiness, filing guidance and follow-up so you can focus on export orders instead of paperwork.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Council for Leather Exports (CLE) Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              CLE registration involves applying for the appropriate Council membership and, where applicable, RCMC based on your exporter profile, leather-sector product category and export performance.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the exporter receives the applicable CLE membership/RCMC documentation. This can help eligible members access export-promotion services and applicable Foreign Trade Policy benefits, subject to DGFT/CLE rules and ongoing membership compliance.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our export-compliance desk reviews the required IEC, GST, KYC, product-category and export-performance documents, assists with the CLE/RCMC application and supports follow-up until the authority completes its review.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Benefits of CLE Membership for Leather Exporters
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'CLE membership and RCMC can help eligible leather exporters access council services and applicable Foreign Trade Policy benefits, subject to current rules.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Get professional documentation and registration support with transparent professional fees; the final timeline depends on CLE members structure, state, authority, and government verification.'
                },
                {
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for CLE Membership / RCMC
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique CLE members Name Selection',
                ...
                {
                  title: 'Clearly Defined CLE members Objectives and Governance',
                ...
                {
                  title: 'Draft export documentation',
                  desc: 'Clearly state the CLE members objectives, governance, membership or trusteeship, powers, duties, meetings, accounts, and dissolution provisions in the governing document.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Council for Leather Exports (CLE) Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a CLE members in India, there must be a minimum of two exporters / authorized applicants and a maximum of twenty. All exporters / authorized applicants must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Exporters / Authorized Applicants',
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen CLE members structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected CLE members structure.'
                },
                {
                  title: 'Unique CLE members Name Requirement',
                  desc: 'The CLE members must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written CLE members Deed',
                ...
                },
                {
                  ...
                  desc: 'The CLE members must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a CLE members.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Council for Leather Exports (CLE) Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              For CLE membership/RCMC, exporters typically need valid IEC, GST and business KYC details, along with exporter-category, product and export-performance documents where applicable. The exact checklist depends on your applicant profile and current CLE requirements.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                {
                  title: 'Signed export documentation',
                  desc: 'The applicable governing document signed/executed by the required founders, trustees, members, or directors, covering CLE members objectives and governance rules.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our team organizes the CLE application checklist, reviews supporting documents and helps prepare the membership/RCMC filing set according to the applicable requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Council for Leather Exports (CLE) Registration Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Draft export documentation',
                  desc: 'We prepare the appropriate governing document detailing the CLE members objectives, exporter representatives, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Exporters / Authorized Applicants',
                ...
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique CLE members Name',
                  desc: 'Our team helps check the proposed CLE members name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped CLE members deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the CLE members\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the CLE members registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the CLE members bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                CLE Membership & RCMC Status for Exporters
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  CLE membership/RCMC is an export-promotion registration linked to your existing business entity. Your company, LLP, partnership or proprietorship continues to retain its own legal constitution and tax status.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance can include annual CLE membership renewal, keeping IEC and GST particulars current, maintaining export-performance records and completing other export-related filings as applicable.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our export-compliance advisors guide you on CLE category selection, RCMC documentation, IEC/GST consistency, renewal requirements and related export registrations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After obtaining CLE membership/RCMC, exporters should maintain annual membership renewal and keep IEC, GST, export-performance and other applicable details current to preserve eligibility for relevant benefits.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the CLE members\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                ...
                {
                  title: 'Annual CLE Membership Renewal & Export Compliance',
                  desc: 'File the CLE members\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the CLE members employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                CLE members vs Other Business Structures
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on CLE members structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax & GST Considerations for Leather Exporters
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              CLE membership itself does not create a separate income-tax status. Tax and GST treatment depends on your business constitution, export transactions and applicable tax provisions, including zero-rated export rules where relevant.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on CLE members Structure',
                ...
                },
                {
                  ...
                  desc: 'Remuneration and interest paid to working exporters / authorized applicants are taxable in the authorized applicant\'s hands but deductible for the CLE members, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible CLE members should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the CLE members structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              CLE members generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Depending on eligibility and banking requirements, CLE members may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an CLE members; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound CLE members deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Grow Your Leather Export Business with CLE Support
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Move your leather export compliance forward with a category-first approach. We check your profile before quoting, organize the application documents and guide the filing process with transparent support—no misleading one-price promise.
            </p>
