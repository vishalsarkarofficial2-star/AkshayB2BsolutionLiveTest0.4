...
interface EsiRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs for ESI Registration in India
const FAQ_ITEMS = [
  { q: 'What is ESI Registration in India?', a: 'ESI Registration is employer registration under the Employees’ State Insurance (ESI) scheme administered by ESIC. Eligible establishments register to provide medical, sickness, maternity, disablement, dependant and other social-security benefits to covered employees.' },
  { q: 'Who needs ESI Registration?', a: 'Factories and other establishments covered under the ESI Act and applicable notifications generally need registration when they meet the prescribed employee threshold and coverage conditions. Applicability can vary by state, establishment type and current ESIC rules.' },
  { q: 'What documents are generally required for ESI Registration?', a: 'Common documents include PAN of the establishment, registration/incorporation proof, address proof, bank details, employer contact details, and employee information such as Aadhaar, bank details, date of joining and wage particulars, subject to portal requirements.' },
  { q: 'How long does ESI Registration take?', a: 'The timeline depends on document readiness, correct establishment and employee details, and successful submission on the ESIC portal. Registration can often be completed quickly when all required information is available.' },
  { q: 'What is an ESI Code Number?', a: 'After successful employer registration, ESIC issues a unique employer code number used for ESI compliance, employee coverage, contribution payments and related filings.' },
  { q: 'What happens after ESI Registration?', a: 'After registration, the employer must add eligible employees, maintain required records, deposit ESI contributions within the prescribed timelines, update employee details and complete applicable compliance on the ESIC portal.' }
]

// Related services cross-linking items — employment and business compliance services
const RELATED_SERVICES = [
  {
    title: 'EPF Registration',
    desc: 'Get employer EPF registration support for statutory provident fund compliance and employee onboarding.',
    img: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=600&auto=format&fit=crop&q=80',
    price: '₹999'
  },
  {
    title: 'Professional Tax Registration',
    desc: 'Professional Tax registration and enrolment support for eligible employers and businesses.',
    img: 'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=600&auto=format&fit=crop&q=80',
    price: '₹999'
  },
  {
    title: 'Labour License',
    desc: 'Labour licence application and compliance assistance for establishments where applicable.',
    img: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=600&auto=format&fit=crop&q=80',
    price: '₹1,999'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration support for eligible businesses, including application and document guidance.',
    img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80',
    price: '₹999'
  },
  {
    title: 'Company Registration',
    desc: 'Udyam registration assistance for eligible micro, small and medium enterprises.',
  ...
  },
  {
    ...
    desc: 'Registration support under applicable state Shops and Establishments requirements.',
  ...
  },
  {
    ...
    desc: 'Assistance with payroll-related statutory records, employee data and recurring compliance workflows.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: '₹1,999'
  },
  {
    title: 'Company Registration',
    desc: 'Business incorporation support for private limited, LLP and other eligible structures.',
...
export const EsiRegistrationPage: React.FC<EsiRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('ESI Registration Package (₹999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">ESI Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Get your ESI Registration at just{' '}
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  ESI Registration in India is the employer registration process under the Employees’ State Insurance scheme administered by ESIC. It enables eligible establishments to enrol covered employees and comply with statutory social-security requirements.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>ESIC Portal Registration</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our ESI registration specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                    ...
                    <>
                      ...
                      {/* Default Price State tax compliancelight Box */}
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of ESI Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                ESI applicability and registration details may vary by establishment type, employee strength, wage coverage and applicable state notifications.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete ESIC registration assistance, employer and employee data review, portal filing support, and compliance guidance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select ESI Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="ESI Registration Package (₹999)">ESI Registration Package — ₹999</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your ESI Registration Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional ESI registration guidance, employer and employee data review, ESIC portal filing support, and dedicated compliance assistance.
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mb-6">
                    Essential ESI employer registration support for eligible establishments and covered employees.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'ESI Applicability & Document Review',
                      'Employer & Employee Data Preparation',
                      'ESIC Filing Support Support',
                      'ESI Code Registration Assistance',
                      'Employee Coverage & IP Registration Guidance',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('ESI Registration Package (₹999)');
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              ESI Registration gives an eligible employer an ESIC employer code and enables covered employees to be enrolled under the Employees’ State Insurance scheme for statutory medical and cash benefits, subject to applicable eligibility rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Who Should Register:</strong>
                  Suitable for factories and eligible establishments that fall within ESI coverage based on employee strength, wage limits, establishment category and applicable central or state notifications.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Employee Social Security:</strong>
                  ESI coverage provides eligible employees access to medical care and specified cash benefits such as sickness, maternity, disablement and dependant benefits under the scheme.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Employer Compliance Framework:</strong>
                  Registered employers are required to keep employee information updated, deposit contributions within prescribed timelines and follow applicable ESIC compliance requirements.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Mandatory When Applicable:</strong>
                  ESI registration is statutory for establishments that come within the coverage of the ESI Act and relevant notifications. Applicability should be checked against current ESIC rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Workforce Compliance Support:</strong>
                  Proper ESI registration helps employers organize employee insurance coverage and maintain statutory labour-compliance records as the workforce grows.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, ESI Registration helps eligible employers comply with employee social-security requirements. Our team supports applicability review, document preparation, ESIC filing, employee-data setup and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How ESI Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              ESI Registration is completed by eligible employers through the ESIC registration process using establishment, employer and employee details required by the portal.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After successful registration, the establishment receives an ESIC employer code. The employer can then enrol eligible employees, manage contribution-related compliance and maintain statutory ESI records.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk helps organize establishment and employee documents, prepare portal-ready information, submit the ESI registration application and assist with follow-up guidance.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of ESI Registration
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'ESI registration helps eligible employers meet statutory employee-insurance obligations and maintain a recognized ESIC employer account.'
                },
                {
                  title: 'Shared Capital & Combined Expertise',
                  desc: 'Covered employees can access eligible medical and cash benefits under the ESI scheme, subject to applicable rules.'
                },
                {
                  title: 'Minimal Start-up Costs & Quick Setup',
                  desc: 'Get professional registration support with transparent service fees; processing depends on complete and accurate employer and employee information.'
                },
                {
                  title: 'Improved Business Credibility',
                  desc: 'Statutory ESI compliance demonstrates structured workforce management and supports stronger labour-compliance practices.'
                },
                {
                  title: 'Simplified Compliance Structure',
                  desc: 'A centralized ESIC portal helps employers manage employee coverage, contribution records and related compliance activities.'
                },
                {
                  title: 'Access to Government Benefits',
                  desc: 'Eligible insured employees may receive medical, sickness, maternity, disablement, dependant and other benefits under the ESI scheme.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before ESI Registration
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Confirm whether the establishment is covered based on employee strength, establishment category, wage criteria and applicable notifications.'
                },
                {
                  title: 'Confirm Establishment Details',
                  desc: 'Keep the legal name, PAN, registration details, business activity, address and employer contact information ready.'
                },
                {
                  title: 'Prepare Employee Information',
                ...
                },
                {
                  ...
                  desc: 'Keep acceptable premises proof such as utility bill, rent agreement or ownership document available as applicable.'
                },
                {
                  title: 'Check ESI Applicability',
                  desc: 'Prepare portal-ready establishment and employee information to reduce errors and avoid delays during registration.'
                },
                {
                  title: 'Check Related Labour Compliance',
                  desc: 'Review whether EPF, Professional Tax, Shops and Establishments or other labour registrations also apply to the business.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              ESI Registration applies to establishments that fall within the coverage of the ESI Act and relevant notifications. Applicability depends on factors such as establishment category, employee strength, wage eligibility and the rules in force for the relevant location.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The establishment must fall within a category and employee threshold covered by the ESI framework and applicable notifications.'
                },
                {
                  title: 'Eligible Employees',
                  desc: 'Employees must meet the applicable coverage and wage conditions prescribed under the ESI scheme.'
                },
                {
                  title: 'Valid Employer Registration Details',
                  desc: 'The employer should have valid PAN, establishment registration details and accurate business particulars for portal registration.'
                },
                {
                  title: 'Employee & Wage Records',
                  desc: 'Employee joining details, wages and KYC information should be maintained accurately for ESI coverage and contribution compliance.'
                },
                {
                  title: 'Establishment Address in India',
                  desc: 'A valid establishment address and acceptable premises proof should be available for registration.'
                },
                {
                  title: 'Applicability of Notifications',
                  desc: 'Coverage may differ by establishment type, location and government notification, so applicability should be checked before filing.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process ESI Registration smoothly, establishment KYC, address proof, bank information, authorized-person details and employee data are generally required. Exact requirements may depend on the ESIC portal and establishment profile.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: 'Identity and contact details of the authorized employer representative, as required for registration.'
                },
                {
                  title: 'Establishment Address Proof',
                  desc: 'Utility bill, rent agreement, ownership proof or other acceptable document for the establishment address.'
                },
                {
                  title: 'Bank Account Details',
                  desc: 'Business bank account information and supporting proof where required by the registration process.'
                },
                {
                  title: 'Employee Details',
                  desc: 'Employee name, date of joining, wage details, Aadhaar, bank and other information required for ESI coverage.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our compliance team helps organize and format employer and employee information for ESIC portal submission.'
                }
              ].map((item, idx) => (
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Check ESI Applicability',
                  desc: 'We review your establishment type, workforce and available details to assess ESI registration applicability.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Employer & Employee Documents',
                  desc: 'Collect establishment PAN, address proof, bank information, authorized-person details and employee KYC/data.'
                },
                {
                  step: 'Step 3',
                  title: 'Prepare ESIC Portal Information',
                  desc: 'We organize registration details in the format required for accurate ESIC portal submission.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit ESIC Employer Registration',
                  desc: 'We assist with submission of the employer registration details and supporting information through the ESIC registration process.'
                },
                {
                  step: 'Step 5',
                  title: 'Employee Coverage Setup Guidance',
                  desc: 'We guide the addition of eligible employees and preparation of insured-person details after employer registration.'
                },
                {
                  step: 'Step 6',
                  title: 'Receive ESIC Employer Code & Compliance Guidance',
                  desc: 'Receive the ESIC employer code and post-registration guidance for employee coverage, contributions and ongoing compliance.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Status & Compliance of ESI Registration
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  ESI Registration does not change the legal form of the business; it creates the employer’s statutory registration under the Employees’ State Insurance framework for covered workforce compliance.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  After registration, employers must maintain eligible employee records, update changes, deposit applicable contributions on time and follow ESIC compliance requirements.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  ESI registration supports employee social-security compliance, but employers must continue timely contributions, employee updates and record maintenance after registration.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Employer responsibilities include accurate employee coverage, contribution compliance, record maintenance and timely updates on the ESIC portal.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our compliance advisors guide you on ESI applicability, employer registration, employee coverage and post-registration obligations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After ESI Registration, employers must follow ongoing ESIC compliance requirements to avoid contribution defaults, interest, damages or other consequences under applicable law.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Maintain Employer Profile',
                  desc: 'Keep establishment name, address, contact details and other employer particulars updated whenever required.'
                },
                {
                  title: 'Add & Update Eligible Employees',
                  desc: 'Add eligible employees and keep insured-person information accurate on the ESIC system.'
                },
                {
                  title: 'Monthly ESI Contribution Compliance',
                  desc: 'Calculate and deposit applicable ESI contributions on eligible wages within the prescribed due dates.'
                },
                {
                  title: 'Report Employee Changes',
                  desc: 'Update eligible employee joining, exit and other relevant particulars as required under ESIC compliance.'
                },
                {
                  title: 'Maintain Wage & Contribution Records',
                  desc: 'Maintain wage, attendance, contribution and employee records required for ESIC compliance and verification.'
                },
                {
                  title: 'Coordinate Other Labour Compliance',
                  desc: 'Check and comply with other applicable labour registrations such as EPF, Professional Tax and Shops & Establishments.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                ESI Registration Compliance Overview
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold border-r border-blue-800">EPF Registration</th>
                    <th className="p-3.5 font-bold border-r border-blue-800">Professional Tax</th>
                    <th className="p-3.5 font-bold">Shops & Establishments</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Provident Fund Compliance</td>
                    <td className="p-3.5 border-r border-slate-200">State Professional Tax Compliance</td>
                    <td className="p-3.5">State Establishment Compliance</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">2. Applies To</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Eligible Employers & Covered Employees
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Eligible Employers & Employees</td>
                    <td className="p-3.5 border-r border-slate-200">Businesses/Employers as per State Rules</td>
                    <td className="p-3.5">Commercial Establishments as per State Rules</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">3. Registration Focus</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-rose-700 border-r border-slate-200">
                      Employee Insurance Coverage
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Retirement & Provident Fund</td>
                    <td className="p-3.5 border-r border-slate-200">Professional Tax Enrollment</td>
                    <td className="p-3.5 text-orange-800 font-semibold">Establishment Registration</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">4. Payment / Contribution</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      ESI contributions as per applicable rates
                    </td>
                    <td className="p-3.5 border-r border-slate-200">PF contributions as per applicable rules</td>
                    <td className="p-3.5 border-r border-slate-200">Professional tax as per state slabs</td>
                    <td className="p-3.5 text-orange-800 font-semibold">Fees/renewal as per state rules</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">5. Ongoing Action</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Employee updates & contributions
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Member updates & PF compliance</td>
                    <td className="p-3.5 border-r border-slate-200">Returns/payments as applicable</td>
                    <td className="p-3.5">Records/renewal as applicable</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">6. Compliance Burden</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Recurring ESIC compliance
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Recurring EPF compliance</td>
                    <td className="p-3.5 border-r border-slate-200">State-specific periodic compliance</td>
                    <td className="p-3.5">State-specific establishment compliance</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Provident fund compliance</td>
                    <td className="p-3.5 border-r border-slate-200">State tax compliance</td>
                    <td className="p-3.5 text-orange-800 font-semibold">State tax complianceest (Global Standards)</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-slate-900 border-r border-slate-200">
                      Eligible establishments with covered employees
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Eligible establishments with PF applicability</td>
                    <td className="p-3.5 border-r border-slate-200">Employers covered by state professional tax law</td>
                    <td className="p-3.5">State tax compliance-Growth Startups &amp; Tech</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                ESI Contribution & Compliance in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              ESI is a statutory social-security contribution framework rather than an income-tax registration. Contribution liability and employee coverage are governed by the ESI Act, applicable wage limits and current ESIC rules.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Contribution Liability',
                  desc: 'Employer and employee contribution obligations apply according to the contribution rates and coverage rules in force.'
                },
                {
                  title: 'Contribution on Eligible Wages',
                  desc: 'Contributions should be calculated on eligible wages in accordance with applicable ESIC rules and deposited within prescribed timelines.'
                },
                {
                  title: 'Employee Wage Records',
                  desc: 'Maintain accurate wage, attendance and employee records because they affect ESI coverage and contribution calculations.'
                },
                {
                  title: 'Coverage & Wage Eligibility',
                  desc: 'Employee coverage depends on the wage ceiling and other eligibility conditions prescribed under current ESI rules.'
                },
                {
                  title: 'Records & Verification',
                  desc: 'Employers should maintain required employee, wage, contribution and related statutory records for compliance and verification.'
                },
                {
                  title: 'akshayb2bsolutions ESI Compliance Support',
                  desc: 'Our compliance team helps organize ESI registration data, employee records and recurring statutory compliance workflows.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              ESI Registration is a labour and social-security compliance requirement and does not determine how a business raises finance. Maintaining statutory compliance can, however, support stronger operational governance and documentation.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Keep statutory workforce records organized when presenting business documentation to banks, investors or institutions.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Businesses may access suitable banking and finance options independently of ESI registration, subject to lender eligibility.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity and business financing remain governed by the legal structure and commercial profile of the enterprise, not by ESI registration.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists organize employer and employee information to reduce avoidable ESIC portal errors and registration delays.'
                },
                {
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Businesses Trust akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Zero hidden costs and crystal-clear professional service pricing starting at just ₹999/- for ESI Registration assistance.',
                  icon: Tag
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Get Your ESI Registration with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Get professional assistance for ESI Registration with akshayb2bsolutions. Transparent pricing, digital document support, ESIC filing assistance and post-registration guidance.
            </p>
