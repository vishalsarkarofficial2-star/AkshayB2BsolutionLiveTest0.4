...
interface GjepcRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Applicable GJEPC / export rules framework)
const FAQ_ITEMS = [
  { q: 'What is GJEPC Membership in India?', a: 'The Gem & Jewellery Export Promotion Council (GJEPC) is an Export Promotion Council for India\'s gem and jewellery sector. Eligible businesses engaged in gem and jewellery exports can apply for membership and, where applicable, Registration-Cum-Membership Certificate (RCMC) support.' },
  { q: 'Who can apply for GJEPC membership?', a: 'Proprietorships, partnership firms, LLPs, companies and other eligible business entities engaged in the gem and jewellery trade or exports may apply, subject to GJEPC rules, product category, IEC and supporting documentation.' },
  { q: 'Is IEC required for GJEPC membership?', a: 'For exporter membership and RCMC-related applications, a valid Importer Exporter Code (IEC) and supporting business documents are generally important. Our team checks your documents before submission.' },
  { q: 'What documents are commonly required?', a: 'Common documents can include IEC, PAN, constitution documents such as partnership deed or MOA/AOA, contact details, signature-related documents and manufacturer-exporter proof where applicable. Final requirements depend on applicant category.' },
  { q: 'How much does GJEPC membership cost?', a: 'There is no single fixed fee for every applicant. GJEPC subscription can depend on membership category, export performance and applicable taxes or admission charges. We provide a custom quote after checking your business profile.' },
  { q: 'Why should a gem & jewellery exporter consider GJEPC membership?', a: 'Membership can help eligible exporters access industry representation, export-promotion initiatives, exhibitions, trade information, networking opportunities and other member services offered by the Council, subject to applicable rules.' }
];

const RELATED_SERVICES = [
  {
    title: 'IEC Registration',
    desc: 'Get your Importer Exporter Code ready before starting export-related registrations and international trade.',
    img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  },
  {
    title: 'IEC Renewal / Update',
    desc: 'Keep IEC details updated and compliant for uninterrupted import-export operations.',
    img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  },
  {
    title: 'RCMC Registration',
    desc: 'Professional support for Registration-Cum-Membership Certificate applications with the relevant Export Promotion Council.',
    img: 'https://images.unsplash.com/photo-1521791055366-0d553872125f?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  },
  {
    title: 'AD Code Registration',
    desc: 'Register your bank AD Code with customs for smoother export documentation and shipping bill processing.',
    img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  },
  {
    title: 'ICEGATE Registration',
    desc: 'Get assistance with ICEGATE onboarding for digital customs and import-export filing workflows.',
    img: 'https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  },
  {
    title: 'GST Registration',
    desc: 'Set up GST registration and compliance support for your jewellery trading or export business.',
    img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  },
  {
    title: 'MSME Udyam Registration',
    desc: 'Get Udyam recognition for eligible micro, small and medium enterprises in the gems and jewellery sector.',
    img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your jewellery brand name, logo and market identity in India.',
    img: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  },
  {
    title: 'BIS Registration / Hallmarking Support',
    desc: 'Get guidance for applicable BIS and hallmarking-related compliance for precious metal jewellery businesses.',
    img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=600&auto=format&fit=crop&q=80',
    price: 'Custom Quote'
  }
];

export const GjepcRegistrationPage: React.FC<GjepcRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('GJEPC Membership Assistance Package');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">GJEPC Membership Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  GJEPC membership support helps eligible Indian gem and jewellery businesses prepare for Council membership and RCMC-related requirements. Our team assists with IEC/KYC review, business-document verification, product-category mapping and application guidance so exporters can move forward with greater confidence.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Gem & Jewellery Exporters</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>IEC & KYC Review</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>GJEPC Filing Guidance</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our export-compliance specialist has been assigned to your GJEPC membership enquiry. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            GJEPC / statutory fee as applicable
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of GJEPC Membership Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your business location and constitution help us identify the correct documentation and application support required.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                End-to-end document checklist, IEC/KYC review, application preparation, filing guidance and dedicated support with minimal confusion.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select GJEPC Membership Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="GJEPC Membership Assistance Package">GJEPC Membership Assistance Package — Custom Quote</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get GJEPC Assistance</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                GJEPC Membership Assistance Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused package for gem & jewellery businesses that want professional guidance from document readiness to GJEPC membership / RCMC application support.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    ...
                    <span className="px-3 py-1 rounded bg-yellow-100 text-yellow-900 text-[10px] font-black uppercase tracking-wide">
                      CUSTOM QUOTE AFTER PROFILE CHECK
                    </span>
                  </div>

                  <h3 className="text-2xl font-bold text-[#0D47A1]">GJEPC Exporter Assistance</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    A conversion-focused support package for eligible jewellers, manufacturers, traders and exporters who want to strengthen their export compliance and GJEPC membership readiness.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'IEC, PAN & Business Document Pre-Check',
                      'GJEPC Membership / RCMC Application Guidance',
                      'GJEPC Filing Guidance Support',
                      'Product / Export Category Mapping Support',
                      'Manufacturer Exporter Document Guidance',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('GJEPC Membership Assistance Package');
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is GJEPC Membership in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              GJEPC membership connects eligible gem and jewellery businesses with an industry Export Promotion Council ecosystem. For exporters, membership and RCMC-related compliance can support formal export positioning, industry participation and access to Council services subject to eligibility and prevailing rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for Indian jewellers, gemstone businesses, diamond traders, manufacturers and exporters seeking professional assistance with GJEPC membership and connected export-compliance requirements.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Properly drafted MOA, business constitution document, or business constitution documents clearly define the exporter's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  GJEPC membership does not change your legal business structure. Your proprietorship, partnership, LLP or company continues under its applicable law while GJEPC membership supports your industry/export ecosystem participation.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  For businesses exporting products covered by the Council, the relevant membership/RCMC route can be important for export-promotion and policy-linked requirements. Eligibility and necessity should be checked against current DGFT/GJEPC rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Membership is intended for eligible businesses in the gem and jewellery sector and can support access to industry initiatives, exhibitions, trade information, networking and export-promotion services offered by the Council.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, GJEPC membership support helps gem and jewellery exporters organize the documentation needed for a smoother application. Our team focuses on eligibility checks, document readiness, application guidance and follow-up support.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How GJEPC Membership Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              GJEPC membership is an industry membership process for eligible businesses in the gems and jewellery sector. The exact application path depends on your business constitution, IEC details, exporter/manufacturer status, product category and supporting documents.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After successful processing by the Council, eligible applicants can access the applicable membership certificate and RCMC-related services through the prescribed process. Our role is to help you prepare accurate information and reduce avoidable document gaps.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our export-compliance desk reviews IEC, PAN, constitution documents, contact details and manufacturer-exporter proofs where applicable, then helps prepare the GJEPC membership / RCMC application and follow-up.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Benefits of GJEPC Membership Support
              </h2>
            </div>
              ...
              {[
{
                  ...
                  desc: 'Organize IEC, business and product-category information required for an exporter-focused membership application.'
                },
                {
                  title: 'Industry Recognition',
                  desc: 'GJEPC membership places eligible businesses within India’s organized gem and jewellery export promotion ecosystem.'
                },
                {
                  title: 'Trade Fair & Networking Opportunities',
                  desc: 'Members may access eligible Council exhibitions, buyer-seller initiatives, networking programs and industry events subject to prevailing rules.'
                },
                {
                  title: 'Market & Policy Information',
                  desc: 'Stay closer to sector updates, export trends, trade notices and industry representation relevant to gems and jewellery.'
                },
                {
                  title: 'RCMC / Export Documentation Support',
                  desc: 'Where applicable, membership can support the RCMC framework used for export-promotion related compliance and benefits.'
                },
                {
                  title: 'Professional Application Assistance',
                  desc: 'Reduce avoidable document gaps with pre-checks, application preparation and dedicated follow-up guidance.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for GJEPC Membership
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
{
                  title: 'Keep a Valid IEC Ready',
                  desc: 'Ensure your Importer Exporter Code details are active and match your business records.'
                },
                {
                  title: 'Confirm Business Constitution',
                  desc: 'Keep proprietorship, partnership, LLP or company constitution documents available as applicable.'
                },
                {
                  title: 'Verify PAN & Contact Details',
                  desc: 'PAN, email, mobile number and business details should be accurate and consistent across records.'
                },
                {
                  title: 'Identify Gem & Jewellery Product Category',
                  desc: 'Clearly identify the jewellery, diamond, gemstone, precious-metal or allied export category for which membership is sought.'
                },
                {
                  title: 'Prepare Export Performance Information',
                  desc: 'Where applicable, keep prior-year gem and jewellery export figures ready because membership subscription may depend on export performance.'
                },
                {
                  title: 'Manufacturer Exporter Proof, If Applicable',
                  desc: 'Manufacturer exporters may need relevant industrial or MSME/manufacturing evidence as required by the Council.'
                },
                {
                  title: 'Keep Constitution Supporting Documents Ready',
                  desc: 'Partnership deed, MOA/AOA or other entity documents may be required depending on your business type.'
                },
                {
                  title: 'Pre-Submission Document Review',
                  desc: 'Our team checks the application pack for common mismatches before you proceed with filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for GJEPC Membership Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              GJEPC membership eligibility depends on the applicant’s business activity, gem and jewellery product category, exporter status, IEC and the Council’s prevailing membership rules. The exact category and supporting documents should be checked before filing.
            </p>

            <div className="space-y-3">
              {[
{
                  title: 'Gem & Jewellery Sector Business',
                  desc: 'The applicant should be engaged in an eligible gem, jewellery, diamond, gemstone, precious-metal or allied business/activity covered by GJEPC.'
                },
                {
                  title: 'Valid Importer Exporter Code',
                  desc: 'Exporter applicants should keep a valid IEC and matching business details ready.'
                },
                {
                  title: 'Eligible Business Constitution',
                  desc: 'Proprietorships, partnerships, LLPs, companies and other eligible entities can be evaluated under the applicable membership rules.'
                },
                {
                  title: 'Correct Export Product Classification',
                  desc: 'The applicant should select the relevant export product/category for Council membership.'
                },
                {
                  title: 'Supporting Business Documentation',
                  desc: 'PAN and constitution documents should support the legal identity used in the application.'
                },
                {
                  title: 'Manufacturer Exporter Evidence',
                  desc: 'If applying as a manufacturer exporter, additional manufacturing/industry proof may be required.'
                },
                {
                  title: 'Profile Review Before Filing',
                  desc: 'We verify the available documents and flag gaps before preparing the final application support pack.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for GJEPC Membership Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process a GJEPC membership enquiry smoothly, keep your IEC, PAN, business constitution proof, contact details and relevant exporter/manufacturer documents ready. Final documentation can vary by membership category and applicant profile.
            </p>
              ...
              {[
{
                  ...
                  desc: 'Self-certified IEC copy/details matching the applicant business.'
                },
                {
                  title: 'PAN of the Business / Applicant',
                  desc: 'PAN details should correspond with the entity or proprietor applying for membership.'
                },
                {
                  title: 'Partnership Deed / LLP / Company Documents',
                  desc: 'Constitution proof such as partnership deed, incorporation documents or MOA/AOA, as applicable.'
                },
                {
                  title: 'Email, Mobile & Communication Details',
                  desc: 'Active contact information used for application communication and account access.'
                },
                {
                  title: 'Signature / Authorization Documents',
                  desc: 'Signature and authorization-related documents may be required in the format prescribed by the Council.'
                },
                {
                  title: 'Manufacturer Exporter Proof, If Applicable',
                  desc: 'Relevant manufacturing, SSI/MSME/industry proof may be required for manufacturer-exporter classification.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step GJEPC Membership Registration Process
              </h2>
            </div>
...
{
                  step: 'Step 1',
                  title: 'Eligibility & Business Profile Check',
                  desc: 'We review your business constitution, IEC, export activity and gem & jewellery product category.'
                },
                {
                  step: 'Step 2',
                  title: 'Document Checklist & Verification',
                  desc: 'We organize IEC, PAN, constitution documents, contact details and manufacturer-exporter proof where applicable.'
                },
                {
                  step: 'Step 3',
                  title: 'Select Appropriate Membership Category',
                  desc: 'We guide you on the suitable GJEPC membership / exporter category based on the information available.'
                },
                {
                  step: 'Step 4',
                  title: 'Prepare Membership / RCMC Application',
                  desc: 'The required application information and supporting documents are prepared for submission through the applicable process.'
                },
                {
                  step: 'Step 5',
                  title: 'Fee & Submission Guidance',
                  desc: 'We explain the custom consultancy quote and applicable GJEPC membership/admission/tax fees before submission.'
                },
                {
                  step: 'Step 6',
                  title: 'Follow-Up & Certificate Guidance',
                  desc: 'We assist with application follow-up and guide you on accessing the applicable membership certificate / RCMC after approval.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                GJEPC Membership & Exporter Status
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  GJEPC membership is an industry/export membership and does not create a separate legal entity. The applicant continues to operate through its existing proprietorship, partnership, LLP, company or other eligible business constitution.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  After membership, businesses should keep IEC, GST, entity details and GJEPC profile information updated and complete renewal or other Council requirements within the applicable timelines.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our compliance team guides you on membership documentation, IEC/GST alignment, exporter profile updates and other related export registrations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, export businesses must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>

            <div className="space-y-3">
              {[
{
                  title: 'Keep IEC Details Updated',
                  desc: 'Maintain accurate IEC and business information for uninterrupted export-related processes.'
                },
                {
                  title: 'Maintain GST & Business Records',
                  desc: 'Keep GST and legal entity details aligned with your application and export documentation.'
                },
                {
                  title: 'Renew Membership on Time',
                  desc: 'Complete annual GJEPC membership renewal and applicable subscription requirements within the prescribed period.'
                },
                {
                  title: 'Update Constitution / Contact Changes',
                  desc: 'Inform the relevant systems/Council when there are changes in entity constitution, address, contact details or authorized persons.'
                },
                {
                  title: 'Maintain Export Performance Records',
                  desc: 'Keep accurate export data because subscription or membership classification can depend on previous export performance.'
                },
                {
                  title: 'Track RCMC & Related Validity',
                  desc: 'Monitor the validity and update requirements of RCMC and connected export registrations as applicable.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                GJEPC Membership vs Basic Export Registrations
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-rose-700 border-r border-slate-200">
                      Does not alter entity liability
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax follows underlying business entity
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      As per underlying business entity
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Professional service firms / businesses</td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax & Compliance Considerations for Gem & Jewellery Exporters
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              GJEPC membership does not by itself create a separate tax status. Income-tax, GST, customs and export compliance depend on the applicant’s underlying legal entity, transactions and applicable laws.
            </p>

            <div className="space-y-3">
              {[
{
                  title: 'Tax Follows Your Business Entity',
                  desc: 'Income-tax treatment depends on whether the exporter is a proprietorship, partnership, LLP or company.'
                },
                {
                  title: 'GST Compliance for Jewellery Trade',
                  desc: 'Maintain correct GST registration, invoicing and return compliance based on your actual business and export transactions.'
                },
                {
                  title: 'Export Documentation Consistency',
                  desc: 'IEC, GST, bank and shipping/customs records should carry consistent legal business information.'
                },
                {
                  title: 'Maintain Books & Supporting Records',
                  desc: 'Keep purchase, sales, export, banking and inventory records required under applicable tax and business laws.'
                },
                {
                  title: 'Professional Advice for High-Value Transactions',
                  desc: 'Gem and jewellery transactions can involve specialized tax, customs and valuation issues; obtain transaction-specific advice where needed.'
                },
                {
                  title: 'Compliance Support',
                  desc: 'Our team can coordinate membership documentation with related GST, IEC and export-compliance requirements.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Gem and jewellery exporters may use working-capital limits, export finance, packing credit, bill discounting and other banking facilities depending on turnover, collateral, transaction documents and lender policy.
            </p>
              ...
              {[
{
                  ...
                  desc: 'Eligible exporters may explore pre-shipment working-capital finance from banks against confirmed export requirements.'
                },
                {
                  title: 'Post-Shipment Export Finance',
                  desc: 'Banks may offer finance against eligible export bills and receivables subject to documentation and credit approval.'
                },
                {
                  title: 'Working Capital / Cash Credit',
                  desc: 'Jewellery businesses can evaluate suitable working-capital facilities based on turnover, stock, receivables and banking profile.'
                },
                {
                  title: 'MSME Finance, If Eligible',
                  desc: 'Udyam-registered eligible businesses may explore MSME-focused lending and guarantee schemes subject to lender criteria.'
                },
                {
                  title: 'Bank Guarantee & Trade Facilities',
                  desc: 'Exporters may require bank guarantees, forex and other trade-finance facilities depending on transaction structure.'
                },
                {
                  title: 'Buyer / Supplier Credit',
                  desc: 'Commercial credit arrangements can support inventory and international trade cycles where contractually appropriate.'
                },
                {
                  title: 'Documentation Support',
                  desc: 'We can help organize registration and compliance documents commonly requested during business finance applications.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-slate-200">
        ...
        <section id="why-akshayb2b" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
{
                  title: 'Exporter-Focused Profile Review',
                  desc: 'We check your IEC, business constitution, product category and available exporter documents before application preparation.'
                },
                {
                  title: 'Document Gap Identification',
                  desc: 'Our team flags missing or inconsistent details early to reduce avoidable back-and-forth.'
                },
                {
                  title: 'Membership / RCMC Guidance',
                  desc: 'Get practical assistance with the applicable GJEPC membership and RCMC-related application workflow.'
                },
                {
                  title: 'Clear Custom Pricing',
                  desc: 'No misleading fixed price: the consultancy quote is shared after reviewing your profile, while applicable GJEPC fees remain separate.'
                },
                {
                  title: 'Related Export Compliance Support',
                  desc: 'Access support for IEC, AD Code, ICEGATE, GST, MSME and other connected export registrations when needed.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Digital document collection and guided workflows help reduce unnecessary paperwork and repeated follow-ups.',
                  icon: Clock
                },
                {
                  title: 'Affordable Transparent Pricing',
                  desc: 'Clear consultancy scope with a custom quote after profile review; applicable GJEPC membership, admission, tax or statutory fees are communicated separately.',
                  icon: Tag
                },
                {
                  title: 'Trusted by Thousands',
                  desc: 'Pan-India assistance for businesses seeking registration, tax and export-compliance support.',
                  icon: Users
                },
                {
                  title: 'Automated Compliance Alerts',
                  desc: 'Structured follow-up support helps you stay aware of membership and connected compliance requirements.',
                  icon: Zap
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            <span className="text-xs font-black uppercase tracking-widest text-[#FF5A00] bg-white/10 px-3 py-1 rounded-full border border-white/20">
              Grow Your Jewellery Export Business
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Apply for GJEPC Membership with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Get professional GJEPC membership assistance built for Indian gem & jewellery businesses. We focus on document readiness, clear communication and end-to-end application guidance—without displaying a misleading fixed fee.
            </p>
            ...
            <div className="bg-gradient-to-r from-[#0B3D91] via-[#0D47A1] to-[#082a66] text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-4 max-w-md relative z-10">
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
                  Track Your GJEPC Application Support
                </h3>
                <p className="text-xs text-slate-200 leading-relaxed">
                  Download the akshayb2bsolutions mobile application for iOS &amp; Android. Access your submitted documents, application updates and compliance support from our team.
                </p>
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  <a
