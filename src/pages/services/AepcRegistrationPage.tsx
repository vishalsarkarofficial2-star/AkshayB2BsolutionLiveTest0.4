...
interface AepcRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian AEPC Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is AEPC Registration in India?', a: 'AEPC Registration generally refers to obtaining membership / Registration-Cum-Membership Certificate (RCMC) with the Apparel Export Promotion Council for eligible apparel and garment exporters in India.' },
  { q: 'Who should apply for AEPC RCMC?', a: 'Manufacturer exporters, merchant exporters and other eligible exporters actually engaged in garment or apparel exports can apply, subject to AEPC eligibility, DGFT requirements and the applicable membership category.' },
  { q: 'Why is AEPC RCMC important for apparel exporters?', a: 'RCMC is an important export registration for eligible apparel exporters and is used for accessing applicable Foreign Trade Policy / Exim Policy benefits. AEPC membership can also provide access to export promotion initiatives, policy support, international fairs, buyer-seller meets and industry resources.' },
  { q: 'How is AEPC RCMC applied for?', a: 'RCMC applications, renewals and amendments are handled through the DGFT e-RCMC platform. Applicants should have the required DGFT profile, IEC and eligible digital authentication such as DSC or Aadhaar-based e-sign, as applicable.' },
  { q: 'What documents are generally required for AEPC Registration?', a: 'The exact checklist depends on exporter type and membership category, but commonly includes IEC-linked exporter details, PAN/entity information, business and export details, authorization/signatory information and supporting documents requested through the DGFT e-RCMC / AEPC process.' },
  { q: 'Is AEPC Registration fee fixed for every exporter?', a: 'No. AEPC membership / subscription charges can vary by exporter category, status and the applicable schedule. We provide a custom quotation after checking your exporter profile and required service scope.' }
]

// Related services cross-linking items — sourced from AEPC-adjacent structures
const RELATED_SERVICES = [
  {
    title: 'IEC Registration',
    desc: 'Importer Exporter Code registration support for businesses starting or expanding apparel exports from India.',
  ...
  },
  {
    ...
    desc: 'Registration-Cum-Membership Certificate support through the appropriate Export Promotion Council or authority.',
    img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'AD Code Registration',
    desc: 'Guidance for AD Code and port-related customs formalities for apparel exporters shipping goods from India.',
    img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration and compliance support for eligible garment manufacturers, merchant exporters and apparel businesses.',
    img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your apparel brand, clothing label and logo before scaling into domestic and international markets.',
    img: 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'MSME Udyam Registration',
    desc: 'Udyam registration support for eligible apparel manufacturers, exporters and textile-related MSMEs.',
  ...
  },
  {
    ...
    desc: 'Practical assistance with export-related business documents, shipping readiness and compliance coordination.',
    img: 'https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'Company Registration',
    desc: 'Business incorporation support for apparel brands, garment manufacturers and export-focused companies.',
    img: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'Apparel Export Compliance Consultation',
    desc: 'Combined roadmap for IEC, RCMC, GST, AD Code, brand protection and export-readiness requirements.',
    img: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  }
]

export const AepcRegistrationPage: React.FC<AepcRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('AEPC Registration Support — Custom Quote');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">AEPC Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Grow your apparel exports with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      AEPC / government charges as applicable
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  AEPC Registration in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an AEPC may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Shirt className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Garment Exporter Focused</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based AEPC / RCMC specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                    ...
                    <>
                      ...
                      {/* Default Price Core export identificationlight Box */}
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Your State / Export Business Location *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The applicable registration authority and documentation depend on whether your AEPC is formed as a Society, Trust, or Section 8 Company.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete AEPC name-check, MOA / Trust Deed / Society Rules drafting, government filing support, and registration guidance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select AEPC Registration Support *
                              </label>
                              <select
                              ...
                              >
                                <option value="AEPC Registration Support — Custom Quote">AEPC Registration Package — Contact for Price + AEPC / Statutory Chargess</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get AEPC Quote</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Apparel Export Growth Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your AEPC Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional AEPC registration guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    <span className="px-3 py-1 rounded bg-orange-100 text-orange-900 text-[10px] font-black uppercase tracking-wide">
                      APPAREL EXPORTER GROWTH PACKAGE
                    </span>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">AEPC Export Growth Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    For eligible garment manufacturers and merchant exporters who want AEPC / RCMC support plus a practical checklist for the next export-compliance steps.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'AEPC / RCMC Eligibility & Profile Review',
                      'IEC & DGFT Profile Readiness Check',
                      'DGFT / AEPC Filing Support',
                      'Basic AEPC Name Availability Check',
                      'Required Document Checklist & Verification',
                      'Dedicated AEPC / Export Registration Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('AEPC Registration Support — Custom Quote');
                ...
                >
                  Get Started with AEPC Export Growth Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Apparel Export Overview
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is a AEPC in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              AEPC registration gives a non-governmental organization a recognized legal identity to operate for lawful charitable or social-welfare objectives. The organization may be structured as a Society, Trust, or Section 8 Company, with its governing documents defining its purpose, members or trustees, management, and rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Garment manufacturers, merchant exporters, apparel brands and export-oriented businesses already exporting or preparing to export eligible apparel products from India.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Open More Export Opportunities:</strong>
                  Properly drafted MOA, Trust Deed, or Society Rules clearly define the AEPC's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The legal identity and liability framework depends on whether the AEPC is formed as a Society, Trust, or Section 8 Company; the governing documents and applicable law determine the responsibilities of members, trustees, directors, and office bearers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Important for Policy Benefits:</strong>
                  Registration under the Indian AEPC Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow members / trustees in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Build Export Credibility:</strong>
                  An AEPC is not formed for distributing profits to members. Eligible organizations can pursue donations, grants, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, AEPC registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How AEPC Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              AEPC registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the AEPC registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our export-compliance desk reviews your IEC/DGFT profile, exporter category and documents, helps prepare the e-RCMC application and supports submission and clarification handling.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Access to Apparel Export Promotion Ecosystem',
                  desc: 'AEPC membership connects eligible exporters with a sector-focused council working specifically for Indian apparel exports.'
                },
                {
                  title: 'Support for Foreign Trade Policy Benefits',
                  desc: 'RCMC is an important supporting document for eligible exporters seeking applicable benefits under Foreign Trade / Exim Policy schemes.'
                },
                {
                  title: 'International Fairs & Buyer-Seller Meets',
                  desc: 'Members can explore participation in overseas fairs, buyer-seller meets and market-access initiatives subject to event and programme eligibility.'
                },
                {
                  title: 'Industry & Policy Representation',
                  desc: 'AEPC works with the Government of India on policy matters affecting the apparel export sector, giving members an industry platform.'
                },
                {
                  title: 'Market Intelligence & Export Resources',
                  desc: 'Apparel exporters can benefit from sector updates, publications, market information and export-oriented resources provided by AEPC.'
                },
                {
                  title: 'Stronger Export Business Positioning',
                  desc: 'A sector-specific RCMC can strengthen your export profile when dealing with overseas buyers, institutions and trade-promotion opportunities.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Registering Your AEPC
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique AEPC Name Selection',
                ...
                {
                  title: 'Clearly Defined AEPC Objectives and Governance',
                ...
                },
                {
                  ...
                  desc: 'Clearly state the AEPC objectives, governance, membership or trusteeship, powers, duties, meetings, accounts, and dissolution provisions in the governing document.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                AEPC Registration Eligibility
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a AEPC in India, there must be a minimum of two members / trustees and a maximum of twenty. All members / trustees must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Garment manufacturers exporting eligible apparel products can apply subject to AEPC and DGFT requirements.'
                },
                {
                  title: 'Merchant Exporters',
                  desc: 'Eligible merchant exporters actually exporting garments can also qualify for AEPC registration / membership.'
                },
                {
                  title: 'Valid IEC & DGFT Profile',
                  desc: 'The exporter should have an active IEC and a usable DGFT profile for the e-RCMC application process.'
                },
                {
                  title: 'Eligible Apparel / Garment Export Activity',
                  desc: 'The principal export activity should fall within the apparel/garment domain represented by AEPC.'
                },
                {
                  title: 'Correct Applicant & Authorized Signatory',
                  desc: 'Business constitution and signatory details should match the IEC, PAN and DGFT profile records.'
                },
                {
                  title: 'Applicable Membership Category',
                  desc: 'Registered Exporter / Member Exporter and other status-based categories may have different eligibility or subscription requirements.'
                },
                {
                  title: 'Pre-Registration Eligibility Check',
                  desc: 'We review your exporter profile first and tell you what is needed before you proceed with the application.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Commonly Required for AEPC / RCMC
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your AEPC registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'IEC & DGFT Exporter Profile',
                  desc: 'Active IEC-linked exporter details and DGFT login/profile information needed for the e-RCMC process.'
                },
                {
                  title: 'PAN & Business Constitution Details',
                  desc: 'PAN and entity information for proprietorship, partnership, AD Code, company or other eligible exporter structure.'
                },
                {
                  title: 'Registered Business Address',
                  desc: 'Current business address and supporting records consistent with the exporter profile.'
                },
                {
                  title: 'Authorized Signatory Details',
                  desc: 'Details of the person authorized to submit and digitally authenticate the application.'
                },
                {
                  title: 'Apparel Export / Product Details',
                  desc: 'Information about garment/apparel export activity and exporter category required for AEPC registration.'
                },
                {
                  title: 'Supporting Documents Requested by DGFT / AEPC',
                  desc: 'Any declarations, authorization or additional records required under the applicable current e-RCMC workflow.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step AEPC / RCMC Registration Process
              </h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  step: 'Step 1',
                  title: 'Exporter Eligibility Review',
                  desc: 'We review your apparel business, IEC and exporter category to confirm the likely AEPC / RCMC route.'
                },
                {
                  step: 'Step 2',
                  title: 'DGFT Profile & Document Check',
                  desc: 'Verify DGFT access, IEC-linked details, business records and signatory readiness before application.'
                },
                {
                  step: 'Step 3',
                  title: 'Select AEPC / RCMC Category',
                  desc: 'Identify the correct council, exporter type and membership category based on your apparel export profile.'
                },
                {
                  step: 'Step 4',
                  title: 'Prepare & Submit e-RCMC Application',
                  desc: 'Complete the DGFT e-RCMC application and upload or provide the required supporting information.'
                },
                {
                  step: 'Step 5',
                  title: 'Digital Authentication & Clarification Support',
                  desc: 'Complete the required DSC/Aadhaar-based authentication and address any application clarification or correction.'
                },
                {
                  step: 'Step 6',
                  title: 'RCMC & Export Growth Guidance',
                  desc: 'After successful registration, receive guidance on AEPC membership opportunities, export events and related compliance steps.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an AEPC depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the AEPC structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate AEPC structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, AEPCs must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Renew AEPC Membership / Subscription',
                  desc: 'Pay the applicable annual subscription within the notified period to keep membership services active.'
                },
                {
                  title: 'Keep RCMC Current',
                  desc: 'Complete renewal, amendment or profile updates through the DGFT e-RCMC system when required.'
                },
                {
                  title: 'Update Business / IEC Changes',
                  desc: 'Keep IEC, address, entity and authorized-signatory information consistent across DGFT and export records.'
                },
                {
                  title: 'Use Export Promotion Opportunities',
                  desc: 'Track AEPC fairs, buyer-seller meets, market-access programmes and member opportunities relevant to your target markets.'
                },
                {
                  title: 'Maintain GST / Customs / Banking Compliance',
                  desc: 'AEPC registration does not replace GST, customs, AD Code, shipping or banking requirements for exports.'
                },
                {
                  title: 'Protect Your Apparel Brand',
                  desc: 'Consider trademark and related brand-protection steps before expanding through overseas buyers and marketplaces.'
                },
                {
                  title: 'akshayb2bsolutions Ongoing Export Support',
                  desc: 'We can assist with RCMC renewal, IEC, AD Code, GST and other export-readiness registrations.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                AEPC vs Other Business Structures
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold border-r border-blue-800">Sole IEC</th>
                    <th className="p-3.5 font-bold border-r border-blue-800">AD Code</th>
                    <th className="p-3.5 font-bold">GST / Other Export Compliance</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Indian AEPC Act, 1932
                    </td>
                    <td className="p-3.5 border-r border-slate-200">No Single Central Statute</td>
                    <td className="p-3.5 border-r border-slate-200">AD Code Act, 2008</td>
                    <td className="p-3.5">Tax / sector dependent</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">2. Number of Owners</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Eligible apparel exporters
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">Exporter bank/port profile</td>
                    <td className="p-3.5">Business/activity dependent</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on AEPC structure and applicable exemptions
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Separate tax compliance</td>
                    <td className="p-3.5 border-r border-slate-200">Flat 30% on AD Code</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Exporter / membership category
                    </td>
                    <td className="p-3.5 border-r border-slate-200">IEC-holder controlled</td>
                    <td className="p-3.5 border-r border-slate-200">As per AD Code Agreement</td>
                    <td className="p-3.5">Tax / compliance specific</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Membership / RCMC renewal based</td>
                    <td className="p-3.5 border-r border-slate-200">Bank / port updates</td>
                    <td className="p-3.5">Depends on business compliance</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Core export identification for apparel export ecosystem</td>
                    <td className="p-3.5 border-r border-slate-200">Core export identification</td>
                    <td className="p-3.5 text-orange-800 font-semibold">Core export identificationest (Global Standards)</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Importers & exporters</td>
                    <td className="p-3.5 border-r border-slate-200">Port-based exporters</td>
                    <td className="p-3.5">Core export identification-Growth Startups &amp; Tech</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for AEPCs in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              AEPC tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on AEPC Structure',
                  desc: 'Tax liability and exemptions depend on whether the AEPC is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible AEPCs must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working members / trustees are taxable in the founder / trustee\'s hands but deductible for the AEPC, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible AEPCs should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the AEPC structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Apparel Export Growth Opportunities
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              AEPCs generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'International Apparel Fairs',
                  desc: 'Explore AEPC-supported participation in overseas apparel fairs and promotional events subject to programme eligibility.'
                },
                {
                  title: 'Buyer-Seller Meets',
                  desc: 'Use sector networking and buyer-seller platforms to connect with potential international sourcing partners.'
                },
                {
                  title: 'Market Access Initiatives',
                  desc: 'Eligible members may benefit from market-access support linked to approved export-promotion programmes.'
                },
                {
                  title: 'Export Market Intelligence',
                  desc: 'Use AEPC publications, sector data and market resources to identify demand trends and destination opportunities.'
                },
                {
                  title: 'Policy & Industry Updates',
                  desc: 'Stay informed about policy matters and sector developments affecting India\'s apparel export industry.'
                },
                {
                  title: 'Trade Finance & Working Capital',
                  desc: 'Eligible exporters can separately explore bank working-capital and trade-finance facilities based on their business profile.'
                },
                {
                  title: 'akshayb2bsolutions Export Setup Support',
                  desc: 'We help organize the registrations and documentation needed to move from domestic apparel business to export-ready operations.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-slate-200">
        ...
        <section id="why-akshayb2b" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Exporter Profile & AEPC Eligibility Review',
                ...
                {
                  title: 'e-RCMC Application Readiness Check',
                  desc: 'Our compliance specialists draft a legally sound AEPC deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                  title: 'Application & Clarification Support',
                  desc: 'We help with application submission and document corrections or clarifications if they arise.'
                },
                {
                  title: 'Export-Ready Next-Step Checklist',
                  desc: 'After AEPC / RCMC, get a practical checklist covering IEC, AD Code, GST, shipping and brand-readiness steps relevant to exporters.'
                },
                {
                  title: 'Membership Opportunity Guidance',
                  desc: 'Understand how to track AEPC fairs, buyer-seller meets, market-access initiatives and membership updates after registration.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                {
                  title: 'Custom Quote, No Guesswork',
                  desc: 'Your quote is shared after checking your exporter category and service scope, so you know what support is included before proceeding.',
                  icon: Tag
                },
                {
                ...
                {
                  title: 'Secure Exporter Documentation',
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your AEPC with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their AEPC with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
