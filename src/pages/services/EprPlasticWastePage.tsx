...
interface EprPlasticWastePageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — EPR Plastic Waste (India / CPCB)
const FAQ_ITEMS = [
  { q: 'What is EPR Plastic Waste Registration in India?', a: 'EPR Plastic Waste Registration is the compliance registration required for covered entities dealing with plastic packaging under India’s Plastic Waste Management framework. Producers, Importers and Brand Owners (PIBOs), and other covered entities, register through the centralized EPR portal and fulfil category-wise obligations.' },
  { q: 'Who needs EPR Plastic Waste registration?', a: 'Businesses that introduce covered plastic packaging into the Indian market may need registration as a Producer, Importer or Brand Owner. Certain plastic waste processors and manufacturers/importers of plastic raw material may also have separate registration obligations.' },
  { q: 'What documents are generally required?', a: 'Commonly requested details include PAN, GST, CIN or business registration proof where applicable, authorized-person KYC, registered-office proof, product and plastic-packaging details, state-wise operations, and supporting declarations required on the EPR portal.' },
  { q: 'How long does EPR Plastic Waste registration take?', a: 'Processing time depends on document readiness, application accuracy, authority review and portal queries. We first review your business and packaging data, then give you a practical timeline and commercial quote.' },
  { q: 'Is there a fixed price for EPR Plastic Waste registration?', a: 'No single fixed professional fee fits every business. Pricing depends on your entity type, number of states or units, packaging categories, data volume and compliance scope. Contact us for a tailored quote.' },
  { q: 'What happens after registration?', a: 'Registered entities must continue to meet applicable EPR obligations, maintain records, file required returns or reports, and fulfil category-wise plastic packaging targets through permitted compliance routes.' }
]

// Related services cross-linking items — environmental & EPR compliance
const RELATED_SERVICES = [
  { title: 'EPR E-Waste Registration', desc: 'Registration and compliance support for producers covered under India’s e-waste EPR framework.', img: 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' },
  { title: 'EPR Battery Waste Registration', desc: 'End-to-end support for battery EPR registration, documentation and ongoing compliance.', img: 'https://images.unsplash.com/photo-1609592424824-86c7c6939892?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' },
  { title: 'Plastic Waste Processor Registration', desc: 'Registration support for eligible recyclers and plastic waste processors on the EPR portal.', img: 'https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' },
  { title: 'Consent to Establish (CTE)', desc: 'Pollution-control consent support for setting up eligible industrial and processing units.', img: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' },
  { title: 'Consent to Operate (CTO)', desc: 'Application and documentation support for pollution-control operating consent.', img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' },
  { title: 'Environmental Compliance Advisory', desc: 'Practical compliance guidance for waste, pollution-control and environmental filings.', img: 'https://images.unsplash.com/photo-1531058020387-3be344556be6?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible Indian micro, small and medium enterprises.', img: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' },
  { title: 'GST Registration', desc: 'GST registration support for businesses requiring indirect-tax registration in India.', img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' },
  { title: 'IEC Registration', desc: 'Importer Exporter Code registration support for businesses engaged in cross-border trade.', img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80', price: 'Contact for Price' }
]

export const EprPlasticWastePage: React.FC<EprPlasticWastePageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Producer / Importer / Brand Owner');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('EPR Plastic Waste Compliance Package');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">EPR Plastic Waste</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span className="text-white">CPCB / SPCB EPR Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Get your EPR Plastic Waste compliance plan with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Final quote after eligibility & scope review
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  EPR Plastic Waste compliance helps covered Indian businesses fulfill Extended Producer Responsibility obligations for plastic packaging. Our team supports Producers, Importers and Brand Owners (PIBOs) with eligibility review, category-wise packaging data preparation, centralized EPR portal filing and ongoing compliance guidance.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>PIBO Eligibility Check</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Packaging Data Mapping</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our EPR Plastic Waste compliance specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of EPR Plastic Waste Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your registration route and documentation depend on your EPR role, operating states, units, plastic packaging categories and business profile.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get eligibility assessment, packaging-category mapping, document review, EPR portal application support, query handling and post-registration compliance guidance in one managed service.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select EPR Plastic Waste Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="EPR Plastic Waste Compliance Package">EPR Plastic Waste Compliance Package — Contact for Price</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Tailored EPR Compliance Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your EPR Plastic Waste Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One conversion-focused package covering eligibility review, documentation, plastic packaging data mapping, EPR portal filing assistance and compliance guidance. Pricing is shared after reviewing your exact business scope.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">EPR Plastic Waste Compliance Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Built for Producers, Importers and Brand Owners that need a clear, professionally managed EPR Plastic Waste registration and compliance journey.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-lg text-slate-400">Scope-based</span>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'PIBO / Entity Eligibility & Applicability Review',
                      'Plastic Packaging Category & Quantity Data Mapping',
                      'Document Checklist, Review & Application Preparation',
                      'Centralized EPR Portal Filing Assistance',
                      'Authority Query / Clarification Support',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('EPR Plastic Waste Compliance Package');
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is EPR Plastic Waste Compliance in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              Extended Producer Responsibility (EPR) for plastic packaging places defined compliance responsibility on covered businesses that introduce plastic packaging into the Indian market. Registration and ongoing obligations are handled through the centralized EPR framework, with responsibilities varying by entity role and plastic packaging category.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for Producers, Importers and Brand Owners (PIBOs), plus businesses that need clarity on whether their plastic packaging activities trigger EPR registration or ongoing obligations.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Category-Wise Compliance:</strong>
                  Plastic packaging obligations are assessed category-wise, so correct classification and quantity data are essential before filing and target planning.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Centralized EPR Registration:</strong>
                  Covered entities register through the centralized EPR portal and must keep their business, packaging and compliance information accurate and up to date.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Registration Is a Compliance Requirement:</strong>
                  Covered entities should not carry on regulated activities without the required EPR registration, making correct applicability assessment an important first step.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Ongoing EPR Responsibility:</strong>
                  Registration is only the beginning. Ongoing responsibilities may include target fulfilment, record maintenance, returns, recycled-content obligations and permitted end-of-life compliance routes.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, EPR Plastic Waste compliance requires accurate business classification, plastic packaging data and consistent portal compliance. Our team helps reduce confusion, avoid preventable filing errors and keep your compliance journey organized.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How EPR Plastic Waste Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              EPR Plastic Waste registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a business entity type.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the registered entity can proceed with its applicable EPR obligations. Accurate records, category-wise data and timely compliance are important because registrations and target fulfilment are tied to the information declared on the portal.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk helps organize KYC and business documents, plastic packaging data, declarations and portal inputs, then supports filing, clarification responses and post-registration next steps.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Businesses Choose Professional EPR Support
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Avoid Applicability Confusion', desc: 'Get clarity on whether your business falls under Producer, Importer, Brand Owner or another covered EPR role before you file.' },
                { title: 'Accurate Packaging Classification', desc: 'Map plastic packaging into the correct category and organize quantity data to reduce preventable portal errors.' },
                { title: 'Faster Document Readiness', desc: 'Receive a structured checklist and professional review so missing KYC, business proofs and declarations are identified early.' },
                { title: 'Managed Portal Filing', desc: 'Get support for application preparation, portal submission and authority queries instead of handling the process alone.' },
                { title: 'Better Ongoing Compliance Control', desc: 'Understand the records, targets, returns and evidence you may need after registration.' },
                { title: 'Dedicated Compliance Assistance', desc: 'Work with a single support team for registration and ongoing EPR Plastic Waste compliance questions.' }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for EPR Plastic Waste Registration
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Identify Your EPR Role',
                  desc: 'Confirm whether you operate as a Producer, Importer, Brand Owner or another covered entity under the applicable plastic packaging framework.'
                },
                {
                  title: 'Map Plastic Packaging Categories',
                  desc: 'Identify the plastic packaging categories used or introduced into the market and organize category-wise quantity information.'
                },
                {
                  title: 'Prepare Sales / Procurement / Import Data',
                  desc: 'Compile product-wise and category-wise plastic packaging information carefully so your application and future compliance calculations are based on consistent data.'
                },
                {
                  title: 'Keep Authorized Person KYC Ready',
                  desc: 'Ensure each authorized person\'s PAN Card and Aadhaar Card details match identically and are linked to an active mobile number for OTP verification.'
                },
                {
                  title: 'Prepare Business & Registered Office Proof',
                ...
                {
                  title: 'Prepare EPR Declarations & Supporting Documents',
                  desc: 'Prepare the declarations, authorizations and supporting documents required for your entity type and EPR application.'
                },
                {
                  title: 'Check Multi-State / Multi-Unit Requirements',
                  desc: 'Review whether separate registrations or additional disclosures are needed based on states, units or sub-categories of operation.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility / Applicability for EPR Plastic Waste Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              EPR Plastic Waste applicability depends on what your business does with plastic packaging. Producers, Importers and Brand Owners are key covered categories, while certain processors and raw-material related entities may have separate registration obligations.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Authorized Persons',
                  desc: 'Applicability depends on your business role, including Producer, Importer, Brand Owner, Plastic Waste Processor or other categories covered by the rules.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'The applicant entity must have the business registrations, tax details and authorized-person information required for its category and portal filing.'
                },
                {
                  title: 'Unique EPR Plastic Waste Name Requirement',
                  desc: 'The EPR Plastic Waste must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written EPR Plastic Waste Deed',
                  desc: 'Accurate plastic packaging category, quantity, product and operational information should be available for the relevant reporting period.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The EPR Plastic Waste must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a EPR Plastic Waste.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions reviews business KYC, packaging information and application inputs before filing to reduce avoidable discrepancies.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your EPR Plastic Waste application smoothly, keep business-registration records, tax details, authorized-person KYC, registered-office proof, product information, and plastic packaging data ready. Exact requirements vary by entity role and application scope.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Authorized Persons\' Identity Proof (PAN Cards)',
                  desc: 'Scanned copies of each authorized person\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Authorized Persons\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Authorized-person identity and address proof such as Aadhaar, PAN or other portal-accepted KYC, as applicable.'
                },
                {
                ...
                {
                  title: 'Signed EPR declarations / supporting documents',
                  desc: 'Authorization letter, declarations and other entity-specific supporting documents required for the EPR application.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our compliance team helps prepare authorization formats, declarations, data sheets and supporting documents according to the applicable EPR portal requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step EPR Plastic Waste Registration Process
              </h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  step: 'Step 1', title: 'Applicability & Role Assessment', desc: 'We review your business model to identify the correct EPR role, operating scope and likely registration requirements.'
                },
                {
                  step: 'Step 2', title: 'Document & Packaging Data Collection', desc: 'Share business KYC, tax details, authorized-person documents, product information and category-wise plastic packaging data.'
                },
                {
                  step: 'Step 3', title: 'Application Preparation & Data Validation', desc: 'Our team checks the information for consistency and prepares the registration inputs and declarations required for filing.'
                },
                {
                  step: 'Step 4', title: 'Centralized EPR Portal Filing', desc: 'We assist with submission on the applicable EPR portal using the verified business and packaging information.'
                },
                {
                  step: 'Step 5', title: 'Query / Clarification Support', desc: 'If the authority raises observations or requests clarification, we help organize and submit an appropriate response.'
                },
                {
                  step: 'Step 6', title: 'Registration & Ongoing Compliance Guidance', desc: 'After registration, we guide you on key next steps such as records, target planning, returns and other applicable EPR obligations.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Regulatory Status of EPR Plastic Waste Registration
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an EPR Plastic Waste depends on its structure. A company has a separate corporate identity, while other registered entity structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance may include category-wise target fulfilment, record maintenance, annual returns, recycled-content obligations and other portal reporting applicable to your entity.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Registration supports lawful operation under the EPR framework, but approval does not replace ongoing target fulfilment, record keeping or other statutory obligations.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The registered entity remains responsible for the accuracy of information submitted and for meeting its applicable EPR obligations under the plastic waste framework.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our compliance advisors explain your EPR role, packaging categories, registration scope, ongoing target obligations and practical post-registration compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, covered entities must continue to meet applicable EPR obligations, maintain records and complete required portal compliances to reduce the risk of notices, environmental compensation or registration issues.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the EPR Plastic Waste\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered EPR Plastic Waste name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual EPR Plastic Waste Compliance & Tax Filing',
                  desc: 'File the EPR Plastic Waste\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                  title: 'Report Changes to the relevant registering authority',
                  desc: 'Report applicable changes to governing documents, authorized representatives, directors, registered office, or other particulars to the relevant authority.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the EPR Plastic Waste employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                EPR Plastic Waste — Key Compliance Areas
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Indian EPR Plastic Waste Act, 1932
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Authorized Persons
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Authorized Persons</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on EPR Plastic Waste structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Authorized Persons
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Commercial & Compliance Implications of EPR Plastic Waste
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              EPR Plastic Waste is primarily an environmental compliance requirement. The commercial impact depends on your packaging volumes, entity role, compliance targets, recycling/reuse obligations and the evidence required to fulfil them.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on EPR Plastic Waste Structure',
                  desc: 'Registration cost and ongoing compliance effort vary by entity role, packaging category, number of units or states and quantity data.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Covered businesses should budget for ongoing EPR fulfilment and record-keeping rather than treating registration as a one-time compliance expense.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working authorized persons are taxable in the authorized person\'s hands but deductible for the EPR Plastic Waste, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible covered businesses should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the EPR Plastic Waste structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              EPR Plastic Waste compliance is an operating and regulatory responsibility rather than a funding structure. The practical cost depends on your business scope, packaging quantities, registration profile and ongoing target obligations.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Businesses may fulfil applicable obligations through permitted recycling, reuse, recycled-content and end-of-life routes, depending on category and regulatory requirements.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, covered businesses may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an EPR Plastic Waste; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We review your products, plastic packaging flow, business role, states and units to define the correct EPR registration scope before filing.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists organize declarations, authorization documents and packaging data to reduce preventable portal objections.'
                },
                {
                  title: 'Portal Query & Authority Follow-Ups',
                  desc: 'We help manage EPR portal observations, clarification requests and supporting responses with structured documentation.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Get post-registration guidance for records, return planning, target tracking and future compliance updates.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Indian Businesses Choose akshayb2bsolutions for EPR Support
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'A digital-first workflow that helps you organize documentation, packaging data and portal submissions without unnecessary office visits.',
                  icon: Clock
                },
                {
                  title: 'Affordable Transparent Pricing',
                  desc: 'No misleading fixed-price promise. We review your EPR role, states, units, packaging categories and data volume first, then share a clear scope-based quote.',
                  icon: Tag
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            <span className="text-xs font-black uppercase tracking-widest text-[#FF5A00] bg-white/10 px-3 py-1 rounded-full border border-white/20">
              Make Your Plastic Compliance Easier
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Get EPR Plastic Waste Compliance Support with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Don’t let plastic packaging compliance slow down your business. Get a clear applicability review, professionally prepared documentation, portal filing support and a practical post-registration compliance roadmap.
            </p>
            ...
            <div className="bg-gradient-to-r from-[#0B3D91] via-[#0D47A1] to-[#082a66] text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-4 max-w-md relative z-10">
                ...
                <p className="text-xs text-slate-200 leading-relaxed">
                  Download the akshayb2bsolutions mobile application for iOS &amp; Android. Access your compliance documents, registration records, and get direct support 24x7.
                </p>
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  <a
