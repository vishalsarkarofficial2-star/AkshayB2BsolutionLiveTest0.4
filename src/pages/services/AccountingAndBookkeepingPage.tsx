      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Accounting and Bookkeeping</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="flex items-start gap-4 p-4 rounded-xl bg-slate-50 border border-slate-200">
                  <div className="w-14 h-8 rounded-lg bg-[#0B3D91] text-[#FF5A00] flex items-center justify-center text-xs font-black flex-shrink-0">
                    {item.step}
                  </div>
                  <div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold bg-orange-500 text-[#0B3D91]">Managed Accounting Service</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-slate-50">
                      ...
                      <td className="p-3.5 bg-orange-50/60 font-semibold text-[#0B3D91]">{row[2]}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
