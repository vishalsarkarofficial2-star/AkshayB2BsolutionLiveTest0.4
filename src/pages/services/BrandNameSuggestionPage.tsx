...
interface BrandNameSuggestionPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian brand Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is Brand Name Suggestion service?', a: 'Brand Name Suggestion is a professional naming service that helps you discover distinctive, memorable and business-relevant brand name ideas based on your industry, audience, positioning and future growth plans.' },
  { q: 'Will you suggest names for Indian businesses?', a: 'Yes. The naming approach can consider Indian market relevance, pronunciation, language comfort, category expectations and the type of audience you want to attract.' },
  { q: 'Do you check trademark availability?', a: 'We can provide preliminary trademark-direction guidance and obvious conflict screening for shortlisted names. Final legal clearance should be completed through a proper trademark search and filing process.' },
  { q: 'Can you suggest domain-friendly names?', a: 'Yes. We can prioritize short, easy-to-spell and digital-friendly names and guide you on domain-check considerations for shortlisted options.' },
  { q: 'How many names will I receive?', a: 'The final deliverable depends on your brief, but the package is designed to provide multiple curated concepts, a focused shortlist and reasoning so you can choose confidently.' },
  { q: 'Can you suggest names for products, startups and companies?', a: 'Yes. The service can be used for startups, D2C brands, agencies, SaaS products, restaurants, e-commerce stores, service businesses and new product lines.' }
]

// Related services cross-linking items — sourced from brand-adjacent structures
const RELATED_SERVICES = [
  { title: 'Brand Name Registration', desc: 'Protect your selected brand name through trademark registration support in India.', img: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Trademark Search', desc: 'Check similar marks and identify potential trademark conflict risks before filing.', img: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Trademark Registration', desc: 'File your trademark application for a chosen brand name or logo.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Logo Design Guidance', desc: 'Turn your selected name into a clear visual brand direction for logo development.', img: 'https://images.unsplash.com/photo-1558655146-d09347e92766?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Company Name Consultation', desc: 'Get naming support for private limited, LLP and other business structures.', img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Domain & Digital Brand Check', desc: 'Evaluate shortlisted names for digital usability, spelling and online brand consistency.', img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Startup India Registration', desc: 'Get startup registration support after finalizing your business and brand direction.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Private Limited Company Registration', desc: 'Set up your company after finalizing the right brand and business identity.', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Brand Strategy Consultation', desc: 'Align your name, positioning, audience and messaging before launch.', img: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' }
]

export const BrandNameSuggestionPage: React.FC<BrandNameSuggestionPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Startup / New Business');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Brand Name Suggestion Support Package (Custom Quote)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Brand Name Suggestion</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Brand Naming Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Strategic Naming Support</span>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Trademark Direction Guidance</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Users2 className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Dedicated Naming Specialist</span>
                  </div>
                </div>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>HIGH-CONVERSION NAMING SUPPORT</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based brand naming specialist has been assigned to your naming request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <span className="text-base font-black text-[#0B3D91] leading-none">
                              Get Strategic Brand Name Ideas
                            </span>
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            customized to your niche & audience
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Brand Name Suggestion *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your location, industry and target audience help us make the name ideas more relevant to the market you want to serve.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why choose akshayb2bsolutions for brand naming?</span>
                              </div>
                              <p className="text-[11px]">
                                Get structured naming ideas, business-fit reasoning, shortlist support and trademark/domain direction without wasting days on random name generators.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Current Brand / Keyword Preference (Optional)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Brand Name Suggestion Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Brand Name Suggestion Support Package (Custom Quote)">Brand Name Suggestion Support Package — Custom Case Quote</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get Brand Name Ideas</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'Naming Process' },
                { id: 'advantages', label: 'Why It Matters' },
                { id: 'checklist', label: 'Checklist' },
                { id: 'eligibility', label: 'Who It Is For' },
                { id: 'documents', label: 'Documents Required' },
                { id: 'steps', label: 'Steps' },
                { id: 'legal-status', label: 'Legal Protection' },
                { id: 'post-compliance', label: 'After Name Selection' },
                { id: 'comparison', label: 'Generic vs Brandable' },
                { id: 'tax-implications', label: 'Trademark & Domain' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Focused Brand Naming Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Brand Name Suggestion Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused package designed to help you move from confusion to a clear, brandable shortlist with naming logic and launch-ready direction.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Brand Name Suggestion Support</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Perfect for startups, creators, agencies, e-commerce sellers, local businesses and founders who want a distinctive name before investing in logo, domain, ads or trademark filing.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="text-2xl sm:text-3xl font-extrabold text-[#0D47A1]">Custom Case Quote</div>
                    <span className="text-xs text-slate-500 font-medium block mt-1">
                      Pricing determined by scope & brief complexity
                    </span>
                  </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Business & Audience Naming Brief',
                      'Multiple Curated Brand Name Concepts',
                      'Trademark Direction Guidance Support',
                      'Competitor & Category Naming Direction',
                      'Trademark / Domain Direction for Shortlisted Names',
                      'Dedicated Naming Specialist & Final Shortlist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Brand Name Suggestion Support Package (Custom Quote)');
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Brand Naming Overview
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is Brand Name Suggestion?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              Brand Name Suggestion is a structured naming process that converts your business idea, positioning and audience into a strong brand identity. Instead of random name lists, the goal is to create names that are relevant, memorable, pronounceable and suitable for long-term brand building.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for startups, service businesses, SaaS products, D2C brands, restaurants, agencies, creators, manufacturers and founders launching a new business or product.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A good brand name should match your positioning, be easy to say and spell, fit your category and still leave room for future business expansion.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Strong names are not chosen only because they sound attractive; they are evaluated for recall, category fit, audience perception and basic trademark/domain direction.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Final legal ownership comes from proper trademark protection, so name suggestion should be followed by a dedicated trademark search before major investment.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A strong name can improve first impressions, make marketing easier and create a better foundation for your logo, website, packaging, social media and future advertising.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, brand registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Brand Name Suggestion Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              brand registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the brand registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Professional Brand Naming Matters
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Save Hours of Random Brainstorming', desc: 'Move quickly from confusion to curated naming directions built around your business goals.' },
                { title: 'Get Names That Fit Your Audience', desc: 'Naming ideas are shaped around your target customer, positioning, tone and category.' },
                { title: 'Improve Brand Recall', desc: 'Short, distinctive and easy-to-pronounce names are easier for customers to remember and recommend.' },
                { title: 'Avoid Overly Generic Names', desc: 'Professional naming helps reduce weak, descriptive or forgettable choices that are hard to build into a brand.' },
                { title: 'Plan for Trademark & Domain', desc: 'Shortlisted names can be reviewed for basic trademark and digital-availability direction before you invest further.' },
                { title: 'Build a Stronger Brand Foundation', desc: 'Your final name becomes the base for logo, website, packaging, content, advertising and long-term identity.' }
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before We Suggest Your Brand Name
              </h2>
            </div>

            <div className="space-y-3">
              {[
                { title: 'Define Your Business Clearly', desc: 'Tell us what you sell, how you deliver value and what makes your business different.' },
                { title: 'Identify Your Target Audience', desc: 'Share customer type, age group, geography, budget level and whether the market is B2B or B2C.' },
                { title: 'Choose Your Desired Brand Tone', desc: 'Decide whether the brand should feel premium, modern, trustworthy, youthful, traditional, bold or minimal.' },
                { title: 'Share Preferred Keywords', desc: 'Tell us words, themes, meanings or concepts you like — and any words you want to avoid.' },
                { title: 'Clarify Language Preference', desc: 'Specify whether you prefer English, Hindi-inspired, Sanskrit-inspired, regional, global or blended naming.' },
                { title: 'Share Competitor Names', desc: 'A few competitor examples help us understand category patterns and avoid look-alike naming.' },
                { title: 'Think About Future Expansion', desc: 'Tell us if the brand may expand into new products, services or geographies later.' },
                { title: 'Set Practical Naming Constraints', desc: 'Mention spelling length, pronunciation, domain preference or initials that matter to you.' }
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Brand Name Suggestion
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a brand in India, there must be a minimum of two founders / applicants and a maximum of twenty. All founders / applicants must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Founders / Applicants',
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen brand structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected brand structure.'
                },
                {
                  title: 'Unique brand Name Requirement',
                  desc: 'The brand must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written brand Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the brand objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The brand must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a brand.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates each founder\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Brand Name Suggestion
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your brand registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Founders / Applicants\' Identity Proof (PAN Cards)',
                  desc: 'Scanned copies of each founder\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Founders / Applicants\' Address Proof (Aadhaar Card / Voter ID)',
                ...
                },
                {
                  ...
                  desc: 'The applicable governing document signed/executed by the required founders, trustees, members, or directors, covering brand objectives and governance rules.'
                },
                {
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Brand Name Suggestion Process
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'We prepare the appropriate governing document detailing the brand objectives, founders, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Founders / Applicants',
                ...
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique brand Name',
                  desc: 'Our team helps check the proposed brand name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped brand deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the brand\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the brand registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the brand bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Brand Name vs Legal Protection
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the brand structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a founder\'s exit, unless the deed states otherwise.
                </p>
              </div>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                After Name Selection Compliance Checklist
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, brands must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the brand\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered brand name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual brand Compliance & Tax Filing',
                  desc: 'File the brand\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the brand employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Generic Name vs Brandable Name
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Founders / Applicants
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Founders / Applicants</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Founders / Applicants
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Trademark & Domain Considerations
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on brand Structure',
                  desc: 'Tax liability and exemptions depend on whether the brand is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible brands must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working founders / applicants are taxable in the founder\'s hands but deductible for the brand, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible brands should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the brand structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Best Use Cases for Brand Name Suggestion
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              brands generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible brands may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, brands may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an brand; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your founders / applicants\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound brand deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                ...
                {
                  title: 'Dedicated After Name Selection Growth Advisory',
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Founders Choose akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Zero hidden costs, crystal-clear custom quotes, and transparent professional service breakdowns.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your founders / applicants\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Choose Your Brand Name with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their brand with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
