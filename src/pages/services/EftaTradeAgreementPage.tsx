...
interface EftaTradeAgreementPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian EFTA Trade Agreement Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is the India–EFTA Trade and Economic Partnership Agreement (TEPA)?', a: 'TEPA is the trade agreement between India and the EFTA States—Switzerland, Norway, Iceland and Liechtenstein. It entered into force on 1 October 2025 and can provide preferential market access for eligible goods and services subject to the agreement.' },
  { q: 'Can every Indian exporter claim lower customs duty under TEPA?', a: 'No. Preferential tariff treatment depends on the product, destination EFTA State, tariff schedule and compliance with the applicable Rules of Origin. Our support starts with product and HS-code eligibility review before documentation is prepared.' },
  { q: 'What is required to claim preferential origin?', a: 'The exported product must satisfy the relevant Rules of Origin and be supported by an accepted proof of origin, such as an India–EFTA Certificate of Origin or permitted origin declaration, together with supporting commercial and production records.' },
  { q: 'Which EFTA countries are covered?', a: 'The EFTA States covered by the India–EFTA TEPA are Iceland, Liechtenstein, Norway and Switzerland.' },
  { q: 'What documents are generally reviewed?', a: 'Depending on the shipment, we may review IEC, GST and business KYC, commercial invoice, packing list, HS code, purchase and manufacturing records, bill of materials or cost data, shipping details and other documents needed to establish originating status.' },
  { q: 'Can you help with Certificate of Origin filing?', a: 'Yes. We can assist with eligibility review, Rules of Origin documentation, application preparation and Certificate of Origin / eCoO filing support through the applicable authorised mechanism. Final approval remains subject to the competent authority and the agreement requirements.' }
]

// Related services cross-linking items — sourced from EFTA Trade Agreement-adjacent structures
const RELATED_SERVICES = [
  {
    title: 'Certificate of Origin (CoO)',
    desc: 'Preferential Certificate of Origin filing support for eligible India–EFTA exports.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'IEC Registration',
    desc: 'Import Export Code registration support for businesses starting international trade.',
    img: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'IEC Renewal / Update',
    desc: 'DGFT IEC annual confirmation, modification and reactivation assistance.',
    img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'AD Code Registration',
    desc: 'Customs port AD Code registration support for smoother export documentation.',
    img: 'https://images.unsplash.com/photo-1494412519320-aa613dfb7738?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'ICEGATE Registration',
    desc: 'ICEGATE onboarding and customs digital access assistance for importers and exporters.',
    img: 'https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'LUT Filing',
    desc: 'GST Letter of Undertaking filing assistance for eligible exporters supplying without IGST payment.',
    img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'RCMC Registration',
    desc: 'Registration-cum-Membership Certificate support with the relevant Export Promotion Council.',
    img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration and exporter compliance support for Indian businesses.',
    img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your export brand and logo in India with trademark filing support.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  }
]

export const EftaTradeAgreementPage: React.FC<EftaTradeAgreementPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('EFTA Trade Agreement');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('EFTA Trade Agreement Package (Custom Quote)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">EFTA Trade Agreement</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Register your EFTA Trade Agreement at just{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Professional / statutory charges as applicable after eligibility review
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  India–EFTA TEPA is a preferential trade agreement between India and Iceland, Liechtenstein, Norway and Switzerland. For an Indian exporter, the commercial opportunity depends on the destination market, HS classification, tariff schedule, product-specific Rules of Origin and acceptable proof of origin.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>30-45 Working Days</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Handshake className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>2-20 Exporter / Authorised Signatory Allowed</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Rules of Origin Review</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>HS Code &amp; Origin Check</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Ship className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Exporter Documentation Support</span>
                  </div>
                </div>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>Free TEPA Eligibility Check</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based India–EFTA TEPA specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            quoted after product & document review
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of EFTA Trade Agreement *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                TEPA eligibility depends on your product, HS code, EFTA destination, manufacturing / sourcing facts and the applicable product-specific Rules of Origin.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get a practical TEPA eligibility check before you spend on documentation. We review your product, destination, HS code and available origin records and guide you on the next compliant step.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select EFTA Trade Agreement Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="EFTA Trade Agreement Package (Custom Quote)">EFTA Trade Agreement Package — Custom Quote Applicable Chargess</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get TEPA Eligibility Review</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'legal-status', label: 'Trade Eligibility' },
                { id: 'post-compliance', label: 'Post-Shipment' },
                { id: 'comparison', label: 'TEPA vs Standard MFN' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Preferential Trade Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                India–EFTA TEPA Support Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional EFTA Trade Agreement support guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">TEPA Advantage Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    End-to-end support for Indian exporters who want to check TEPA eligibility, establish originating status and prepare the right preferential trade documentation before shipment.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-sm font-bold text-slate-500">Pricing after eligibility review</span>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'commercial, origin and supporting export documents Drafting & Vetting',
                      'PAN / TAN Application Guidance',
                      'relevant registering authority Filing Support',
                      'Basic EFTA Trade Agreement Name Availability Check',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('EFTA Trade Agreement Package (Custom Quote)');
                ...
                >
                  Get Started with TEPA Advantage Package
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is the India–EFTA Trade Agreement (TEPA)?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              India–EFTA TEPA creates a framework for preferential trade between India and the four EFTA States. Exporters can potentially access reduced or zero customs duties for eligible products when the tariff commitment and origin requirements are satisfied and the shipment is supported by valid proof of origin.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for Indian manufacturers, merchant exporters and export-oriented businesses selling eligible goods to Switzerland, Norway, Iceland or Liechtenstein and seeking to understand whether TEPA preference can improve landed cost competitiveness.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Correct HS classification, bill of materials, manufacturing or sourcing records and commercial documents help establish whether a product satisfies the applicable origin rule before a preferential claim is made.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Preferential eligibility is product-specific. Different HS lines can have different tariff commitments and Rules of Origin, so each export line should be checked rather than assuming every shipment qualifies.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration under the Indian EFTA Trade Agreement Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow exporter / authorised signatory in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An EFTA Trade Agreement is not formed for distributing profits to members. Eligible organizations can pursue preferential tariffs, buyer opportunities and export growth, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, our TEPA support helps exporters move from product eligibility review to origin documentation and Certificate of Origin readiness, reducing avoidable errors before a preferential tariff claim is made.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How EFTA Trade Agreement Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Using India–EFTA TEPA is not a general business registration. It is a shipment and product-specific preferential trade process in which the exporter must verify tariff eligibility, comply with Rules of Origin and maintain supporting evidence for the proof of origin.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the EFTA Trade Agreement support certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building buyer and customs confidence.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our trade-compliance desk helps review HS classification, origin evidence, commercial documents and Certificate of Origin requirements and assists with filing preparation and query support.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Benefits of India–EFTA TEPA
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Eligible originating goods may receive preferential tariff treatment in the relevant EFTA market, helping improve landed-cost competitiveness.'
                },
                {
                  title: 'Shared Capital & Combined Expertise',
                  desc: 'Exporter / Authorised Signatory pool resources, skills, and networks, enabling faster growth than a single-owner structure with minimal capital constraints.'
                },
                {
                  title: 'Minimal Start-up Costs & Quick Setup',
                  desc: 'Get professional documentation and registration support with transparent professional fees; the final timeline depends on EFTA Trade Agreement structure, state, authority, and government verification.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'A properly supported preferential claim can strengthen buyer confidence and make Indian offers more competitive in EFTA markets.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Claiming TEPA Preference
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique EFTA Trade Agreement Name Selection',
                ...
                {
                  title: 'Clearly Defined EFTA Trade Agreement Objectives and Governance',
                ...
                {
                  title: 'Valid Identity and Address Proofs of All Exporter / Authorised Signatory',
                ...
                {
                  title: 'Draft commercial, origin and supporting export documents',
                  desc: 'Map the HS code, product-specific origin rule, sourcing pattern and manufacturing process before preparing the origin evidence.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for EFTA Trade Agreement
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Indian exporters seeking TEPA preference should have a valid export setup and sufficient product and origin records to demonstrate that the goods satisfy the applicable Rules of Origin. Eligibility is based on the product and transaction—not on a minimum number of owners or members.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Indian Exporter / Manufacturer Eligibility',
                  desc: 'The applicant should be an Indian exporter with appropriate business and export registrations and a shipment or product intended for an EFTA market.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'The authorised signatory and business records should be consistent across IEC, GST, invoice and other export documentation used for the application.'
                },
                {
                  title: 'Unique EFTA Trade Agreement Name Requirement',
                  desc: 'The EFTA Trade Agreement must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written EFTA Trade Agreement Deed',
                  desc: 'The appropriate commercial, origin and supporting export documents must clearly state the EFTA Trade Agreement objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The EFTA Trade Agreement must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a EFTA Trade Agreement.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for EFTA Trade Agreement
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your EFTA Trade Agreement support smoothly, identity and address proofs of business owners, partners, directors or authorised signatories, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Exporter / Authorised Signatory\' Identity Proof (PAN Cards)',
                ...
                {
                  title: 'Exporter / Authorised Signatory\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Accepted identity and address proof such as Aadhaar, Voter ID, Passport, or other applicable documents for business owners, partners, directors or authorised signatories.'
                },
                {
                ...
                {
                  title: 'Signed commercial, origin and supporting export documents',
                  desc: 'The applicable governing document signed/executed by the required business owners, partners, directors or authorised signatories, covering EFTA Trade Agreement objectives and governance rules.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our team helps organise the Certificate of Origin application, origin declaration inputs and supporting commercial / manufacturing records according to the applicable TEPA requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                TEPA Support Sequence
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step EFTA Trade Agreement Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Draft commercial, origin and supporting export documents',
                  desc: 'We first identify the destination EFTA State, product HS code, applicable tariff preference and the product-specific Rule of Origin.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Exporter / Authorised Signatory',
                  desc: 'Upload PAN, identity/address proof, registered-office proof, NOC where required, and photographs of the required business owners, partners, directors or authorised signatories.'
                },
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique EFTA Trade Agreement Name',
                  desc: 'Our team helps check the proposed EFTA Trade Agreement name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped EFTA Trade Agreement deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the EFTA Trade Agreement\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the EFTA Trade Agreement support certificate/incorporation documents and governing-document copies, followed by guidance for opening the EFTA Trade Agreement bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Trade Eligibility of a EFTA Trade Agreement
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  TEPA does not create a separate legal entity. It provides a preferential trade framework; the exporter continues to operate through its existing Indian business entity while meeting customs, origin and export-document requirements.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the EFTA Trade Agreement structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The exporter remains responsible for the accuracy of origin declarations, supporting records and shipment information used to claim preferential treatment.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our trade advisors guide you on TEPA eligibility, HS-code review, Rules of Origin, proof-of-origin documentation and ongoing shipment-level compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Post-Shipment Compliance Checklist
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              After using TEPA preferences, exporters should retain supporting origin and commercial records and remain ready for verification or customs queries under the agreement.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the EFTA Trade Agreement\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered EFTA Trade Agreement name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual EFTA Trade Agreement Compliance & Tax Filing',
                  desc: 'File the EFTA Trade Agreement\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                  title: 'Report Changes to the relevant registering authority',
                  desc: 'Keep product sourcing, manufacturing, invoice and origin records updated so future preference claims remain supportable during verification.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the EFTA Trade Agreement employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                EFTA Trade Agreement vs Other Business Structures
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Indian EFTA Trade Agreement Act, 1932
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Exporter / Authorised Signatory
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Exporter / Authorised Signatory</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on EFTA Trade Agreement structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Exporter / Authorised Signatory
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for EFTA Trade Agreements in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              India–EFTA TEPA can affect the customs duty treatment of qualifying goods, while normal Indian GST, customs, income-tax and foreign-exchange rules continue to apply. Our support focuses on preferential tariff eligibility and origin documentation, not on promising a fixed tax outcome.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Preferential customs duty depends on the tariff schedule, product classification, destination and successful satisfaction of the Rules of Origin.'
                },
                {
                  title: 'GST & Export Tax Compliance',
                  desc: 'Exporters must continue to meet applicable GST, customs, FEMA and other Indian compliance requirements; TEPA preference is not a general tax exemption.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working exporter / authorised signatory are taxable in the authorised signatory\'s hands but deductible for the EFTA Trade Agreement, subject to prescribed limits.'
                },
                {
                  title: 'GST Threshold Exemption Limits',
                  desc: 'GST treatment and export documentation depend on the exporter’s facts and applicable law; TEPA preference does not replace normal GST compliance.'
                },
                {
                  title: 'Mandatory Tax Audit Above Turnover Limits',
                  desc: 'Eligible EFTA Trade Agreements should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the EFTA Trade Agreement structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              TEPA can support export competitiveness by reducing applicable customs duties in destination markets for qualifying goods. Exporters can combine this with normal export finance, working-capital and trade-credit solutions subject to lender eligibility.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible exporters may explore packing credit, post-shipment finance, invoice discounting and other trade-finance facilities from banks and financial institutions.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, EFTA Trade Agreements may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                  title: 'Pradhan Mantri MUDRA Yojana (PMMY)',
                  desc: 'Eligible exporters may explore bank working-capital and export-credit facilities based on their turnover, orders and lender criteria.'
                },
                {
                  title: 'Credit Guarantee Fund Trust for Micro and Small Enterprises (CGTMSE)',
                  desc: 'Trade-credit and guarantee options may be available through banks and eligible government-supported export finance mechanisms.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an EFTA Trade Agreement; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound EFTA Trade Agreement deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                ...
                {
                  title: 'Dedicated Post-Shipment Growth Advisory',
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your EFTA Trade Agreement with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their EFTA Trade Agreement with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
            ...
            <div className="bg-gradient-to-r from-[#0B3D91] via-[#0D47A1] to-[#082a66] text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-4 max-w-md relative z-10">
                ...
                <p className="text-xs text-slate-200 leading-relaxed">
                  Download the akshayb2bsolutions mobile application for iOS &amp; Android. Access your trade documents, application updates and compliance support in one place.
                </p>
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  <a
