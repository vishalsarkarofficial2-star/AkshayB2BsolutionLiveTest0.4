...
interface BrandNameRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian NGO Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is Brand Name Registration in India?', a: 'Brand Name Registration generally means protecting a business name, product name, logo, or identity through trademark registration under the Trade Marks Act, 1999.' },
  { q: 'Can I register only a brand name without a logo?', a: 'Yes. A word mark can protect the brand name itself, while a separate logo/device mark protects the visual identity.' },
  { q: 'What documents are generally required?', a: 'Typical documents include applicant PAN and identity/address proof, business constitution proof where applicable, brand name or logo, goods/services details, use information if claimed, and authorization documents.' },
  { q: 'How long does trademark registration take?', a: 'Application filing can be completed quickly once documents are ready, while final registration depends on examination, objections, journal publication, opposition and Registry processing.' },
  { q: 'Can I use the ™ symbol after filing?', a: 'Businesses commonly use ™ to indicate a trademark claim. The ® symbol should be used only after registration.' },
  { q: 'Is trademark registration valid across India?', a: 'An Indian trademark registration provides protection across India for the registered mark and approved classes, subject to the scope of registration and applicable law.' }
]

// Related services cross-linking items — sourced from NGO-adjacent structures
const RELATED_SERVICES = [
  { title: 'Trademark Registration', desc: 'Protect your business name, logo or brand identity with professional trademark filing support in India.', img: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=600&auto=format&fit=crop&q=80', price: '₹1,499 + Govt. Fees' },
  { title: 'Logo Trademark Registration', desc: 'Secure legal protection for your brand logo and visual identity.', img: 'https://images.unsplash.com/photo-1558655146-d09347e92766?w=600&auto=format&fit=crop&q=80', price: '₹1,499 + Govt. Fees' },
  { title: 'Trademark Objection Reply', desc: 'Professional response drafting and filing support for trademark examination objections.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: '₹2,499' },
  { title: 'Trademark Renewal', desc: 'Renew your registered trademark and continue brand protection.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: '₹1,999 + Govt. Fees' },
  { title: 'Copyright Registration', desc: 'Protect eligible creative works, artwork, content and software.', img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=600&auto=format&fit=crop&q=80', price: '₹2,499 + Govt. Fees' },
  { title: 'MSME Udyam Registration', desc: 'Get Udyam registration support for eligible MSMEs.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: '₹499' },
  { title: 'Private Limited Company Registration', desc: 'Build a stronger legal foundation for your growing brand.', img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80', price: '₹6,999 + Govt. Fees' },
  { title: 'GST Registration', desc: 'Get GST registration support for eligible businesses.', img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80', price: '₹699' },
  { title: 'Brand Consultation', desc: 'Get guidance on brand-name availability, trademark risk and filing strategy.', img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' }
]

export const BrandNameRegistrationPage: React.FC<BrandNameRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('Brand Name Registration Package (₹1,499 + Govt. Fees)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Brand Name Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Trademark Registration Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Fast Application Filing Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Protect your brand name at just{' '}
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Brand Name Registration helps protect your business name, product name, logo or identity through trademark filing in India. Our team assists with preliminary search, class selection, application preparation and filing so you can build your brand with stronger legal protection.
                </p>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our trademark specialist has been assigned to your brand registration request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <h3 className="text-base font-extrabold text-[#0B3D91]">
                              Online Trademark Registration Desk
                            </h3>
                          </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Brand Name Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your state and business details help us prepare the applicant information and trademark filing documents correctly.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get preliminary brand-name search, trademark class guidance, application drafting, filing support and expert assistance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Applicant / Proprietor / Director Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Brand Name Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Brand Name Registration Package (₹1,499 + Govt. Fees)">Brand Name Registration Package — ₹1,499 + Govt. Fees</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start Trademark Filing</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'Trademark Process' },
                ...
                { id: 'comparison', label: 'Word Mark vs Logo' },
                { id: 'tax-implications', label: 'Trademark Rights' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Simple, Transparent Brand Protection
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Brand Name Registration Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                A simple package for entrepreneurs and businesses that want to secure their brand identity with professional trademark application support.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Brand Protection Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Perfect for startups, proprietors, companies and online sellers who want to protect a business name, product name or brand identity in India.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Preliminary Trademark / Brand Name Search',
                      'Trademark Class Selection Guidance',
                      'IP India Filing Support Support',
                      'Word Mark / Logo Application Guidance',
                      'Application Acknowledgement & Status Guidance',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Brand Name Registration Package (₹1,499 + Govt. Fees)');
                ...
                >
                  Get Started with Brand Protection Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              Brand Name Registration is commonly achieved through trademark registration. It helps secure stronger rights over a distinctive brand name, product name, logo or identity for the approved goods or services.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for startups, proprietorships, LLPs, companies, e-commerce sellers, manufacturers, service providers and growing businesses that want to protect a valuable brand identity.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  You can apply for a word mark to protect the brand name itself, a logo/device mark to protect the visual identity, or both depending on your brand strategy.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Trademark protection is linked to specified classes of goods and services, so selecting the correct class is important for meaningful protection.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A registered trademark gives the proprietor stronger statutory rights and can make it easier to establish ownership and enforce the brand.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A protected brand can become a valuable business asset and improve trust with customers, distributors, marketplaces, investors and franchise partners.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, NGO registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Brand Name Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              NGO registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the NGO registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Benefits of Brand Name Registration
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Exclusive Brand Protection', desc: 'Registration gives the proprietor stronger statutory rights to use and protect the mark for the registered goods or services.' },
                { title: 'Build Customer Trust', desc: 'A protected brand identity looks more established and can increase confidence among customers and business partners.' },
                { title: 'Protect Marketing Investment', desc: 'Reduce the risk of competitors copying a name or identity you are investing time and money to promote.' },
                { title: 'Create a Valuable Business Asset', desc: 'A trademark can become an intellectual-property asset supporting licensing, franchising, assignment or expansion.' },
                { title: 'Nationwide Indian Protection', desc: 'Indian trademark registration can provide enforceable rights across India within the scope of the registration.' },
                { title: 'Stronger Enforcement Position', desc: 'A registered mark generally provides a stronger legal basis against confusingly similar or infringing use.' }
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Registering Your Brand Name
              </h2>
            </div>

            <div className="space-y-3">
              {[
                { title: 'Choose a Distinctive Brand Name', desc: 'Avoid overly generic names and select a distinctive mark that is easier to protect.' },
                { title: 'Run a Preliminary Trademark Search', desc: 'Check for identical or similar marks before filing to identify possible conflict risks.' },
                { title: 'Select the Correct Trademark Class', desc: 'Choose the class or classes covering the goods or services sold under your brand.' },
                { title: 'Decide Word Mark, Logo Mark or Both', desc: 'A word mark protects the name, while a logo/device application focuses on the visual identity.' },
                { title: 'Confirm Applicant Ownership', desc: 'Decide whether the filing should be in an individual, proprietorship, LLP, company or other entity name.' },
                { title: 'Confirm Use Status', desc: 'Identify whether the brand is proposed to be used or already in use and keep proof ready if prior use is claimed.' },
                { title: 'Keep Brand Artwork Ready', desc: 'If filing a logo/device mark, prepare a clear image of the brand artwork.' },
                { title: 'Professional Pre-Filing Review', desc: 'Our trademark team reviews the mark, class, applicant details and documents before submission.' }
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Brand Name Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a NGO in India, there must be a minimum of two members / trustees and a maximum of twenty. All members / trustees must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen NGO structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected NGO structure.'
                },
                {
                  title: 'Unique NGO Name Requirement',
                  desc: 'The NGO must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written NGO Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the NGO objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The NGO must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a NGO.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Brand Name Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your NGO registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Applicant PAN & Identity Proof', desc: 'PAN and identity details of the individual, proprietor, partner, director or authorised applicant.' },
                { title: 'Business Constitution Proof', desc: 'Partnership deed, LLP incorporation details, company certificate or other entity proof where applicable.' },
                { title: 'Brand Name / Logo', desc: 'The exact word mark or clear logo/device artwork that you want to protect.' },
                { title: 'Business Activity & Trademark Class', desc: 'Description of the goods or services for which the trademark will be used.' },
                { title: 'User Date & Supporting Proof, If Claimed', desc: 'If prior use is claimed, keep invoices, packaging, website or marketing evidence ready.' },
                { title: 'Authorization / Power of Attorney', desc: 'Authorization documents may be required where a professional files the application.' }
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Brand Name Registration Process
              </h2>
            </div>

            <div className="space-y-4">
              {[
                { step: 'Step 1', title: 'Share Your Brand Name & Business Activity', desc: 'Tell us the name or logo you want to protect and what products or services you offer.' },
                { step: 'Step 2', title: 'Preliminary Trademark Search', desc: 'We check for similar marks and identify obvious conflict risks before filing.' },
                { step: 'Step 3', title: 'Select the Correct Trademark Class', desc: 'We identify the appropriate class or classes based on your goods and services.' },
                { step: 'Step 4', title: 'Prepare Applicant Documents', desc: 'We collect applicant KYC, business proof, brand artwork and use details where applicable.' },
                { step: 'Step 5', title: 'Prepare & File Trademark Application', desc: 'The application is prepared with the selected mark, class, applicant details and supporting information.' },
                { step: 'Step 6', title: 'Receive Acknowledgement & Track Status', desc: 'After filing, we provide application details and guide you on examination, objection, journal and registration stages.' }
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an NGO depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the NGO structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate NGO structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the NGO\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered NGO name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual NGO Compliance & Tax Filing',
                  desc: 'File the NGO\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the NGO employs staff.'
                },
                {
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on NGO structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Trademark Rights & Important Points
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              NGO tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on NGO Structure',
                  desc: 'Tax liability and exemptions depend on whether the NGO is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible NGOs must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working members / trustees are taxable in the founder / trustee\'s hands but deductible for the NGO, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible NGOs should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the NGO structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Where Brand Registration Adds Value
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Eligible NGOs may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, NGOs may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an NGO; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound NGO deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Protect Your Brand Name with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their NGO with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Start Brand Registration at ₹1,499/-
              </button>
              <button
