...
interface EpchRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — Export Promotion Council for Handicrafts (EPCH) / RCMC focused
const FAQ_ITEMS = [
  { q: 'What is Export Promotion Council for Handicrafts (EPCH) Registration?', a: 'Export Promotion Council for Handicrafts (EPCH) membership is for eligible Indian exporters in the handicrafts and allied artisan-product sector. Registered exporters can obtain/maintain the applicable Registration-cum-Membership Certificate (RCMC) and access export-promotion support subject to EPCH and DGFT rules.' },
  { q: 'Who should apply for EPCH membership?', a: 'Exporters of eligible Indian handicrafts such as home décor, gifts, woodcraft, metalware, textiles, fashion accessories, artisanal products and related categories can apply for EPCH membership/RCMC subject to current product coverage and EPCH/DGFT requirements.' },
  { q: 'Why is there no fixed price on this page?', a: 'Official EPCH charges and GST apply according to the current membership rules. This page does not display a fixed service price; we first review your exporter profile, category and documents, then provide a clear custom quote before filing.' },
  { q: 'Which documents are generally required?', a: 'Common requirements include IEC details, GST registration, PAN/KYC, business constitution proof, export-product details and supporting export-performance or manufacturer documents where applicable. Final documents depend on your exporter category.' },
  { q: 'What is RCMC and why does it matter?', a: 'RCMC is the Registration-cum-Membership Certificate linked with the relevant Export Promotion Council. For eligible handicrafts-sector exporters, EPCH membership/RCMC can support access to Foreign Trade Policy benefits, schemes and export-promotion services subject to applicable rules.' },
  { q: 'Can you help with renewal as well as new membership?', a: 'Yes. Our service can assist with new EPCH membership/RCMC applications, document review, category assessment, renewal guidance and follow-up support, subject to authority approval.' }
]

// Related export-compliance services for handicrafts exporters
const RELATED_SERVICES = [
  { title: 'IEC Registration', desc: 'Get your Import Export Code for starting import-export activities in India.', img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'IEC Renewal / Update', desc: 'Keep IEC particulars updated and compliant on the DGFT portal.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'AD Code Registration', desc: 'Register your bank AD Code for smoother customs and export-shipping processing.', img: 'https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'ICEGATE Registration', desc: 'Set up ICEGATE access for Indian Customs-related electronic services.', img: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'LUT Filing', desc: 'LUT support for eligible exporters supplying goods or services without payment of IGST.', img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'GST Registration', desc: 'GST registration and compliance support for export-oriented businesses.', img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Trademark Registration', desc: 'Protect your handicrafts, décor or artisan-products brand in India.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible handicrafts MSMEs.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'RCMC Registration', desc: 'RCMC support for exporters based on the correct Export Promotion Council and product category.', img: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&auto=format&fit=crop&q=80', price: 'View Service' }
]

export const EpchRegistrationPage: React.FC<EpchRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Handicrafts Exporter');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('EPCH Membership & RCMC Assistance — Custom Quote');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Export Promotion Council for Handicrafts (EPCH) Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Export Promotion Council for Handicrafts (EPCH) is the Export Promotion Council for India's handicrafts and artisan-products sector. Eligible exporters can apply for EPCH membership and the applicable RCMC to align their export profile with the relevant council and access export-promotion support under applicable Government of India policies.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>EPCH / RCMC Filing Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our handicrafts-export compliance specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Export Promotion Council for Handicrafts (EPCH) Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your applicable EPCH category and documents depend on exporter type, product profile and previous-year export FOB value. We review these first so you know the likely official fee category before filing.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                We pre-check IEC, GST, business KYC, handicrafts product category and export-performance details before EPCH filing to reduce avoidable errors and back-and-forth.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Export Promotion Council for Handicrafts (EPCH) Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Export Promotion Council for Handicrafts (EPCH) Registration Package (Custom Quote)">Export Promotion Council for Handicrafts (EPCH) Registration Package — Custom Quote + Govt. Fees</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Start Your EPCH Membership & RCMC Application
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused package for EPCH membership/RCMC assistance: exporter-category assessment, document pre-check, handicrafts product mapping, DGFT e-RCMC guidance and application follow-up. We share the service quote after reviewing your profile; official EPCH fees and GST are payable as applicable.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Exporter Growth Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    A conversion-focused package for Indian handicrafts exporters who want the right EPCH exporter category, a clean document set and guided RCMC filing without unnecessary confusion or repeated corrections.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-lg text-slate-400 line-through">Category Based</span>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Exporter Category & Previous-Year FOB Value Assessment',
                      'IEC, GST, PAN & Business KYC Pre-Check',
                      'EPCH / RCMC Filing Support',
                      'Handicrafts Product Category Mapping',
                      'Export Performance / Supporting Document Review',
                      'Dedicated Export Compliance Specialist & Follow-Up'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Export Promotion Council for Handicrafts (EPCH) Registration Package (Custom Quote)');
                ...
                >
                  Get Started with Exporter Growth Package
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is Export Promotion Council for Handicrafts (EPCH) in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              EPCH membership connects eligible Indian handicrafts-sector exporters with the sector's designated Export Promotion Council. The associated RCMC helps establish the exporter’s council membership for applicable Foreign Trade Policy benefits and export-promotion services, subject to current rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for merchant exporters, manufacturer exporters and eligible businesses exporting handicrafts, home décor, gifts, fashion accessories, textiles, woodcraft, metalware and other eligible handicraft products from India.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Correct product mapping, exporter classification and export-performance details help determine the appropriate EPCH membership category and supporting documentation.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  EPCH membership does not change your business constitution; it supports your recognition with the relevant Export Promotion Council for applicable RCMC and export-promotion purposes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  EPCH registration is not a separate business incorporation. For eligible handicrafts exporters, membership and RCMC help establish the relevant Export Promotion Council linkage for applicable Foreign Trade Policy services and benefits.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  EPCH membership supports an existing export business; it does not replace your company, LLP, partnership or proprietorship. Export growth continues through your own business entity while EPCH supports sector-specific promotion and exporter services.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, EPCH membership/RCMC helps eligible handicrafts exporters align with the relevant Export Promotion Council. Our team supports category assessment, document readiness, filing guidance and follow-up so you can focus on export orders instead of paperwork.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Export Promotion Council for Handicrafts (EPCH) Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              EPCH registration involves applying for the appropriate Council membership and RCMC based on your exporter profile, handicrafts product category and exporter type.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the exporter receives the applicable EPCH membership/RCMC documentation. This can help eligible members access export-promotion services and applicable Foreign Trade Policy benefits, subject to DGFT/EPCH rules and ongoing membership compliance.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our export-compliance desk reviews IEC, GST, KYC, constitution and handicrafts product-category documents, assists with the EPCH/RCMC application and supports follow-up until the authority completes its review.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Benefits of EPCH Membership for Handicrafts Exporters
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'EPCH membership and RCMC can help eligible handicrafts exporters access council services and applicable Foreign Trade Policy benefits, subject to current rules.'
                },
                {
                  title: 'Shared Capital & Combined Expertise',
                  desc: 'Exporters / Authorized Applicants pool resources, skills, and networks, enabling faster growth than a single-owner structure with minimal capital constraints.'
                },
                {
                  title: 'Minimal Start-up Costs & Quick Setup',
                  desc: 'Get professional documentation and registration support with transparent professional fees; the final timeline depends on EPCH membership structure, state, authority, and government verification.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible registered exporters may access applicable export-promotion schemes, trade-fair support, market-development initiatives and policy facilitation, subject to scheme rules.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for EPCH Membership / RCMC
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique EPCH membership Name Selection',
                ...
                {
                  title: 'Clearly Defined EPCH membership Objectives and Governance',
                  desc: 'Confirm the authorized signatory, exporter category and handicrafts product classification before filing so the EPCH membership/RCMC application matches your actual business profile.'
                },
                {
                  title: 'Valid Identity and Address Proofs of All Exporters / Authorized Applicants',
                ...
                },
                {
                  ...
                  desc: 'Keep your business constitution documents, authorization and exporter declarations consistent with IEC, GST and the selected EPCH category.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Export Promotion Council for Handicrafts (EPCH) Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              An exporter engaged or intending to engage in eligible handicrafts exports can apply for EPCH membership subject to the Council’s current rules. A valid IEC is essential for RCMC, while manufacturer exporters may also need valid Udyam/MSME evidence and product self-declaration.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Eligible Indian Exporter / Business Entity',
                  desc: 'Individuals, HUFs, firms, companies, corporations, co-operative societies and other eligible entities engaged in handicrafts exports may apply subject to EPCH guidelines.'
                },
                {
                  title: 'Valid IEC & Business KYC',
                  desc: 'IEC is mandatory for RCMC. PAN, GST and constitution/KYC documents should match the applicant’s current business records.'
                },
                {
                  title: 'Applicant Name Consistency',
                  desc: 'The applicant name should be consistent across IEC, GST, PAN and business constitution documents; EPCH also cautions against confusingly similar member names.'
                },
                {
                  title: 'Correct Exporter Category Selection',
                  desc: 'Keep your IEC, GST, product classification, exporter category and supporting business documents accurate and consistent before filing.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'Maintain valid registered-office/business address details matching the relevant business and tax records.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'The exported products should fall within EPCH’s eligible handicrafts and allied product coverage; product mapping should be checked before filing.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Export Promotion Council for Handicrafts (EPCH) Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              For EPCH membership/RCMC, exporters typically need valid IEC, GST and business KYC details, along with exporter-category, product and export-performance documents where applicable. The exact checklist depends on your applicant profile and current EPCH requirements.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Exporters / Authorized Applicants\' Identity Proof (PAN Cards)',
                ...
                {
                  title: 'Exporters / Authorized Applicants\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Accepted KYC and authorization documents may be required for the proprietor, partner, director or authorized signatory depending on the applicant constitution.'
                },
                {
                ...
                {
                  title: 'Business Constitution & Exporter Supporting Documents',
                  desc: 'Partnership deed, incorporation documents, authorization/resolution, Export House certificate or manufacturer evidence may be required depending on the applicant type.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our team organizes the EPCH application checklist, reviews supporting documents and helps prepare the membership/RCMC filing set according to the applicable requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Export Promotion Council for Handicrafts (EPCH) Registration Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Profile & Category Assessment',
                  desc: 'We review your business constitution, IEC, handicrafts product line and export activity to identify the appropriate EPCH membership/RCMC category.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect IEC, GST, KYC & Business Documents',
                  desc: 'Share IEC, GST, PAN/KYC and constitution documents; manufacturer exporters should also keep Udyam/MSME evidence and handicrafts product self-declaration ready.'
                },
                {
                  step: 'Step 3',
                  title: 'Map Handicrafts Products & Exporter Type',
                  desc: 'We map your eligible handicrafts products and confirm whether your application fits Merchant Exporter, Manufacturer Exporter or a combined profile.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit EPCH / DGFT e-RCMC Application',
                  desc: 'We file Form 1, the stamped EPCH membership deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'Application Review & Query Support',
                  desc: 'We apply for the EPCH membership\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Membership / RCMC Completion Guidance',
                  desc: 'After approval, we guide you on membership/RCMC records, annual membership renewal discipline and keeping IEC, GST and exporter details current.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                EPCH Membership & RCMC Status for Exporters
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  EPCH membership/RCMC is an export-promotion registration linked to your existing business entity. Your company, LLP, partnership or proprietorship continues to retain its own legal constitution and tax status.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance can include annual EPCH membership renewal, keeping IEC and GST particulars current, maintaining export-performance records and completing other export-related filings as applicable.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Your underlying business entity remains responsible for contracts, taxes, customs, export documentation and regulatory compliance; EPCH membership does not transfer those obligations.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our export-compliance advisors guide you on EPCH category selection, RCMC documentation, IEC/GST consistency, renewal requirements and related export registrations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After obtaining EPCH membership/RCMC, exporters should maintain annual membership renewal and keep IEC, GST, export-performance and other applicable details current to preserve eligibility for relevant benefits.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the EPCH membership\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Maintain an export banking relationship and complete AD Code / customs-related registrations where applicable to your shipping process.'
                },
                {
                  title: 'Annual EPCH Membership Renewal & Export Compliance',
                  desc: 'File income-tax and GST returns according to your underlying business constitution and applicable export transactions; EPCH membership itself does not create a separate income-tax entity.'
                },
                {
                  title: 'Report Changes to the relevant registering authority',
                  desc: 'Keep IEC, GST, business address, authorized signatory and other exporter particulars updated with the appropriate authorities and in membership records where required.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the EPCH membership employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                EPCH Membership / RCMC vs Other Export Registrations
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Indian EPCH membership Act, 1932
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Exporters / Authorized Applicants
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Exporters / Authorized Applicants</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on EPCH membership structure and applicable exemptions
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Personal Slab Rates</td>
                    <td className="p-3.5 border-r border-slate-200">Depends on business constitution</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Exporters / Authorized Applicants
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax, GST & Export Compliance for Handicrafts Exporters
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              EPCH membership itself does not create a separate income-tax status. Tax and GST treatment depends on your business constitution, export transactions and applicable tax provisions, including zero-rated export rules where relevant.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on EPCH membership Structure',
                  desc: 'Income-tax treatment depends on your business constitution, while GST treatment for exports is governed by applicable export and zero-rated supply provisions.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Exporters should maintain proper invoices, shipping documents, GST records and foreign-remittance evidence required for their transactions and tax filings.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working exporters / authorized applicants are taxable in the authorized applicant\'s hands but deductible for the EPCH membership, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible EPCH membership should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the EPCH membership structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Handicrafts exporters may access export finance, working-capital facilities and eligible government/export-promotion support through their own business entity. EPCH membership itself is not a financing product, but it can support sector visibility and participation in relevant export-promotion initiatives.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Export Finance & Working Capital',
                  desc: 'Eligible exporters may access export finance, packing credit, working-capital facilities and applicable export-promotion assistance subject to lender and scheme criteria.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, handicrafts exporters may explore packing credit, working-capital and other export-finance facilities through their business entity.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity or debt funding is raised by your underlying business entity. EPCH membership/RCMC does not replace normal banking, investment, tax or corporate due diligence.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your exporters / authorized applicants\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists review IEC, GST, constitution documents, authorization and exporter declarations to reduce avoidable application errors and queries.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Zero hidden costs, crystal-clear pricing starting at just Custom Quote/-, and transparent separate government fee breakdowns.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your exporters / authorized applicants\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Grow Your Handicrafts Export Business with EPCH Support
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Move your handicrafts export compliance forward with a category-first approach. We check your profile before quoting, organize the application documents and guide the filing process with transparent support—no misleading one-price promise.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Start Registration at Custom Quote/-
              </button>
              <button
