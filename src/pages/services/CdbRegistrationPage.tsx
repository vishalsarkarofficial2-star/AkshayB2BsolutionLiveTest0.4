...
interface CdbRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian export Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is Coconut Export Promotion Council registration?', a: 'The Coconut Development Board (CDB) functions as the Export Promotion Council for coconut products other than coir/husk-fibre products. Eligible exporters obtain a Registration-cum-Membership Certificate (RCMC) to establish their membership and access applicable export-promotion support.' },
  { q: 'Who should apply for Coconut Board RCMC?', a: 'Businesses exporting eligible coconut products such as coconut oil, virgin coconut oil, desiccated coconut, coconut milk products, activated carbon, shell-based products and other covered coconut products should evaluate RCMC registration with the Coconut Development Board.' },
  { q: 'Is IEC required before applying?', a: 'Yes. An active Importer Exporter Code (IEC) is generally the starting point for export registration. The e-RCMC application is filed through the DGFT platform with the relevant Export Promotion Council or Commodity Board selected.' },
  { q: 'What documents are generally required?', a: 'Typical requirements include IEC-linked business details, PAN and GST details where applicable, constitution documents, bank details, authorised-signatory information and product/export details. Exact documents can vary by applicant category and current portal requirements.' },
  { q: 'What is the benefit of Coconut Board RCMC?', a: 'RCMC can help exporters access export-promotion information, participation opportunities in trade fairs and buyer-seller meets, and applicable benefits or schemes under India\'s Foreign Trade Policy, subject to eligibility.' },
  { q: 'How long is the RCMC valid?', a: 'Coconut Development Board publications state that its RCMC is issued with a five-year validity. Renewal or updates should be handled in line with current DGFT/CDB requirements.' }
]

// Related services cross-linking items — sourced from export-adjacent structures
const RELATED_SERVICES = [
  {
    title: 'IEC Registration',
    desc: 'Get your Importer Exporter Code ready before starting coconut export registrations and customs processes.',
    img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'APEDA Registration',
    desc: 'Registration support for exporters dealing in APEDA scheduled agricultural and processed food products.',
    img: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Spices Board CRES',
    desc: 'Exporter registration support for businesses exporting spices and spice products from India.',
    img: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'ICEGATE Registration',
    desc: 'Set up ICEGATE access for customs-related online services and export-import transactions.',
    img: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'AD Code Registration',
    desc: 'Support for registering your authorised dealer bank code at the relevant customs port for exports.',
    img: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'FSSAI Registration',
    desc: 'Food-business licensing support for eligible coconut food and beverage products.',
    img: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Certificate of Origin',
    desc: 'Documentation support for eligible exports requiring origin certification for international trade.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'GST & LUT Support',
    desc: 'Export-oriented GST registration, LUT filing and compliance assistance for eligible businesses.',
    img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your coconut-product brand name and logo before scaling across domestic and export markets.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  }
]

export const CdbRegistrationPage: React.FC<CdbRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('Coconut Export Growth Package');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Coconut Export Promotion Council</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Coconut Export Promotion Council in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an export may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Exporter Eligibility Check</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>RCMC Documentation Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our export-compliance specialist has been assigned to your Coconut Board RCMC enquiry. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Coconut Export Promotion Council *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your business location, IEC details, exporter category and coconut products help determine the correct RCMC filing requirements.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get IEC/RCMC readiness checks, document review, DGFT e-RCMC filing assistance, query support and practical export-compliance guidance in one streamlined process.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>
                                <label className="block text-xs font-bold text-slate-700 mb-1">
                                  Coconut Product / Export Activity *
                                </label>
                                <select
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Coconut Export Promotion Council Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Coconut Export Growth Package">Coconut Export Promotion Council Package — Contact for Price Government / Portal Fees</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'RCMC Process' },
                ...
                { id: 'comparison', label: 'Export Readiness' },
                { id: 'tax-implications', label: 'Export Benefits' },
                { id: 'financing', label: 'Growth Support' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Exporter Growth Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your Coconut Export Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One conversion-focused package designed to move you from basic export readiness to Coconut Development Board RCMC filing with expert documentation and compliance support.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Coconut Export Growth Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Built for coconut-product exporters who want a guided path from IEC readiness to RCMC filing, query resolution and export-market opportunity support.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'IEC & Exporter Profile Readiness Check',
                      'Coconut Product & RCMC Category Mapping',
                      'DGFT e-RCMC Filing Support',
                      'Document Scrutiny Before Submission',
                      'Application Query & Deficiency Support',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Coconut Export Growth Package');
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Export Registration Overview
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is Coconut Export Promotion Council RCMC?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              The Coconut Development Board acts as the Export Promotion Council for eligible coconut products other than coir/husk-fibre products. Its RCMC helps establish your exporter membership and connects your business with export-promotion support, market information and applicable Foreign Trade Policy opportunities.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Best Fit for Exporters:</strong>
                  Ideal for manufacturers, merchant exporters and merchant-cum-manufacturer exporters dealing in eligible coconut products and looking to build a compliant export setup.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Export Opportunity:</strong>
                  RCMC supports a more organized export profile and can help eligible exporters participate in trade fairs, buyer-seller meets and other promotion initiatives.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Product Coverage:</strong>
                  Coverage focuses on coconut products handled by the Coconut Development Board as EPC; coir and coir products fall outside this EPC scope.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Foreign Trade Policy Linkage:</strong>
                  RCMC is a key trade-registration credential used by exporters to establish membership with the relevant Export Promotion Council or Commodity Board and pursue applicable FTP benefits.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Market Expansion:</strong>
                  With the right export registrations and compliance, coconut businesses can build credibility with overseas buyers and explore international market-development opportunities.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, Coconut Board RCMC is a practical export-readiness credential. Our team supports eligibility checks, document preparation, DGFT e-RCMC filing, query handling and post-registration export guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Coconut Export Promotion Council Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Applicants use the DGFT e-RCMC system, select the relevant Export Promotion Council or Commodity Board, provide exporter and product details, upload required documents and submit the application for processing.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the RCMC becomes an important export credential for the covered validity period and can support access to applicable export-promotion services, trade information and scheme benefits.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our export desk checks IEC and business details, maps the relevant coconut-product category, prepares the application file and supports DGFT/Coconut Development Board queries until completion.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of Coconut Board RCMC
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Recognised Exporter Membership',
                  desc: 'RCMC establishes your membership with the Coconut Development Board in its role as Export Promotion Council for covered coconut products.'
                },
                {
                  title: 'Access to Export Promotion Support',
                  desc: 'Registered exporters can access market information, trade-fair participation opportunities, buyer-seller interactions and other eligible export-promotion support.'
                },
                {
                  title: 'Streamlined Digital Filing',
                  desc: 'The application is handled through the DGFT e-RCMC framework, helping exporters complete a major trade-registration step online.'
                },
                {
                  title: 'Stronger Export Credibility',
                  desc: 'A valid RCMC strengthens your exporter profile when dealing with overseas buyers, trade bodies and export-support ecosystems.'
                },
                {
                  title: 'Product-Specific Guidance',
                  desc: 'Correct product mapping and exporter-category selection reduce avoidable filing errors and improve application readiness.'
                },
                {
                  title: 'Foreign Trade Policy Opportunities',
                  desc: 'Eligible exporters may use RCMC while claiming or accessing applicable benefits, incentives, concessions or schemes under the Foreign Trade Policy.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for Coconut Board RCMC
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Active IEC & Correct Business Details',
                  desc: 'Verify that your IEC and core business details are active, accurate and aligned with the applicant entity before filing.'
                },
                {
                  title: 'Identify Coconut Products for Export',
                  desc: 'List the coconut products you manufacture, trade or export so the correct RCMC scope and main line of business can be selected.'
                },
                {
                  title: 'Choose the Correct Exporter Category',
                  desc: 'Confirm whether you are applying as a Manufacturer Exporter, Merchant Exporter or Merchant-cum-Manufacturer Exporter, as applicable.'
                },
                {
                  title: 'Authorised Signatory & KYC Readiness',
                  desc: 'Keep authorised-signatory PAN/KYC and contact details ready and ensure they match your business records where required.'
                },
                {
                  title: 'Business & Bank Proofs Ready',
                  desc: 'Keep business constitution, address and bank details available in the format required by the current DGFT/CDB application workflow.'
                },
                {
                  title: 'DGFT Account & e-RCMC Access',
                  desc: 'Ensure your DGFT profile is accessible and ready for e-RCMC filing with the correct Export Promotion Council / Commodity Board selection.'
                },
                {
                  title: 'Check Product-Specific Compliance',
                  desc: 'Depending on the coconut product, check whether FSSAI, GST/LUT, customs, testing, labelling or other export compliances are also required.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Coconut Export Promotion Council
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Applicants should have an active IEC and be engaged in exporting or proposing to export coconut products falling within the Coconut Development Board EPC scope. Eligibility, category and documentation depend on the applicant entity, exporter type and product line.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Active Importer Exporter Code (IEC)',
                  desc: 'An active IEC is the foundation for the DGFT e-RCMC application and should reflect the correct applicant entity details.'
                },
                {
                  title: 'Eligible Coconut Product Scope',
                  desc: 'The products should fall within the Coconut Development Board EPC scope; coir and coir products are handled separately.'
                },
                {
                  title: 'Correct Exporter Category',
                  desc: 'Select the exporter category that accurately reflects your operations, such as manufacturer exporter, merchant exporter or merchant-cum-manufacturer exporter.'
                },
                {
                  title: 'Consistent Business Records',
                  desc: 'IEC, PAN, GST where applicable, address, bank and authorised-signatory records should be consistent to reduce portal queries.'
                },
                {
                  title: 'DGFT Profile Readiness',
                  desc: 'Your DGFT account/profile should be accessible and updated before the e-RCMC application is submitted.'
                },
                {
                  title: 'Other Export Licences May Apply',
                  desc: 'Depending on the product and destination market, FSSAI, customs, testing, labelling or other registrations may also be required.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Coconut Export Promotion Council
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your RCMC application smoothly, keep your IEC-linked business details, PAN/GST details where applicable, constitution proof, authorised-signatory details, bank information and coconut product/export details ready. Exact attachments may vary by applicant category and current portal requirements.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'IEC & PAN Details',
                  desc: 'Keep the active IEC and PAN details of the applicant entity ready for verification and application preparation.'
                },
                {
                  title: 'GST & Business Constitution Details',
                  desc: 'GST registration, incorporation/constitution documents and entity details may be required depending on applicant type and portal requirements.'
                },
                {
                  title: 'Bank & Business Address Proof',
                  desc: 'Keep bank and business-address information aligned with your IEC/DGFT profile and current application records.'
                },
                {
                  title: 'Authorised Signatory Details',
                  desc: 'Prepare the authorised signatory\'s contact/KYC details and authority proof where required.'
                },
                {
                  title: 'Coconut Product & Export Details',
                  desc: 'Provide the main line of business, coconut products and exporter category information needed for the e-RCMC application.'
                },
                {
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Coconut Export Promotion Council Process
              </h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  step: 'Step 1',
                  title: 'Check IEC & Exporter Eligibility',
                  desc: 'We review your IEC, entity details, coconut products and exporter category before starting the RCMC application.'
                },
                {
                  step: 'Step 2',
                  title: 'Prepare Documents & Product Details',
                  desc: 'We organize the business, signatory, bank and product information required for the current e-RCMC workflow.'
                },
                {
                  step: 'Step 3',
                  title: 'Select Coconut Development Board in e-RCMC',
                  desc: 'The correct Export Promotion Council / Commodity Board and main line of business are selected in the DGFT application.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit DGFT e-RCMC Application',
                  desc: 'We support completion, attachments, declarations and final submission of the application through the DGFT platform.'
                },
                {
                  step: 'Step 5',
                  title: 'Handle Queries & Deficiencies',
                  desc: 'If the application receives clarification or deficiency requirements, we help prepare the response and supporting documents.'
                },
                {
                  step: 'Step 6',
                  title: 'RCMC Issuance & Export Growth Guidance',
                  desc: 'After issuance, we guide you on maintaining the credential and using it for applicable export-promotion opportunities and benefits.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Status & Role of Coconut Board RCMC
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an export depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the export structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate export structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After RCMC issuance, exporters should keep IEC/DGFT details current, maintain product and export records, and comply with applicable customs, GST, food-safety and destination-market requirements.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the export\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered export name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual export Compliance & Tax Filing',
                  desc: 'File the export\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the export employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                export vs Other Business Structures
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on export structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Export Benefits & Tax-Related Readiness
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              RCMC itself does not replace tax or customs registrations. Exporters should coordinate GST/LUT, customs, banking and product-specific compliance to use available export mechanisms correctly.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on export Structure',
                  desc: 'Tax liability and exemptions depend on whether the export is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible exporters must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working members / trustees are taxable in the founder / trustee\'s hands but deductible for the export, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible exporters should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the export structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Coconut Export Growth & Market Support
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Coconut exporters can strengthen market access through trade fairs, buyer-seller meets, quality improvement, export incentives and appropriate working-capital or trade-finance facilities, subject to scheme and lender eligibility.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible exporters may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, exporters may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an export; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound export deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your export with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their export with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
