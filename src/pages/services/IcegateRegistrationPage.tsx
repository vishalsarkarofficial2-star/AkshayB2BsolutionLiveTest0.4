...
interface IcegateRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — ICEGATE / Indian Customs registration
const FAQ_ITEMS = [
  { q: 'What is ICEGATE Registration in India?', a: 'ICEGATE (Indian Customs Electronic Gateway) is the national customs trade portal of CBIC. Registration enables eligible trade users such as IEC holders, IEC authorised persons, Customs Brokers, shipping lines or agents, airlines or air agents and other permitted stakeholders to access applicable customs e-services.' },
  { q: 'Who can register on ICEGATE?', a: 'Eligible user categories include IEC holders and authorised persons, Customs Brokers and their permitted users, shipping lines, shipping agents, airlines, air agents, console agents and other stakeholder categories supported by ICEGATE.' },
  { q: 'What documents or details are generally required?', a: 'Requirements depend on the user category. Commonly required details may include PAN, IEC where applicable, GSTIN linkage details, authorised-person information, email and mobile verification, organisation details and a valid Digital Signature Certificate where required.' },
  { q: 'Is DSC required for ICEGATE?', a: 'Digital Signature Certificate registration is available on ICEGATE and is required for applicable digitally signed customs transactions. The exact requirement depends on the user category and service being used.' },
  { q: 'How long does ICEGATE Registration take?', a: 'The timeline depends on user category, successful verification, completeness of submitted information and departmental approval. We assist with document readiness, application preparation and follow-up.' },
  { q: 'What happens after ICEGATE Registration?', a: 'After approval, the registered user can log in to the ICEGATE portal and access permitted customs services such as filing, status tracking, duty-related services, DSC registration and other facilities available to that user category.' }
]

// Related services cross-linking items — import/export and customs compliance
const RELATED_SERVICES = [
  {
    title: 'Import Export Code (IEC) Registration',
    desc: 'Get IEC registration support for businesses planning to import or export goods from India.',
    img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80',
    price: '₹999'
  },
  {
    title: 'AD Code Registration',
    desc: 'Assistance for AD Code registration and customs port mapping for export transactions.',
    img: 'https://images.unsplash.com/photo-1494412519320-aa613dfb7738?w=600&auto=format&fit=crop&q=80',
    price: '₹1,499'
  },
  {
    title: 'Digital Signature Certificate (DSC)',
    desc: 'DSC assistance for secure digital signing and applicable customs or government portal transactions.',
    img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&auto=format&fit=crop&q=80',
    price: '₹1,499'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration support for eligible importers, exporters and trading businesses in India.',
  ...
  },
  {
    ...
    desc: 'Letter of Undertaking filing support for eligible exporters supplying without payment of IGST.',
  ...
  {
    title: 'DGFT Profile & IEC Update',
    desc: 'Support for DGFT profile setup, IEC details update and import-export compliance maintenance.',
    img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80',
    price: '₹999'
  },
  {
    title: 'Customs Broker Support',
    desc: 'Documentation and process assistance for customs-related filing, registration and trade compliance.',
  ...
  },
  {
    ...
    desc: 'Professional assistance with commercial invoice, packing list and export documentation readiness.',
    img: 'https://images.unsplash.com/photo-1580674285054-bed31e145f59?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Us'
  }
]

export const IcegateRegistrationPage: React.FC<IcegateRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Importer / Exporter');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('ICEGATE Registration Package (₹1,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">ICEGATE Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Customs Registration Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Digital Application Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Get ICEGATE Registration support at just{' '}
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  ICEGATE Registration enables eligible importers, exporters, Customs Brokers, shipping and airline stakeholders and other permitted users to access India’s Customs Electronic Gateway services. Our assistance covers registration readiness, user-category selection, document review, verification guidance and post-registration support.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>IEC &amp; Trade User Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileCheck className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>IEC / PAN / GSTIN Readiness</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <KeyRound className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>ICEGATE Portal Guidance</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our ICEGATE registration specialist has received your request. We will contact you shortly at <span className="font-bold">{applicantMobile}</span> to verify your trade-user category and documents.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State / Business Location *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your business location helps us organise the applicable KYC, IEC/GSTIN details and registration support for your ICEGATE user category.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get guided support for ICEGATE user-category selection, IEC/PAN/GSTIN readiness, email/mobile verification, DSC-related steps and application follow-up.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Applicant / Authorised Person Full Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Applicant / Authorised Person PAN Number (Optional)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select ICEGATE Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="ICEGATE Registration Package (₹1,999)">ICEGATE Registration Package — ₹1,999</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit ICEGATE Registration Request</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'ICEGATE Process' },
                { id: 'advantages', label: 'Advantages' },
                { id: 'checklist', label: 'Checklist' },
                { id: 'eligibility', label: 'Eligibility' },
                { id: 'documents', label: 'Documents Required' },
                { id: 'steps', label: 'Steps' },
                { id: 'legal-status', label: 'Account Status' },
                { id: 'post-compliance', label: 'After Registration' },
                { id: 'comparison', label: 'ICEGATE vs Others' },
                { id: 'tax-implications', label: 'Tax & Duty' },
                { id: 'financing', label: 'Trade Finance' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your ICEGATE Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One professional assistance package for ICEGATE registration readiness, document review, user-category guidance and application support.
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mb-6">
                    ICEGATE registration assistance for eligible import-export and customs trade users.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-sm text-slate-500 font-bold uppercase tracking-wide">Single Package</span>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'ICEGATE Registration Application Guidance',
                      'IEC / PAN / GSTIN Readiness Review',
                      'User Category & Portal Registration Support',
                      'Email & Mobile Verification Guidance',
                      'DSC Registration Guidance, where applicable',
                      'Dedicated ICEGATE Registration Specialist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('ICEGATE Registration Package (₹1,999)');
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              ICEGATE is the Indian Customs Electronic Gateway operated for electronic interaction between Customs and trade users. Registration gives eligible stakeholders access to the portal services permitted for their user category, including customs filing, status tracking and related electronic facilities.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Eligible Trade Users:</strong>
                  Suitable for eligible IEC holders, IEC authorised persons, Customs Brokers, shipping lines or agents, airlines or air agents, console agents and other supported customs stakeholders.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Single Customs Portal Access:</strong>
                  ICEGATE provides a digital interface for eligible customs and trade services, reducing dependence on manual communication for many supported processes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Verified User Identity:</strong>
                  Registration links the user profile with applicable identifiers such as PAN, IEC, GSTIN and authorised-person details depending on the selected category.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Digital Signature Support:</strong>
                  Applicable users can register or update a Digital Signature Certificate on ICEGATE for digitally signed customs transactions.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Trade Compliance Convenience:</strong>
                  A verified ICEGATE account helps eligible businesses interact with Customs electronically and access services relevant to imports, exports and cargo movement.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, ICEGATE registration is an important digital onboarding step for eligible customs and trade users. Our team supports eligibility review, documentation readiness, portal registration guidance, DSC-related assistance and post-registration setup.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How ICEGATE Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              ICEGATE registration is completed through the portal registration module. The applicant selects the appropriate user category and provides the required identification, organisation and contact details for verification.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After successful registration and approval, the user receives access credentials and can use the ICEGATE services available to that user category. Approval timing depends on verification and departmental processing.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk helps review IEC/PAN/GSTIN and authorised-person details, organise supporting information, guide portal registration and assist with DSC-related steps where applicable.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of ICEGATE Registration
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Digital Access to Customs Services',
                  desc: 'Registered users can access applicable ICEGATE customs services through a verified digital account based on their user category.'
                },
                {
                  title: 'Faster Electronic Interaction',
                  desc: 'Electronic customs interaction helps eligible trade users file, track and manage supported transactions more efficiently.'
                },
                {
                  title: 'Structured Registration Support',
                  desc: 'Our ₹1,999 package covers registration guidance, document readiness review and portal support for the applicable user category.'
                },
                {
                  title: 'Verified Trade User Profile',
                  desc: 'The registered profile connects the applicant with relevant identifiers and authorisations used for customs-facing electronic services.'
                },
                {
                  title: 'DSC & Secure Transactions',
                  desc: 'Applicable users can register DSC details for secure digital signing and supported customs transactions.'
                },
                {
                  title: 'Pan-India Customs Connectivity',
                  desc: 'ICEGATE serves as a national electronic gateway for Customs and trade stakeholders across India.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before ICEGATE Registration
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Identify the Correct ICEGATE User Category',
                  desc: 'Determine whether registration is being made as an IEC holder, authorised person, Customs Broker, shipping or airline stakeholder, or another supported category.'
                },
                {
                  title: 'Keep IEC and PAN Details Ready',
                  desc: 'Keep the organisation or applicant PAN and IEC information ready where the selected category requires them.'
                },
                {
                  title: 'Verify GSTIN Linkage, where applicable',
                  desc: 'Ensure GSTIN details are correct and consistent with the business profile where GSTIN integration or matching is applicable.'
                },
                {
                  title: 'Authorised Person Details',
                  desc: 'Keep the authorised person’s identification, email and mobile details ready for user verification and account communication.'
                },
                {
                  title: 'Active Email & Mobile Access',
                  desc: 'Use accessible contact details because verification, status messages and credentials may be communicated electronically.'
                },
                {
                  title: 'Choose the Correct ICEGATE User Category',
                  desc: 'Keep a valid DSC ready where your category or customs transaction requires digital signing, and complete DSC registration post-login where applicable.'
                },
                {
                  title: 'Check Supporting Trade Registrations',
                  desc: 'Review whether IEC, GST, AD Code, RCMC or other trade registrations are required for your import-export operations separately from ICEGATE.'
                },
                {
                  title: 'akshayb2bsolutions Verification Role',
                  desc: 'Our compliance team conducts a preliminary information review to identify mismatches and improve registration readiness before submission.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              ICEGATE registration eligibility depends on the recognised user categories available on the portal. The applicant should have the identifiers, authorisation and contact details required for the selected category.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Supported ICEGATE User Category',
                  desc: 'The applicant must fall within a user category supported by ICEGATE, such as IEC holder/authorised person, Customs Broker or other permitted trade stakeholder.'
                },
                {
                  title: 'Valid Business / Personal Identifiers',
                  desc: 'PAN, IEC, GSTIN or licence-related identifiers must be valid wherever they are required for the selected category.'
                },
                {
                  title: 'Authorisation to Register',
                  desc: 'An authorised person registering for an organisation should have the appropriate authority and matching details.'
                },
                {
                  title: 'Verified Contact Details',
                  desc: 'Active email and mobile details should be available for verification, communication and credential delivery.'
                },
                {
                  title: 'DSC Where Applicable',
                  desc: 'A valid Digital Signature Certificate may be required for applicable digitally signed customs transactions and user categories.'
                },
                {
                  title: 'Departmental Verification',
                  desc: 'Registration remains subject to ICEGATE and Customs validation, approval and any additional verification applicable to the selected user category.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions reviews the information you provide for consistency and guides you through the registration workflow; final approval is controlled by the government portal.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Details & Documents for ICEGATE Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              The exact information required varies by ICEGATE user category. Keep your core KYC, trade registration and authorised-person details ready before starting the registration process.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'PAN Details',
                  desc: 'PAN details of the applicant or organisation should be available and should match the selected registration category.'
                },
                {
                  title: 'IEC Details, where applicable',
                  desc: 'Import Export Code information is required for IEC-holder or authorised-person registration and should match DGFT records.'
                },
                {
                  title: 'GSTIN Details, where applicable',
                  desc: 'Keep GSTIN and related business details ready where matching or integration is relevant to the user profile.'
                },
                {
                  title: 'Authorised Person KYC & Contact Details',
                  desc: 'Name, designation, email, mobile and identity details of the authorised person may be required depending on the category.'
                },
                {
                  title: 'Digital Signature Certificate, where applicable',
                  desc: 'A valid DSC should be available for services or user categories that require digitally signed customs submissions.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our team helps organise the registration information, identify missing items and guide you through the applicable ICEGATE registration workflow.'
                }
              ].map((item, idx) => (
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Choose the Correct ICEGATE User Category',
                  desc: 'Identify whether the applicant is an IEC holder, authorised person, Customs Broker, shipping/airline stakeholder or another supported user type.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect KYC & Trade Registration Details',
                  desc: 'Prepare PAN, IEC, GSTIN, licence details, authorised-person information and valid contact details as applicable.'
                },
                {
                  step: 'Step 3',
                  title: 'Complete Portal Registration Details',
                  desc: 'Enter the required details in the ICEGATE registration module and complete the user verification steps.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'Submit the registration request with the required information and supporting details for departmental verification.'
                },
                {
                  step: 'Step 5',
                  title: 'Register DSC, where applicable',
                  desc: 'After login, complete DSC registration or update where required for secure digitally signed customs transactions.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'After approval, use the issued login credentials to access the ICEGATE services available for your registered user category.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  ICEGATE registration creates a verified portal user profile; it does not itself create a company, IEC, GST registration or separate legal entity.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The user must keep relevant PAN, IEC, GSTIN, licence, contact and authorised-person details updated whenever changes affect the registered profile.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Parent and child-user permissions may apply for certain user categories, and the principal user should manage employee access appropriately.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Access to portal functions depends on the registered category, Customs rules, verification status and the permissions available to that user.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our advisors guide you on ICEGATE onboarding, related IEC/GSTIN readiness, DSC registration steps and ongoing profile maintenance.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Post-Registration ICEGATE Checklist
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              After ICEGATE registration, keep the account and linked trade information current so you can continue using the applicable customs services smoothly.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Verify Login & Registered Profile',
                  desc: 'Confirm that the approved ICEGATE user profile, contact details and linked identifiers are accurate.'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Register or update your Digital Signature Certificate where required for the customs services you use.'
                },
                {
                  title: 'Keep IEC / GSTIN Information Updated',
                  desc: 'Ensure the identifiers linked to your import-export business remain correct across relevant government records.'
                },
                {
                  title: 'Report Changes to the relevant registering authority',
                  desc: 'Where the category supports parent and child users, add, approve or disable user access according to current authorisation.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Keep DSC and other credentials valid and update them when they expire or when portal instructions require changes.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                ICEGATE vs Related Trade Registrations
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      CBIC / Indian Customs Electronic Gateway
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Trade Users</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      No separate tax status created; portal access only
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                ICEGATE Registration & Tax / Duty Compliance
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              ICEGATE registration is a customs portal user registration and does not itself create a new tax status. Import-export businesses must separately comply with GST, Customs duty, IEC and other applicable laws.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'ICEGATE Does Not Replace GST or IEC',
                  desc: 'ICEGATE access is separate from your GST registration and Import Export Code, even though related identifiers may be linked or matched.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Customs duty, cess and other charges depend on the goods, classification, valuation, exemptions and applicable customs rules.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Registered businesses must continue applicable GST return, invoicing and export-related compliance independently of ICEGATE registration.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'IEC details should be maintained with DGFT and kept consistent with the business information used across customs-related systems.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our team can assist with ICEGATE onboarding plus related IEC, GST, AD Code, RCMC and export documentation services where required.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              ICEGATE registration supports customs-facing digital access; it does not provide financing. Importers and exporters may separately use bank facilities, export finance and government export-support mechanisms subject to eligibility.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Importers and exporters may access working-capital or trade-finance facilities from banks subject to credit assessment and documentation.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Eligible exporters may explore pre-shipment or post-shipment finance and other banking facilities according to RBI and bank requirements.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'ICEGATE registration itself is not a loan, subsidy or funding approval and does not guarantee access to finance.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We review your business activity and help identify the appropriate ICEGATE user category and related registration requirements.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists help organise PAN, IEC, GSTIN, authorised-person and DSC readiness to reduce avoidable registration errors.'
                },
                {
                ...
                {
                  title: 'Dedicated Post-Registration Trade Support',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Clear professional assistance pricing at ₹1,999 for the ICEGATE Registration package, with any separate third-party or statutory charges disclosed where applicable.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Secure handling practices for applicant KYC, trade registration details and business documentation shared for assistance.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Complete Your ICEGATE Registration with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Get professional guidance for ICEGATE user registration, document readiness and portal onboarding for your import-export or customs-related business.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Start ICEGATE Registration at ₹1,999/-
              </button>
              <button
            ...
            <div className="bg-gradient-to-r from-[#0B3D91] via-[#0D47A1] to-[#082a66] text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-4 max-w-md relative z-10">
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
                  Track Your ICEGATE Registration in Real-Time
                </h3>
