...
interface FoodBusinessRegistrationLandingProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian Food Business Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is FSSAI State License in India?', a: 'Food Business registration is the legal process of establishing a non-governmental organization under an appropriate structure such as a State License, Food Business, or Central License. Registration gives the organization legal recognition and helps it operate, open a bank account, enter agreements, and seek eligible grants or donations.' },
  { q: 'Which types of Food Business can be registered in India?', a: 'Common structures include State License Registration, Food Business Registration, and Central License Registration. The suitable structure depends on the Food Business objectives, members, governance model, and compliance requirements.' },
  { q: 'What documents are generally required for Food Business registration?', a: 'Typical documents include the proposed Food Business name, PAN and identity/address proofs of founders or trustees, registered-office address proof, NOC where applicable, photographs, and the applicable MOA, FSSAI Docs, or State License Rules.' },
  { q: 'How long does Food Business registration take?', a: 'The timeline depends on the Food Business structure, state, government verification, and document readiness. A practical estimate can range from a few weeks to around 30–45 days, subject to the relevant authority.' },
  { q: 'Can a registered Food Business apply for 12A and 80G?', a: 'Eligible Food Businesss can apply for tax-exemption and donor-benefit registrations such as 12A/12AB and 80G, subject to the applicable Income Tax rules and approval requirements.' },
  { q: 'Can an Food Business receive foreign donations?', a: 'An Food Business generally needs to meet the applicable eligibility and compliance requirements and obtain FCRA registration or prior permission before receiving foreign contributions under Indian law.' }
]

// Related services cross-linking items — sourced from Food Business-adjacent structures
const RELATED_SERVICES = [
  { title:"FSSAI Basic Registration", desc:"Basic registration for petty food businesses.", img:"https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&auto=format&fit=crop&q=80", price:"₹899" },
  { title:"FSSAI Central License", desc:"Central license for large food businesses and import/export.", img:"https://images.unsplash.com/photo-1556740749-887f6717d7e4?w=600&auto=format&fit=crop&q=80", price:"₹4,999" },
  { title:"GST Registration", desc:"GST registration for eligible food businesses.", img:"https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80", price:"₹499" },
  { title:"MSME Udyam Registration", desc:"Udyam registration support.", img:"https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80", price:"₹499" },
  { title:"Shop & Establishment License", desc:"State shop and establishment registration.", img:"https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=600&auto=format&fit=crop&q=80", price:"₹999" },
  { title:"Trademark Registration", desc:"Protect your food brand and logo.", img:"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80", price:"₹1,499" }
]

export const FoodBusinessRegistrationLanding: React.FC<FoodBusinessRegistrationLandingProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('FSSAI State License Package (₹2,499)');
  ...
  const [counterLicensingExperts, setCounterLicensingExperts] = useState(0);
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      setCounterLicensingExperts(Math.floor(progress * 150));
      if (start >= steps) {
        clearInterval(timer);
        setCounterClients(10000);
        setCounterCertificates(15000);
        setCounterLicensingExperts(150);
      }
    }, intervalTime);
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">FSSAI State License</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span className="text-white">Fast-Track 7–15 Days</span>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  FSSAI State License in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an Food Business may be registered as a State License, Food Business, or Central License under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>2-20 Members / Food Businessees Allowed</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>MOA / FSSAI Docs Drafting</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>relevant registering authority Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-white/10 border border-white/15 text-xs text-white">
                    ...
                    <span className="text-slate-300 text-[11px]">Food Businesspilot</span>
                  </div>
                </div>
              </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based Food Business specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of FSSAI State License *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The applicable registration authority and documentation depend on whether your Food Business is formed as a State License, Food Business, or Central License.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete Food Business name-check, FSSAI Documentation drafting, government filing support, and registration guidance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>
                                <label className="block text-xs font-bold text-slate-700 mb-1">
                                  Food Business Activity / Objective *
                                </label>
                                <select
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Authorized Member / Food Businessee Full Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Authorized Member / Food Businessee PAN Number (Optional for quote)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select FSSAI State License Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="FSSAI State License Package (₹2,499)">FSSAI State License Package — ₹2,499 + Govt. Fees</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your Food Business Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional Food Business registration guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mb-6">
                    Essential statutory registration for two or more members / trustees to commence trade.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'FSSAI Documentation Drafting & Vetting',
                      'PAN / TAN Application Guidance',
                      'relevant registering authority Filing Support',
                      'Basic Food Business Name Availability Check',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('FSSAI State License Package (₹2,499)');
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is a Food Business in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              Food Business registration gives a non-governmental organization a recognized legal identity to operate for lawful charitable or social-welfare objectives. The organization may be structured as a State License, Food Business, or Central License, with its governing documents defining its purpose, members or trustees, management, and rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Properly drafted MOA, FSSAI Docs, or State License Rules clearly define the Food Business's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The legal identity and liability framework depends on whether the Food Business is formed as a State License, Food Business, or Central License; the governing documents and applicable law determine the responsibilities of members, trustees, directors, and office bearers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration under the Indian Food Business Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow members / trustees in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An Food Business is not formed for distributing profits to members. Eligible organizations can pursue donations, grants, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, Food Business registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How FSSAI State License Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Food Business registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a State License, Food Business, or Central License.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the Food Business registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our legal desk helps prepare the appropriate MOA, FSSAI Docs, State License Rules, declarations, and supporting documents and assists with filing and government follow-up.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of a Food Business
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Legal recognition helps the Food Business operate through a defined legal structure, enter agreements, maintain records, and pursue its stated charitable or social objectives.'
                },
                {
                  title: 'Shared Capital & Combined Expertise',
                  desc: 'Members / Food Businessees pool resources, skills, and networks, enabling faster growth than a single-owner structure with minimal capital constraints.'
                },
                {
                  title: 'Minimal Start-up Costs & Quick Setup',
                  desc: 'Get professional documentation and registration support with transparent professional fees; the final timeline depends on Food Business structure, state, authority, and government verification.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible Food Businesss may access government schemes, grants, CSR opportunities, and donor programs subject to the relevant eligibility and compliance requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Registering Your Food Business
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique Food Business Name Selection',
                ...
                {
                  title: 'Clearly Defined Food Business Objectives and Governance',
                ...
                {
                  title: 'Valid Identity and Address Proofs of All Members / Food Businessees',
                ...
                {
                  title: 'Draft FSSAI Documentation',
                  desc: 'Clearly state the Food Business objectives, governance, membership or trusteeship, powers, duties, meetings, accounts, and dissolution provisions in the governing document.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To register a Food Business in India, there must be a minimum of two members / trustees and a maximum of twenty. All members / trustees must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Members / Food Businessees',
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen Food Business structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected Food Business structure.'
                },
                {
                  title: 'Unique Food Business Name Requirement',
                  desc: 'The Food Business must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written Food Business Deed',
                  desc: 'The appropriate MOA, FSSAI Docs, or State License Rules must clearly state the Food Business objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The Food Business must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a Food Business.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your Food Business registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Members / Food Businessees\' Identity Proof (PAN Cards)',
                ...
                {
                  title: 'Members / Food Businessees\' Address Proof (Aadhaar Card / Voter ID)',
                ...
                {
                  title: 'Signed FSSAI Documentation',
                  desc: 'The applicable governing document signed/executed by the required founders, trustees, members, or directors, covering Food Business objectives and governance rules.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our legal drafting team prepares the applicable MOA, FSSAI Docs, State License Rules, NOC drafts, declarations, and supporting documents according to the relevant authority requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step FSSAI State License Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Draft FSSAI Documentation',
                  desc: 'We prepare the appropriate governing document detailing the Food Business objectives, founders/trustees, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Members / Food Businessees',
                ...
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique Food Business Name',
                  desc: 'Our team helps check the proposed Food Business name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped Food Business deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                ...
                },
                {
                  ...
                  desc: 'Receive the Food Business registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the Food Business bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Status of a Food Business
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an Food Business depends on its structure. A Central License has a separate corporate identity, while State License and Food Business structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the Food Business structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate Food Business structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, Food Businesss must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Open a dedicated bank account in the registered Food Business name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual Food Business Compliance & Tax Filing',
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Food Business vs Other Business Structures
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Members / Food Businessees
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Members / Food Businessees</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on Food Business structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Members / Food Businessees
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">7. Credibility &amp; Food Business</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for Food Businesss in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Food Business tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on Food Business Structure',
                  desc: 'Tax liability and exemptions depend on whether the Food Business is a Food Business, State License, or Central License and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible Food Businesss must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible Food Businesss should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Food Businesss generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible Food Businesss may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, Food Businesss may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                {
                  title: 'Credit Guarantee Fund Food Business for Micro and Small Enterprises (CGTMSE)',
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an Food Business; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound Food Business deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Thousands of Co-Founders Food Business akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                {
                  title: 'Food Businessed by Thousands',
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your Food Business with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their Food Business with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
...
export const FssaiStateLicenseLanding = FoodBusinessRegistrationLanding;
