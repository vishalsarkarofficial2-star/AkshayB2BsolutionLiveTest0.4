...
interface SocietyRegistrationLandingProps {
  onBackToHome: () => void;
...
// Society Registration FAQs — based on the Societies Registration Act, 1860 framework
const FAQ_ITEMS = [
  {
    q: 'How many members are required to register a Society in India?',
    a: 'A minimum of seven members is generally required to form a society under the Societies Registration Act, 1860. State-specific rules and filing requirements may also apply.'
  },
  {
    q: 'What are the main documents required for Society Registration?',
    a: 'Key documents generally include the Memorandum of Association (MOA), Rules & Regulations, identity and address proofs of founding members, registered office address proof, photographs, owner NOC and required affidavits.'
  },
  {
    q: 'Can a Society receive donations and government grants?',
    a: 'A registered society can pursue donations, grants and institutional funding subject to applicable eligibility and tax/compliance requirements. Additional registrations such as 12A/12AB, 80G, Darpan, CSR-1 or FCRA may be required depending on the activity and funding source.'
  },
  {
    q: 'Is Society Registration valid for all of India?',
    a: 'Society registration is administered by the relevant state/UT authority, and filing procedure, forms, fees and renewal requirements can vary by state. The registered office must fall within the jurisdiction of the registering authority.'
  },
  {
    q: 'How long does Society Registration take?',
    a: 'The timeline depends on the state Registrar of Societies, document readiness and scrutiny. A typical professional service workflow may take around 7 to 15 working days after receiving complete documents, subject to government processing.'
  },
  {
    q: 'Does your team handle MOA, Rules & Regulations and Registrar filing?',
    a: 'Yes. The service covers drafting and review of the Memorandum of Association and Rules & Regulations, document preparation, application filing support and follow-up with the applicable Registrar of Societies.'
  }
];

// Related NGO / Society services with relevant visual references
const RELATED_SERVICES = [
  {
    title: 'NGO Registration',
    desc: 'Choose the appropriate non-profit structure such as Society, Trust or Section 8 Company for social and charitable activities.',
    img: 'https://images.unsplash.com/photo-1593113598332-cd288d649433?w=600&auto=format&fit=crop&q=80',
    price: '₹2,999'
  },
  {
    title: 'Trust Registration',
    desc: 'Register a charitable or private trust with the required trust deed and state-level documentation support.',
    img: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=600&auto=format&fit=crop&q=80',
    price: '₹2,999'
  },
  {
    title: 'Section 8 Company Registration',
    desc: 'A Companies Act structure for charitable, educational, social and non-profit objectives with corporate legal identity.',
  ...
  },
  {
    ...
    desc: 'Tax exemption and donor-benefit registrations for eligible charitable organisations, subject to statutory approval.',
    img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80',
    price: '₹2,999'
  },
  {
    title: 'NGO Darpan Registration',
    desc: 'NITI Aayog NGO Darpan registration support for eligible non-profit organisations seeking institutional visibility and scheme access.',
    img: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=600&auto=format&fit=crop&q=80',
    price: '₹2,999'
  },
  {
    title: 'CSR-1 Registration',
    desc: 'Support for eligible entities seeking to undertake CSR implementation activities in accordance with applicable requirements.',
    img: 'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=600&auto=format&fit=crop&q=80',
    price: '₹2,999'
  },
  {
    title: 'FCRA Registration',
    desc: 'Compliance support for eligible organisations intending to receive foreign contribution under applicable FCRA provisions.',
    img: 'https://images.unsplash.com/photo-1529390079861-591de354faf5?w=600&auto=format&fit=crop&q=80',
    price: '₹2,999'
  },
  {
    title: 'Society Renewal & Compliance',
    desc: 'Renewal, member records, annual documentation and ongoing compliance assistance as required by the applicable state rules.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: '₹2,999'
  }
];

export const SocietyRegistrationLanding: React.FC<SocietyRegistrationLandingProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Society');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Society Registration Package (₹2,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Society Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Society registration is the legal process of establishing a group of individuals for charitable, literary, scientific, cultural, educational or social objectives. In India, societies are commonly registered under the Societies Registration Act, 1860 or applicable state law. Registration provides legal recognition and supports activities such as opening a bank account, holding property, receiving eligible grants and donations, and entering into contracts.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileText className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>MOA & Rules Drafting</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Registrar of Societies</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Society Registration specialist has been assigned to your registration request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                State jurisdiction determines the applicable Registrar of Societies and state-specific filing requirements.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete MOA and Rules & Regulations drafting, documentation and Registrar of Societies filing support with a guided digital process.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              ...
                              >
                                <option value="Society Registration Package (₹2,999)">Society Registration Package — ₹2,999 (MOA + Rules & Regulations + Registrar Filing)</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Society Registration Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                All packages include verified deed drafting, Registrar of Societies filings, and direct Chartered Accountant support from our Noida headquarters.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Society Registration Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Essential registration support for a charitable, literary, cultural, educational or social organisation with a minimum of seven founding members.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-4xl font-extrabold text-[#0D47A1]">₹2,999</span>
                    </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'MOA & Rules & Regulations Drafting and Vetting',
                      'Society PAN Application Support',
                      'Registrar of Societies Filing Support',
                      'Society Name Availability Check',
                      'Bank Account Opening Guidance',
                      'Dedicated Society Registration Specialist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Society Registration Package (₹2,999)');
                ...
                >
                  Get Started with Society Registration
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              Society registration is the legal process of establishing a group of individuals for charitable, literary, scientific, cultural, educational or social objectives. In India, societies are commonly registered under the Societies Registration Act, 1860 or the applicable state law. Registration provides legal recognition and supports activities such as opening a bank account, holding property, receiving eligible grants and donations, and entering into contracts.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for NGOs, welfare associations, cultural organisations, educational initiatives, charitable groups and community-development organisations that need a recognised non-profit structure.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A well-drafted MOA and Rules & Regulations define the society’s objectives, membership, governance, meetings, powers, duties and procedures for managing the organisation.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A registered society has a legal identity recognised under the applicable law. Members are generally not personally liable for every society obligation merely because they are members, subject to the governing documents and applicable law.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration gives the organisation formal legal recognition, improves institutional credibility and helps it apply for eligible grants, funding and related registrations. Exact legal effects depend on the applicable state law.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A society is a non-profit structure and cannot distribute profits to members as dividends. Its income and assets should be applied towards its stated objectives, subject to applicable law.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, Society Registration provides a recognised structure for organisations working towards social, charitable, cultural, educational or other permitted non-profit objectives. Our team supports the documentation, filing and registration workflow from start to certificate issuance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Society Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Society registration involves selecting a compliant name, preparing the Memorandum of Association and Rules & Regulations, compiling member and office documents, and submitting the application to the applicable Registrar of Societies. The exact forms, fees and online/offline process vary by state.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After scrutiny and approval, the Registrar records the society and issues a registration certificate. The certificate can support opening a bank account, applying for eligible registrations and grants, and demonstrating the organisation’s legal status to donors and institutional partners.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our Noida legal desk drafts a legally sound society deed, prepares all documentation with zero errors, and interfaces directly with the state Registrar of Societies to secure your certificate in record time.
              </p>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  desc: 'A registered society can enforce agreements in court and sue clients, suppliers, or competitors for breach of contract or non-payment.'
                },
                {
                  title: 'Shared Capital & Combined Expertise',
                  desc: 'Founding Members pool resources, skills, and networks, enabling faster growth than a single-owner structure with minimal capital constraints.'
                },
                {
                  title: 'Minimal Start-up Costs & Quick Setup',
                  desc: 'Enjoy competitive registration fees and statutory costs, with entire deed drafting and Registrar filing completed in 7 to 15 working days.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Many government schemes and MSME incentives are available to registered societies, enabling growth with financial support.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Society Registration
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique Society Name Selection',
                  desc: 'Choose a distinctive, legally permissible society name that does not infringe on registered trademarks or violate state naming guidelines.'
                },
                {
                  title: 'Clear Non-Profit Objectives and Activities',
                ...
                {
                  title: 'Finalized Governance and Membership Rules',
                  desc: 'Agree in advance on each member\'s member contribution and member rights and governance rules to avoid disputes after registration.'
                },
                {
                  title: 'Valid Identity and Address Proofs of All Founding Members',
                  desc: 'Ensure every member\'s PAN Card and Aadhaar Card details match identically and are linked to an active mobile number for OTP verification.'
                },
                {
                ...
                {
                  title: 'Draft MOA & Rules and Regulations',
                  desc: 'Set out the society’s objects, membership, meetings, governing body powers, accounts, amendment procedure and dissolution provisions.'
                },
                {
                  title: 'Identification of Required Sectoral Licenses',
                  desc: 'Determine whether additional registrations such as 12A/12AB, 80G, NGO Darpan, CSR-1, FCRA, GST or FSSAI are relevant to the society’s activities.'
                },
                {
                  title: 'akshayb2bsolutions Verification Role',
                  desc: 'Our compliance team reviews the proposed name, objectives, member KYC, office proof and constitutional documents before filing to reduce errors and avoid avoidable delays.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              A minimum of seven members is generally required to register a society. Members should be legally competent and the society’s objects must be lawful and aligned with the applicable Societies Registration Act and state requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Seven Founding Members',
                  desc: 'A society generally requires at least seven members. State-specific requirements should be checked before filing.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Every member must be 18 years or older, of sound mind, and not declared an undischarged insolvent under Indian insolvency laws.'
                },
                {
                  title: 'Unique Society Name Requirement',
                  desc: 'The society must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Memorandum of Association & Rules',
                  desc: 'The MOA should state the society’s name, objects and founding members, while the Rules & Regulations should cover governance, meetings, membership, duties and internal administration.'
                },
                {
                  title: 'Registered Office in India',
                  desc: 'The society should have a verifiable registered office address within the jurisdiction of the relevant Registrar of Societies.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'The society must not undertake objects prohibited by law. Activities in regulated sectors may require additional licences or a different legal structure.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates every member\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process Society Registration smoothly, identity and address proofs of founding members, registered office proof and constitutional documents are generally required. Exact requirements vary by state. All documents are collected 100% digitally through our secure cloud portal.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Founding Members\' Identity Proof (PAN Cards)',
                  desc: 'Scanned copies of each member\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Founding Members\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Aadhaar Card, Voter ID, Passport or other accepted address proof as required by the registering authority.'
                },
                {
                  title: 'Registered Office Address Proof',
                  desc: 'Recent utility bill, property tax receipt or other accepted address proof for the registered office.'
                },
                {
                ...
                {
                  title: 'Memorandum of Association & Rules',
                  desc: 'Signed MOA, Rules & Regulations and required declarations/affidavits of the founding members.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our legal drafting team assists with MOA, Rules & Regulations, NOC and affidavit/document formatting according to the applicable Registrar requirements.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  step: 'Step 1',
                  title: 'Draft MOA & Rules & Regulations',
                  desc: 'We prepare the MOA and Rules & Regulations covering the society’s objectives, founding members, governance, meetings, membership and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Founding Members',
                  desc: 'Upload scanned copies of PAN, Aadhaar, business address proof, and photographs of every member to our encrypted platform.'
                },
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique Society Name',
                  desc: 'Our registration team checks proposed name suitability under applicable state guidelines and helps reduce conflicts with existing names or marks.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to Registrar of Societies',
                  desc: 'We file Form 1, the stamped society deed, and supporting documents with the state\'s Registrar of Societies on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'Society PAN Application & GST Registration',
                  desc: 'We apply for the society\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the Society Registration Certificate, constitutional documents and guidance for opening the society’s bank account.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Status of a Registered Society
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  A society does not possess a separate legal personality distinct from its founding members; the founding members and the society are treated as one collective legal entity under Indian law.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Compliance is restricted to active tax returns (GST and society Income Tax) and deed amendment filings without mandatory MCA disclosures or board filings.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered societies still lack perpetual succession — the entity may dissolve upon a member\'s exit, unless the deed states otherwise.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Founding Members bear joint and several liability for operational debts, commercial loans, supplier obligations, and damages resulting from legal suits against the society.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on liability safeguards, deed drafting, member exit clauses, and help you recognize the optimal milestone to convert into an LLP or Private Limited Company as turnover expands.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Post-Registration Compliance for a Society
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Maintain Member & Governing Body Records', desc: 'Keep the register of members, governing body records, minutes and resolutions updated according to the applicable rules.' },
                { title: 'Maintain Books of Accounts', desc: 'Maintain proper books, receipts, vouchers and supporting records for donations, grants and expenditure.' },
                { title: 'Annual / Periodic Filings', desc: 'Complete the annual or periodic filings, statements and renewals required by the relevant state Registrar.' },
                { title: 'Income Tax Compliance', desc: 'File applicable income-tax returns and maintain records supporting the society’s charitable or non-profit activities.' },
                { title: '12A/12AB & 80G Compliance', desc: 'Where approved, maintain the conditions and documentation applicable to tax exemption and donor deduction benefits.' },
                { title: 'Additional NGO Registrations', desc: 'Apply for NGO Darpan, CSR-1 or FCRA only when eligible and relevant to the organisation’s funding or activities.' }
              ].map((item, idx) => (
                <div key={idx} className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed pl-7 mt-1">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">Society vs Other Non-Profit Structures</h2>
            </div>
            <div className="overflow-x-auto rounded-2xl border border-slate-200 bg-white">
              <table className="w-full text-sm">
                <thead className="bg-[#0B3D91] text-white"><tr><th className="p-3 text-left">Factor</th><th className="p-3 text-left">Society</th><th className="p-3 text-left">Trust</th><th className="p-3 text-left">Section 8 Company</th></tr></thead>
                <tbody className="text-slate-700">
                  <tr><td className="p-3 border-t font-semibold">Primary Framework</td><td className="p-3 border-t">Societies Registration Act / State law</td><td className="p-3 border-t">Applicable Trust law</td><td className="p-3 border-t">Companies Act, 2013</td></tr>
                  <tr><td className="p-3 border-t font-semibold">Typical Use</td><td className="p-3 border-t">Welfare, cultural, educational and charitable groups</td><td className="p-3 border-t">Charitable or private trust objectives</td><td className="p-3 border-t">Structured non-profit with corporate identity</td></tr>
                  <tr><td className="p-3 border-t font-semibold">Members / Governance</td><td className="p-3 border-t">Members and governing body</td><td className="p-3 border-t">Trustees</td><td className="p-3 border-t">Members and directors</td></tr>
                  <tr><td className="p-3 border-t font-semibold">Compliance</td><td className="p-3 border-t">State-specific filings and records</td><td className="p-3 border-t">Trust deed and applicable filings</td><td className="p-3 border-t">MCA annual compliance and statutory records</td></tr>
                </tbody>
              </table>
            </div>
          </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">Tax & Funding Considerations for a Society</h2>
            </div>
            <p className="text-sm text-slate-700 leading-relaxed">Society Registration by itself does not automatically grant income-tax exemption. Eligible societies may need separate approval/registration such as 12A/12AB and 80G and must satisfy the applicable conditions. Foreign contributions require compliance under FCRA where applicable.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: '12A / 12AB', desc: 'Supports eligible charitable or religious institutions seeking income-tax exemption, subject to approval and continuing compliance.' },
                { title: '80G', desc: 'Eligible organisations may seek 80G approval so qualifying donors can claim deductions subject to the applicable tax rules.' },
                { title: 'Government & Institutional Grants', desc: 'A registered and compliant society may apply for grants or schemes where the funding programme permits societies.' },
                { title: 'Foreign Contribution', desc: 'FCRA registration or prior permission is required where the organisation intends to receive foreign contribution, subject to eligibility.' }
              ].map((item, idx) => (
                <div key={idx} className="p-4 rounded-xl bg-slate-50 border border-slate-200"><h4 className="font-bold text-sm text-slate-900">{item.title}</h4><p className="text-xs text-slate-600 leading-relaxed mt-1">{item.desc}</p></div>
              ))}
            </div>
          </div>
        </section>
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">Funding Options for Registered Societies</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Public Donations', desc: 'Build transparent donation systems and maintain proper receipts and accounting records.' },
                { title: 'Government Grants', desc: 'Apply to eligible government schemes where the society meets the programme-specific conditions.' },
                { title: 'CSR Funding', desc: 'Eligible organisations may undertake CSR implementation activities after completing the relevant requirements, including CSR-1 where applicable.' },
                { title: 'Institutional / Philanthropic Funding', desc: 'A clear MOA, compliant governance and audited financial records can improve institutional funding readiness.' }
              ].map((item, idx) => (
                <div key={idx} className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm"><div className="flex items-center gap-2"><Landmark className="w-5 h-5 text-[#0B3D91]"/><h4 className="font-bold text-sm text-slate-900">{item.title}</h4></div><p className="text-xs text-slate-600 leading-relaxed mt-1 pl-7">{item.desc}</p></div>
              ))}
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your founding members\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound society deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                  title: 'Direct Liaison & Registrar Follow-Ups',
                  desc: 'We manage all interactions with the state Registrar of Societies, GST authorities, and local licensing bodies, resolving queries proactively.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your founding members\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your Society with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian founding members who launched their society with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
            ...
            <div className="bg-gradient-to-r from-[#0B3D91] via-[#0D47A1] to-[#082a66] text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-4 max-w-md relative z-10">
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
                  Track Your Society Registration in Real-Time
                </h3>
