...
interface PharmexcilRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — Pharmaceutical Export Promotion Council (Pharmexcil) focused
const FAQ_ITEMS = [
  { q: 'What is Pharmaceutical Export Promotion Council registration?', a: 'Pharmaceuticals Export Promotion Council of India (Pharmexcil) membership / RCMC helps eligible India pharmaceutical exporters obtain sector-specific export promotion council recognition and access member services, trade information and export-support opportunities.' },
  { q: 'Who can apply for Pharmexcil membership / RCMC?', a: 'Eligible pharmaceutical businesses may apply under categories such as large-scale manufacturer, small-scale manufacturer or merchant exporter, subject to Pharmexcil rules and supporting documents.' },
  { q: 'What documents are generally required?', a: 'Typical documents can include IEC, PAN, applicable Drug Licence, business profile and category-specific manufacturing or registration documents. Exact requirements depend on applicant category and current Pharmexcil rules.' },
  { q: 'Is there one fixed consultancy price?', a: 'No. Our professional assistance fee is quoted after reviewing your exporter category, document readiness and scope of support. Government/council fees, if applicable, are separate and paid as prescribed.' },
  { q: 'Can you help with RCMC application and document review?', a: 'Yes. We can assist with eligibility review, document checklist, application preparation, online filing guidance, clarification support and follow-up coordination.' },
  { q: 'Does Pharmexcil membership guarantee export orders or incentives?', a: 'No. Membership / RCMC does not guarantee buyers, export orders, reimbursements or incentives. Eligibility for any scheme, event or benefit depends on the applicable rules and approval conditions.' }
]

// Related export-compliance services
const RELATED_SERVICES = [
  { title: 'IEC Registration', desc: 'Get Import Export Code support for starting import-export activities in India.', img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'ICEGATE Registration', desc: 'Registration support for customs e-filing and digital interaction with Indian Customs.', img: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'AD Code Registration', desc: 'Assistance for registering your Authorized Dealer bank code for export customs processing.', img: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Certificate of Origin Support', desc: 'Documentation guidance for eligible Certificate of Origin applications for export shipments.', img: 'https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'DGFT Compliance Support', desc: 'Practical support for exporter registrations, DGFT documentation and related compliance workflows.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration assistance for eligible pharmaceutical manufacturers and exporters.', img: 'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Trademark Registration', desc: 'Protect your pharma brand name and logo in India with trademark filing support.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'GST Registration', desc: 'GST registration and compliance support for eligible exporters and pharmaceutical businesses.', img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Export Documentation Support', desc: 'Get help organizing essential commercial and regulatory documents for smoother export operations.', img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80', price: 'View Service' }
]

export const PharmexcilRegistrationPage: React.FC<PharmexcilRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Pharmaceutical Exporter');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Pharmexcil Membership / RCMC Assistance');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Pharmaceutical Export Promotion Council</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span className="text-white">Pan-India Export Compliance Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start your Pharmexcil membership / RCMC with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Professional fee on consultation • Council/Govt. fees extra, if applicable
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Pharmaceuticals Export Promotion Council of India (Pharmexcil) is the sector export promotion council for Indian pharmaceutical exporters. Eligible manufacturers and merchant exporters can apply for membership / RCMC to access member services, trade information, market and regulatory resources, and export-promotion opportunities subject to applicable rules.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Timeline Depends on Review</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <BadgeCheck className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>RCMC Application Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Online Filing Guidance</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our export-compliance specialist has been assigned to your Pharmexcil membership / RCMC enquiry. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Pharmaceutical Export Promotion Council *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                We use your business location and exporter profile to guide the correct documentation and application workflow.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Eligibility review, document checklist, application preparation, online filing guidance and dedicated follow-up support—built to reduce avoidable delays.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Pharmexcil Membership / RCMC Assistance *
                              </label>
                              <select
                              ...
                              >
                                <option value="Pharmexcil Membership / RCMC Assistance">Pharmexcil Membership / RCMC Assistance — Contact for Pricing</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your Pharmexcil Assistance Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One conversion-focused assistance package for pharmaceutical exporters who want expert help with eligibility, documents, membership / RCMC application and follow-up.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    <span className="px-3 py-1 rounded bg-orange-100 text-orange-900 text-[10px] font-black uppercase tracking-wide">
                      EXPERT EXPORT COMPLIANCE SUPPORT
                    </span>
                    <span className="px-3 py-1 rounded bg-yellow-100 text-yellow-900 text-[10px] font-black uppercase tracking-wide">
                      CUSTOM QUOTE AFTER DOCUMENT REVIEW
                    </span>
                  </div>

                  <h3 className="text-2xl font-bold text-[#0D47A1]">Pharma Exporter Assistance</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Designed for pharmaceutical manufacturers and merchant exporters who want a guided, document-ready path to Pharmexcil membership / RCMC.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'IEC, PAN & Drug Licence Document Review',
                      'Membership / RCMC Application Preparation',
                      'Online Filing Guidance Support',
                      'Exporter Category & Eligibility Review',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Pharmexcil Membership / RCMC Assistance');
                ...
                >
                  Get a Custom Quote & Start Application
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is Pharmaceutical Export Promotion Council?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              Pharmexcil membership / RCMC is an export-sector recognition pathway for eligible pharmaceutical exporters. It is especially relevant for businesses seeking council membership, export promotion information, trade enquiries, market intelligence and participation in eligible export-support activities.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for Indian pharmaceutical manufacturers, merchant exporters, API businesses, formulation exporters, biotech and allied pharma companies preparing to strengthen their export-registration and council-membership readiness.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A complete application depends on the exporter category and document readiness. Manufacturer and merchant-exporter applicants should keep their IEC, PAN, applicable Drug Licence, business profile and category-specific supporting records ready.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Pharmexcil membership / RCMC does not replace your company, LLP, proprietorship or other business constitution. It works alongside your existing legal entity and export registrations.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  For eligible exporters, sector council membership can strengthen access to structured industry information, member communication, trade enquiries and export-promotion resources, subject to the council’s current rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Pharmaceutical exports are highly compliance-sensitive. Council membership should be supported by valid IEC, product/business licences, customs readiness and destination-market regulatory compliance where applicable.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, our role is to make the Pharmexcil membership / RCMC process easier to understand and execute—from eligibility and document review to application guidance and follow-up.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Pharmaceutical Export Promotion Council Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Pharmexcil membership / RCMC application is a sector-specific exporter registration process for eligible pharmaceutical businesses. The required category and supporting documents depend on whether the applicant is a manufacturer, merchant exporter or another eligible class.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After successful processing, the applicant receives the applicable Pharmexcil membership / RCMC recognition according to the council’s process. The certificate supports exporter recognition but does not replace IEC, Drug Licence, customs or destination-country approvals.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our export-compliance desk helps review IEC, PAN, Drug Licence, company profile and category-specific documents, then supports application preparation, online filing guidance and follow-up.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Pharmaceutical Exporters Consider Pharmexcil Membership
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Sector-Specific Exporter Recognition',
                  desc: 'Membership / RCMC helps eligible pharmaceutical exporters establish sector-specific recognition with the export promotion council and access member-focused resources.'
                },
                {
                  title: 'Export Market & Industry Information',
                  desc: 'Members can access relevant circulars, market and regulatory information, trade enquiries and export-performance resources made available by Pharmexcil.'
                },
                {
                  title: 'Guided Digital Application',
                  desc: 'Our team helps organize the application digitally and flags common document gaps before submission. Processing time remains subject to council review.'
                },
                {
                  title: 'Stronger Export Readiness',
                  desc: 'A well-prepared exporter profile, valid registrations and sector membership can improve professional readiness when approaching trade opportunities and export programs.'
                },
                {
                  title: 'Application Follow-up Support',
                  desc: 'Get support responding to application queries, correcting documentation issues and understanding the next compliance step without navigating the process alone.'
                },
                {
                  title: 'Export Promotion Opportunities',
                  desc: 'Eligible members may be able to participate in export-promotion initiatives, events or reimbursement opportunities subject to current scheme rules and approvals.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for Pharmexcil Membership / RCMC
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Confirm Exporter Legal Name & IEC Details',
                  desc: 'Ensure your legal business name, PAN and IEC records are consistent before beginning the application.'
                },
                {
                  title: 'Identify Pharma Export Activity',
                  desc: 'Clearly identify whether you manufacture, trade or export pharmaceutical products and keep relevant licences available.'
                },
                {
                  title: 'Select Correct Membership Category',
                  desc: 'Agree in advance on each authorized applicant\'s capital contribution and profit/loss sharing ratio to avoid disputes after registration.'
                },
                {
                  title: 'Keep Business KYC Ready',
                  desc: 'Ensure each authorized applicant\'s PAN Card and Aadhaar Card details match identically and are linked to an active mobile number for OTP verification.'
                },
                {
                  title: 'Prepare Business Profile & Contact Details',
                  desc: 'Prepare an updated company profile, business address and contact information for the membership application.'
                },
                {
                  title: 'Keep Applicable Drug Licence Ready',
                  desc: 'Manufacturer and merchant-exporter applicants should keep the applicable Drug Licence and category-specific regulatory documents ready.'
                },
                {
                  title: 'Check Supporting Export Registrations',
                  desc: 'Verify IEC and other applicable export, customs, GST and product-specific registrations before submission.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Pharmaceutical Export Promotion Council
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Eligibility for Pharmexcil membership / RCMC depends on the applicant’s pharmaceutical business activity, exporter status, selected membership category and current council requirements. We review your business profile before recommending the application route.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Eligible Pharmaceutical Exporter Entity',
                  desc: "Eligibility depends on the applicant's pharmaceutical business activity, exporter status, membership category and current Pharmexcil requirements."
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'The applicant entity and authorized signatory should have valid business KYC and the supporting registrations required for the selected exporter category.'
                },
                {
                  title: 'Consistent Legal Name & IEC Details',
                  desc: 'Your legal business name, PAN, IEC and supporting records should be consistent across the application documents.'
                },
                {
                  title: 'Written pharmaceutical exporter Deed',
                  desc: 'Application details should accurately reflect the legal entity, exporter category, products, IEC and applicable pharmaceutical licences.'
                },
                {
                  title: 'Valid Indian Business & Export Details',
                  desc: 'Keep your registered business address, contact details and export-registration information current and supportable.'
                },
                {
                  title: 'Applicable Pharmaceutical Licences',
                  desc: 'Applicants should hold the applicable pharmaceutical licences and other regulatory permissions relevant to their products and business activity.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates each authorized applicant\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Pharmaceutical Export Promotion Council
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your Pharmexcil membership / RCMC smoothly, identity and address proofs of authorized persons / business representatives, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Exporters / Applicants\' Identity Proof (PAN Cards)',
                  desc: 'Scanned copies of each authorized applicant\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Exporters / Applicants\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Accepted identity and address proof such as Aadhaar, Voter ID, Passport, or other applicable documents for authorized persons / business representatives.'
                },
                {
                ...
                {
                  title: 'Applicable Business & Pharma Licence Documents',
                  desc: 'The applicable governing document signed/executed by the required authorized persons / business representatives, covering pharmaceutical export activities and governance rules.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our team reviews and organizes the application set, including IEC, PAN, Drug Licence, company profile and other category-specific supporting documents.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Pharmaceutical Export Promotion Council Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Keep Applicable Drug Licence Ready',
                  desc: 'We first confirm your exporter category and create a tailored document checklist for Pharmexcil membership / RCMC.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Exporters / Applicants',
                  desc: 'Upload PAN, identity/address proof, registered-office proof, NOC where required, and photographs of the required authorized persons / business representatives.'
                },
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique pharmaceutical exporter Name',
                  desc: 'Our team helps check the proposed business name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                ...
                {
                  step: 'Step 5',
                  title: 'Membership / RCMC Application Preparation & GST Registration',
                  desc: 'We apply for the pharmaceutical exporter\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the Pharmexcil membership / RCMC certificate/incorporation documents and governing-document copies, followed by guidance for opening the business bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Status & Purpose of Pharmexcil Membership / RCMC
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Pharmexcil membership / RCMC is a sector-specific exporter recognition and does not create a new legal entity. Your company, LLP, proprietorship or other business constitution continues to govern your legal status.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the exporter category and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a authorized applicant\'s exit, unless the deed states otherwise.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Business liabilities and statutory responsibilities continue to depend on your existing entity structure and applicable pharmaceutical, tax, customs and export laws.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate exporter category, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, pharmaceutical exporters must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the pharmaceutical exporter\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                ...
                {
                  title: 'Annual pharmaceutical exporter Compliance & Tax Filing',
                  desc: 'File the pharmaceutical exporter\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                  title: 'Report Changes to the relevant registering authority',
                  desc: 'Keep your membership, IEC, business address, authorized signatory and licence details updated whenever material changes occur.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the pharmaceutical exporter employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Pharmexcil Membership vs Other Export Registrations
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Applicable Pharmexcil / DGFT framework
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Exporters / Applicants
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Exporters / Applicants</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on exporter category and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Exporters / Applicants
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-slate-900 border-r border-slate-200">
                      Pharma Manufacturers & Merchant Exporters
                    </td>
                    <td className="p-3.5 border-r border-slate-200">General Businesses / Domestic Sellers</td>
                    <td className="p-3.5 border-r border-slate-200">Exporters Needing Sector Recognition</td>
                    <td className="p-3.5">Export-Oriented Companies</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Pharma Export Compliance & Tax Considerations
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Pharmexcil membership does not itself determine income-tax or GST treatment. Exporters should separately comply with GST, customs, DGFT, product regulations and applicable tax rules.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'GST & Tax Position Is Separate',
                  desc: 'Tax treatment depends on your actual business constitution, transactions and applicable GST / income-tax provisions, not merely on council membership.'
                },
                {
                  title: 'Export GST / LUT Readiness',
                  desc: 'Exporters should maintain transaction records and comply with applicable GST, LUT/refund, customs and income-tax requirements based on their operations.'
                },
                {
                  title: 'Maintain Proper Export Records',
                  desc: 'Remuneration and interest paid to working exporter / authorized applicant are taxable in the authorized applicant\'s hands but deductible for the pharmaceutical exporter, subject to prescribed limits.'
                },
                {
                  title: 'Customs & DGFT Compliance',
                  desc: 'Pharmaceutical exporters should separately evaluate GST, LUT/bond, refund, customs and DGFT requirements based on the nature of their exports.'
                },
                {
                  title: 'Product & Destination Compliance',
                  desc: 'Pharma exports can involve product-specific and destination-market requirements. Pharmexcil membership does not replace those regulatory approvals.'
                },
                {
                  title: 'Integrated Export Compliance Support',
                  desc: 'We can help you map Pharmexcil membership / RCMC with related exporter registrations such as IEC, ICEGATE, AD Code and supporting documentation.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Export Growth Readiness
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Related Export Growth & Compliance Opportunities
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Pharmexcil membership can form part of a broader export-readiness journey. Depending on your business, you may also need customs, banking, documentation and market-development support.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Market Access & Trade Information',
                  desc: 'Use sector-focused market, regulatory and trade information to identify export opportunities and prepare for buyer discussions.'
                },
                {
                  title: 'Export Banking & AD Code Readiness',
                  desc: 'Keep your export banking setup, AD Code and remittance processes aligned with your customs and shipment workflow.'
                },
                {
                  title: 'ICEGATE & Customs Setup',
                  desc: 'Complete the customs-side registrations and digital access needed for smoother export documentation and shipment processing.'
                },
                {
                  title: 'Certificate of Origin & Shipment Documents',
                  desc: 'Prepare origin, commercial and shipping documentation according to buyer, destination-country and applicable trade requirements.'
                },
                {
                  title: 'Export Promotion Events & Trade Enquiries',
                  desc: 'Explore eligible Pharmexcil trade enquiries, industry events, buyer-seller opportunities and market-development activities.'
                },
                {
                  title: 'Scheme / Reimbursement Eligibility',
                  desc: 'Where available, check eligibility for export-promotion schemes or reimbursements. Approval always depends on the current scheme conditions.'
                },
                {
                  title: 'End-to-End Export Documentation Support',
                  desc: 'Our team can coordinate related IEC, ICEGATE, AD Code, Certificate of Origin and exporter-documentation support based on your business needs.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-slate-200">
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your exporter / authorized applicant\' needs.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Transparent scope-based consultancy pricing, a clear document checklist, and separate disclosure of applicable council/government fees.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your exporter / authorized applicant\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Take Your Pharmaceutical Export Compliance Forward
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Move from document confusion to an application-ready Pharmexcil membership / RCMC file with expert guidance. Get a clear scope, practical checklist and dedicated support for your export-compliance journey.
            </p>
