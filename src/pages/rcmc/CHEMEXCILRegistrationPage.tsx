...
interface CHEMEXCILRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — CHEMEXCIL / DGFT e-RCMC focused
const FAQ_ITEMS = [
  { q: 'What is CHEMEXCIL Registration?', a: 'CHEMEXCIL Registration is membership with the Basic Chemicals, Cosmetics & Dyes Export Promotion Council. Eligible exporters can obtain a Registration-cum-Membership Certificate (RCMC) through the DGFT e-RCMC system for covered chemical and allied product categories.' },
  { q: 'Who can apply for CHEMEXCIL membership?', a: 'A legal entity engaged in, or intending to engage in, export of products covered by CHEMEXCIL may apply. Registration may be available as Merchant Exporter, Manufacturer Exporter, or Merchant-cum-Manufacturer Exporter subject to documents and eligibility.' },
  { q: 'Is IEC required for CHEMEXCIL Registration?', a: 'Yes. A valid Importer Exporter Code (IEC) is a key document for the RCMC application. Manufacturer exporters may also need manufacturing-related proof such as applicable MSME/Udyam, industrial or other authority documentation.' },
  { q: 'How long can CHEMEXCIL registration take?', a: 'CHEMEXCIL states that after receipt of the application with supporting documents, membership and RCMC may be issued within a maximum of about 5 days. Actual timing can vary if clarification, correction, payment, or verification is required.' },
  { q: 'Is CHEMEXCIL membership renewed every year?', a: 'Yes. CHEMEXCIL membership subscription is annual. Renewal requirements and fees can depend on the applicable financial year, export turnover, membership category, and current council rules.' },
  { q: 'Why should a chemical exporter obtain CHEMEXCIL RCMC?', a: 'RCMC helps establish exporter membership with the relevant Export Promotion Council and can support access to export-promotion information, council programmes, trade events, industry representation and eligible Foreign Trade Policy benefits, subject to applicable rules.' }
]

// Related export-compliance services for CHEMEXCIL applicants
const RELATED_SERVICES = [
  {
    title: 'IEC Registration',
    desc: 'Get your Import Export Code for starting import-export activities in India and preparing for RCMC applications.',
  ...
  },
  {
    ...
    desc: 'Get assistance with ICEGATE registration for customs e-filing, shipping bills and digital export workflows.',
    img: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'LUT Registration',
    desc: 'File LUT under GST for eligible zero-rated exports without payment of IGST, subject to applicable rules.',
    img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'RCMC Registration',
    desc: 'Professional support for identifying the correct Export Promotion Council and completing your DGFT e-RCMC application.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Certificate of Origin',
    desc: 'Documentation assistance for eligible Certificate of Origin applications used in international trade.',
    img: 'https://images.unsplash.com/photo-1519003722824-194d4455a60c?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration assistance for exporters and businesses that need tax registration and compliance support.',
    img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'MSME Udyam Registration',
    desc: 'Obtain Udyam registration support for eligible manufacturing or service enterprises in India.',
    img: 'https://images.unsplash.com/photo-1565514020179-026b92b84bb6?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your export brand, product name or logo in India through trademark filing support.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  }
]

export const CHEMEXCILRegistrationPage: React.FC<CHEMEXCILRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Merchant Exporter');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('CHEMEXCIL Registration Assistance — Custom Quote');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">CHEMEXCIL Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span className="text-white">Pan-India Export Registration Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start your CHEMEXCIL registration with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Get a custom quote based on your exporter profile
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  CHEMEXCIL Registration supports eligible Indian exporters of basic chemicals, dyes and dye intermediates, agrochemicals, cosmetics, soaps, toiletries, essential oils, speciality chemicals, lubricants and castor-oil products with council membership and Registration-cum-Membership Certificate (RCMC) formalities through the DGFT e-RCMC framework.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>CHEMEXCIL + DGFT e-RCMC</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>DGFT e-RCMC Assistance</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>CHEMEXCIL / DGFT Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                ...
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  {formSubmitted ? (
                    ...
                    <>
                      ...
                      {/* Default Price Digital customs interactionlight Box */}
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your exporter category, IEC details, product panel and business constitution help determine the documents required for CHEMEXCIL membership and DGFT e-RCMC.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                End-to-end document review, exporter-category guidance, CHEMEXCIL membership assistance and DGFT e-RCMC filing support with clear follow-up.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>
                                <label className="block text-xs font-bold text-slate-700 mb-1">
                                  Export Product / Business Activity *
                                </label>
                                <select
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select CHEMEXCIL Assistance Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="CHEMEXCIL Registration Assistance — Custom Quote">CHEMEXCIL Registration Assistance — Contact for Price</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                CHEMEXCIL Registration Assistance
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused assistance package designed to reduce paperwork and help chemical exporters move confidently from document review to CHEMEXCIL membership and DGFT e-RCMC submission.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">CHEMEXCIL Exporter Assistance</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Built for Indian chemical and allied-product exporters who want a guided, accurate and conversion-focused route to CHEMEXCIL membership and e-RCMC.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Exporter Eligibility & CHEMEXCIL Panel Check',
                      'IEC / PAN / Entity Document Review',
                      'CHEMEXCIL + DGFT e-RCMC Category Guidance',
                      'CHEMEXCIL Membership Application Assistance',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('CHEMEXCIL Registration Assistance — Custom Quote');
                ...
                >
                  Get Started with CHEMEXCIL Exporter Assistance
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is CHEMEXCIL Registration?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              CHEMEXCIL is the Basic Chemicals, Cosmetics & Dyes Export Promotion Council set up by the Ministry of Commerce & Industry, Government of India. Membership is relevant for exporters of covered chemical and allied-product categories, while RCMC is issued under the Foreign Trade Policy framework through the DGFT platform.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for merchant exporters, manufacturer exporters and merchant-cum-manufacturer exporters dealing in CHEMEXCIL-covered products such as dyes, chemicals, agrochemicals, cosmetics, essential oils, speciality chemicals, lubricants and castor-oil products.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A correct exporter category, IEC details, product classification and supporting business documents help reduce queries and improve application readiness.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  CHEMEXCIL membership and RCMC are separate but connected. Council membership is required for obtaining CHEMEXCIL RCMC, while the e-RCMC is issued under the DGFT framework subject to eligibility and documents.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  For exporters seeking CHEMEXCIL RCMC, council membership is a prerequisite. Exporters with nil export performance may also be eligible to enroll, subject to current requirements.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Membership can connect exporters with export-promotion initiatives, industry information, exhibitions, delegations and policy representation, subject to council programmes and eligibility.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, CHEMEXCIL registration helps eligible chemical exporters align their council membership and RCMC documentation. Our team supports document readiness, category selection, application filing and follow-up.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How CHEMEXCIL Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              CHEMEXCIL registration begins with identifying the correct exporter category and CHEMEXCIL product panel, reviewing IEC and entity documents, and completing the required membership / e-RCMC process through the applicable online system.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After successful processing, the exporter receives the applicable membership confirmation and RCMC. CHEMEXCIL states that complete applications with supporting documents may be processed within about five days, although actual timelines can vary.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our export-compliance desk reviews IEC, PAN, entity constitution, exporter category, manufacturing proof where relevant and product details before assisting with CHEMEXCIL / DGFT e-RCMC filing and follow-up.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Benefits of CHEMEXCIL Membership & RCMC
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Correct EPC Recognition',
                  desc: 'For eligible chemical and allied-product exporters, CHEMEXCIL membership connects the business with the sector-specific Export Promotion Council.'
                },
                {
                  title: 'DGFT e-RCMC Support',
                  desc: 'A valid RCMC helps establish registration with the relevant council under the Foreign Trade Policy framework, subject to DGFT rules.'
                },
                {
                  title: 'Exporter Category Clarity',
                  desc: 'Application can be aligned as Merchant Exporter, Manufacturer Exporter or Merchant-cum-Manufacturer Exporter based on your business model and documents.'
                },
                {
                  title: 'Export Promotion Opportunities',
                  desc: 'Members may access council initiatives such as trade exhibitions, delegations, market information and export-promotion activities, subject to programme terms.'
                },
                {
                  title: 'Industry & Policy Interface',
                  desc: 'CHEMEXCIL acts as an interface between the chemical export industry and Government of India on export-oriented matters and sector development.'
                },
                {
                  title: 'Guided Documentation',
                  desc: 'Professional pre-checks of IEC, PAN, constitution documents, product details and manufacturing proof can reduce avoidable application errors and follow-up.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before CHEMEXCIL Registration
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Valid IEC & PAN Details',
                  desc: 'Keep your IEC and PAN details active, accurate and consistent with the legal name and constitution of the exporting entity.'
                },
                {
                  title: 'Choose the Correct Exporter Category',
                  desc: 'Identify whether you are applying as a Merchant Exporter, Manufacturer Exporter or Merchant-cum-Manufacturer Exporter.'
                },
                {
                  title: 'Confirm CHEMEXCIL Product Coverage',
                  desc: 'Map your export products to the appropriate CHEMEXCIL panel and keep product descriptions / HS-code information ready.'
                },
                {
                  title: 'Business Constitution Documents',
                  desc: 'Keep partnership deed, certificate of incorporation, MOA/AOA, authorization or other entity documents ready as applicable.'
                },
                {
                  title: 'Manufacturer Proof Where Applicable',
                  desc: 'Manufacturer exporters should keep relevant manufacturing proof such as Udyam / industrial or other prescribed authority documents ready.'
                },
                {
                  title: 'Authorized Signatory Details',
                  desc: 'Ensure the authorized person and signing authority documents are properly recorded and available for the application.'
                },
                {
                  title: 'Membership Fee & Turnover Information',
                  desc: 'CHEMEXCIL membership fees can depend on membership category, financial year and export turnover; keep relevant turnover evidence ready where required.'
                },
                {
                  title: 'Pre-Filing Expert Review',
                  desc: 'Our team checks your profile and documents before submission to reduce preventable mismatch, category and documentation issues.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility for CHEMEXCIL Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              CHEMEXCIL registration is intended for eligible legal entities exporting, or intending to export, products covered by the Council. A valid IEC, correct exporter category, appropriate entity documents and product / manufacturing evidence where applicable are important for application readiness.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Eligible Export Business',
                  desc: 'The applicant should be a legal entity engaged in, or intending to engage in, export of products falling under CHEMEXCIL coverage.'
                },
                {
                  title: 'Valid Importer Exporter Code',
                  desc: 'A valid IEC issued under the DGFT framework is a core requirement for the RCMC application.'
                },
                {
                  title: 'Correct Product Category',
                  desc: 'The export product should fall within CHEMEXCIL-covered chemical, cosmetics, dyes or allied product panels.'
                },
                {
                  title: 'Exporter Type Documentation',
                  desc: 'Documents should support the selected category: Merchant Exporter, Manufacturer Exporter or Merchant-cum-Manufacturer Exporter.'
                },
                {
                  title: 'Manufacturer Evidence',
                  desc: 'Manufacturer exporters may need prescribed manufacturing / industrial registration evidence in addition to standard entity documents.'
                },
                {
                  title: 'Entity & Authorization Proof',
                  desc: 'Partnership, company or other legal-entity applicants must provide applicable constitution and authorized-signatory documentation.'
                },
                {
                  title: 'Application Readiness Check',
                  desc: 'akshayb2bsolutions reviews eligibility, documents and category mapping before filing to improve submission quality.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents for CHEMEXCIL Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process CHEMEXCIL membership and e-RCMC smoothly, keep IEC, PAN, entity constitution documents, authorized-signatory proof, export-product details and manufacturer evidence where applicable ready. Additional turnover or status documents may be required depending on the application or renewal category.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Self-attested IEC details / copy as applicable for the CHEMEXCIL and DGFT e-RCMC process.'
                },
                {
                  title: 'PAN & Entity KYC',
                  desc: 'PAN and basic KYC details of the applicant entity, with consistent legal name and business information.'
                },
                {
                  title: 'Constitution Proof',
                  desc: 'Partnership deed, certificate of incorporation, MOA/AOA or other constitution documents depending on the type of entity.'
                },
                {
                  title: 'Authorized Signatory / Board Authorization',
                  desc: 'Board resolution, authority letter or Power of Attorney where the application is signed by an authorized representative.'
                },
                {
                  title: 'Manufacturer Exporter Proof',
                  desc: 'Applicable Udyam / industrial / manufacturing evidence and product details where registration is sought as Manufacturer Exporter.'
                },
                {
                  title: 'Export Turnover / Status Documents',
                  desc: 'CA-certified export turnover or Status Holder / Export House documents may be required depending on current membership or renewal requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step CHEMEXCIL Registration Process
              </h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  step: 'Step 1',
                  title: 'Profile & Product Eligibility Check',
                  desc: 'We identify your exporter type and confirm whether your products fit the appropriate CHEMEXCIL panel.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect IEC & Business Documents',
                  desc: 'Share IEC, PAN, constitution documents, authorized-signatory details and manufacturing proof where applicable.'
                },
                {
                  step: 'Step 3',
                  title: 'Choose Exporter Category',
                  desc: 'Your application is prepared under Merchant Exporter, Manufacturer Exporter or Merchant-cum-Manufacturer Exporter as supported by your documents.'
                },
                {
                  step: 'Step 4',
                  title: 'Prepare CHEMEXCIL Membership Application',
                  desc: 'We organize the required particulars, product information and supporting documents for membership / RCMC processing.'
                },
                {
                  step: 'Step 5',
                  title: 'Submit Through DGFT e-RCMC Workflow',
                  desc: 'Application assistance is provided for the current DGFT common e-RCMC process and applicable council membership requirements.'
                },
                {
                  step: 'Step 6',
                  title: 'Follow-up & Certificate Support',
                  desc: 'We assist with clarification or correction requirements and guide you through completion of membership and RCMC formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                CHEMEXCIL Membership & RCMC Status
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  CHEMEXCIL membership confirms association with the sector-specific Export Promotion Council, while RCMC is a separate Registration-cum-Membership Certificate issued under the DGFT / Foreign Trade Policy framework.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Membership subscription is generally renewed annually, and exporters should keep their DGFT, IEC, turnover, contact, director/partner and manufacturer records updated as required.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  RCMC does not replace IEC, GST, customs registrations, product-specific licences or other export compliances. It forms one part of the exporter compliance ecosystem.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The exporter remains responsible for accurate declarations, valid documents, renewals and compliance with DGFT, customs, GST and product-specific regulations.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our export-compliance advisors help you understand the right exporter category, document set, membership requirements, e-RCMC workflow and connected export registrations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, exporters should keep CHEMEXCIL membership and e-RCMC records updated, renew applicable membership subscriptions, maintain IEC and business records, and comply with DGFT, GST, customs and product-specific requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Annual CHEMEXCIL Membership Renewal',
                  desc: 'Renew the applicable council membership subscription within the prescribed period to keep membership benefits and records active.'
                },
                {
                  title: 'Maintain / Renew e-RCMC as Applicable',
                  desc: 'Keep the DGFT e-RCMC valid and complete renewal or amendment formalities when required under current policy.'
                },
                {
                  title: 'Update Export Turnover Records',
                  desc: 'Maintain CA-certified export turnover and other evidence required for membership category, fee calculation or renewal.'
                },
                {
                  title: 'Update Directors / Partners & Contact Details',
                  desc: 'Keep company representatives, directors / partners, mobile numbers, e-mail and authorization records updated with the relevant systems.'
                },
                {
                  title: 'Maintain IEC, GST & Customs Compliance',
                  desc: 'Ensure IEC, GST, ICEGATE, AD Code and other applicable export registrations remain accurate and compliant.'
                },
                {
                  title: 'Keep Manufacturer Documents Updated',
                  desc: 'Manufacturer exporters should maintain current Udyam / industrial / manufacturing evidence and product details where applicable.'
                },
                {
                  title: 'Ongoing Export Compliance Support',
                  desc: 'Our team can assist with connected export registrations, amendments, renewals and documentation follow-up as your business grows.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                CHEMEXCIL RCMC vs Other Export Registrations
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Sector EPC membership + RCMC for covered chemical exports
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-rose-700 border-r border-slate-200">
                      Eligible CHEMEXCIL-covered exporters
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Membership + Registration-cum-Membership Certificate
                    </td>
                    <td className="p-3.5 border-r border-slate-200">IEC Number</td>
                    <td className="p-3.5 border-r border-slate-200">ICEGATE User Registration / Access</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      IEC, PAN, entity documents, product / exporter details
                    </td>
                    <td className="p-3.5 border-r border-slate-200">PAN and business / entity details</td>
                    <td className="p-3.5 border-r border-slate-200">IEC / GST / customs-linked KYC as applicable</td>
                    <td className="p-3.5">GSTIN and authorized-signatory details</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">6. Renewal / Validity</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Membership subscription / RCMC renewal as applicable
                    </td>
                    <td className="p-3.5 border-r border-slate-200">IEC requires periodic confirmation / update under DGFT rules</td>
                    <td className="p-3.5 border-r border-slate-200">Maintain account / credentials and applicable customs compliance</td>
                    <td className="p-3.5">Generally financial-year specific LUT filing</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">7. Best Use Case</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Chemical-sector export promotion and EPC recognition
                    </td>
                    ...
                    <td className="p-3.5 text-orange-800 font-semibold">Digital customs interactionest (Global Standards)</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-slate-900 border-r border-slate-200">
                      Dyes, chemicals, cosmetics and allied exporters under CHEMEXCIL panels
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Any eligible importer / exporter needing IEC</td>
                    <td className="p-3.5 border-r border-slate-200">Exporters / importers handling customs filings</td>
                    <td className="p-3.5">Digital customs interaction-Growth Startups &amp; Tech</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              CHEMEXCIL registration does not by itself determine tax treatment. Exporters should separately maintain GST, income-tax, customs and zero-rated export compliance based on their business model and transactions.
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'CHEMEXCIL membership and RCMC do not replace GST, customs or income-tax compliance. Applicable fees and business expenses should be recorded appropriately in the exporter\'s books.'
                },
                {
                  title: 'GST / LUT / IGST Route',
                  desc: 'Exporters should follow the applicable GST route for zero-rated supplies and maintain LUT, invoice, shipping and refund documentation where relevant.'
                },
                {
                  title: 'Books & Statutory Records',
                  desc: 'Exporters should maintain proper books, IEC / RCMC records, invoices, shipping documentation and statutory filings required for their entity and export activity.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team can coordinate GST, LUT, IEC, AD Code, ICEGATE and other connected export-compliance support alongside CHEMEXCIL registration.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Exporters may also explore government-backed export-promotion and credit-support schemes where their business meets the applicable conditions.'
                },
                {
                  title: 'Packing Credit / Pre-Shipment Finance',
                  desc: 'Eligible exporters may explore packing credit or other pre-shipment working-capital facilities based on bank assessment and export orders.'
                },
                {
                ...
                {
                  title: 'Trade Credit & Banking Support',
                ...
                },
                {
                  ...
                  desc: 'Equity or external investment depends on the legal constitution of the exporting business and is separate from CHEMEXCIL membership or RCMC.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyse your export business, product category and documents to identify the appropriate CHEMEXCIL panel and exporter classification.'
                },
                {
                  title: 'Application Data & Document Verification',
                  desc: 'Our compliance specialists organise application data, authorization documents and supporting records to reduce avoidable filing queries.'
                },
                {
                  title: 'Application Follow-up & Query Support',
                  desc: 'We assist with application-stage clarifications, document corrections and follow-up required for the CHEMEXCIL / DGFT e-RCMC workflow.'
                },
                {
                  title: 'Connected Export Compliance Guidance',
                  desc: 'Get guidance on connected registrations such as IEC, GST, LUT, ICEGATE and AD Code where they are relevant to your export operations.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your exporter KYC, IEC details, financial records and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Start Your CHEMEXCIL Registration with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Get expert-guided CHEMEXCIL registration support for your chemical export business. Share your exporter profile, receive a tailored document checklist and custom quote, and move ahead with focused filing assistance.
            </p>
