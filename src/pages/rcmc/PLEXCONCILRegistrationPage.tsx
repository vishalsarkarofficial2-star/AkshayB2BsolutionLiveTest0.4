...
interface PLEXCONCILRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian PLEXCONCIL Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is Plastic Export Promotion Council Registration?', a: 'Plastic Export Promotion Council Registration generally refers to membership / Registration-Cum-Membership Certificate (RCMC) with The Plastics Export Promotion Council (PLEXCONCIL) for eligible exporters of plastic products from India.' },
  { q: 'Who should apply for PLEXCONCIL RCMC?', a: 'Eligible manufacturer exporters and merchant exporters dealing in plastic products can apply, subject to the applicable product coverage, DGFT requirements and PLEXCONCIL membership rules.' },
  { q: 'Why is PLEXCONCIL membership useful for plastic exporters?', a: 'PLEXCONCIL members can access sector-specific export promotion support such as trade leads, international fairs and exhibitions, networking opportunities, member directory visibility, export-finance assistance, policy representation and other member services.' },
  { q: 'How is PLEXCONCIL RCMC applied for?', a: 'New, renewal and amendment requests for RCMC are handled through the DGFT e-RCMC system. An active IEC, updated IEC profile and valid DSC or Aadhaar e-Sign are generally required for submission.' },
  { q: 'What documents are commonly required?', a: 'Requirements vary by exporter category, but typically include IEC-linked exporter details, PAN and entity information, business/export details, authorized-signatory information and supporting documents requested through the DGFT / PLEXCONCIL process.' },
  { q: 'Is the PLEXCONCIL registration fee fixed?', a: 'No. Membership and subscription charges can vary by exporter category, manufacturer/merchant status and the applicable membership schedule. We provide a custom quote after reviewing your exporter profile.' }
]

// Related services cross-linking items — sourced from PLEXCONCIL-adjacent structures
const RELATED_SERVICES = [
  {
    title: 'IEC Registration',
    desc: 'Importer Exporter Code registration support for plastic manufacturers and merchant exporters entering global trade.',
  ...
  },
  {
    ...
    desc: 'Registration-Cum-Membership Certificate support through the appropriate Export Promotion Council or registering authority.',
    img: 'https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'AD Code Registration',
    desc: 'AD Code and port-related customs registration support for exporters shipping plastic products from India.',
    img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration and compliance support for plastic manufacturers, traders and export businesses.',
    img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'EPR Registration',
    desc: 'Extended Producer Responsibility compliance support for eligible plastic packaging producers, importers and brand owners.',
    img: 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your plastic product brand, packaging identity and logo before scaling into international markets.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'MSME Udyam Registration',
    desc: 'Udyam registration support for eligible plastic manufacturers, processors and export-focused MSMEs.',
  ...
  },
  {
    ...
    desc: 'Practical support for export documentation, shipping readiness and compliance coordination for plastic exporters.',
    img: 'https://images.unsplash.com/photo-1494412685616-a5d310fbb07d?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  },
  {
    title: 'Plastic Export Compliance Consultation',
    desc: 'Combined roadmap for IEC, PLEXCONCIL RCMC, GST, AD Code, EPR and other export-readiness requirements.',
    img: 'https://images.unsplash.com/photo-1531058020387-3be344556be6?w=600&auto=format&fit=crop&q=80',
    price: 'Contact Contact for Price'
  }
]

export const PLEXCONCILRegistrationPage: React.FC<PLEXCONCILRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('PLEXCONCIL Registration Support — Custom Quote');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Plastic Export Promotion Council Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Plastic Export Promotion Council Registration in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an PLEXCONCIL may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Plastic Exporter Focused</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>DGFT / PLEXCONCIL Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based PLEXCONCIL / RCMC specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The applicable registration authority and documentation depend on whether your PLEXCONCIL is formed as a Society, Trust, or Section 8 Company.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete PLEXCONCIL name-check, MOA / Trust Deed / Society Rules drafting, government filing support, and registration guidance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select PLEXCONCIL Registration Support *
                              </label>
                              <select
                              ...
                              >
                                <option value="PLEXCONCIL Registration Support — Custom Quote">Plastic Export Promotion Council Registration Package — Contact for Price + PLEXCONCIL / Statutory Chargess</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get PLEXCONCIL Quote</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Plastic Export Growth Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your PLEXCONCIL Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional PLEXCONCIL registration guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    <span className="px-3 py-1 rounded bg-orange-100 text-orange-900 text-[10px] font-black uppercase tracking-wide">
                      PLASTIC EXPORTER GROWTH PACKAGE
                    </span>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">PLEXCONCIL Export Growth Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    For eligible plastic manufacturers and merchant exporters who want PLEXCONCIL / RCMC support plus a practical checklist for the next export-compliance steps.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'PLEXCONCIL / RCMC Eligibility Review',
                      'IEC & DGFT Profile Readiness Check',
                      'DGFT / PLEXCONCIL Filing Support',
                      'Basic PLEXCONCIL Name Availability Check',
                      'Required Document Checklist & Verification',
                      'Dedicated PLEXCONCIL Registration Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('PLEXCONCIL Registration Support — Custom Quote');
                ...
                >
                  Get Started with PLEXCONCIL Export Growth Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Plastic Export Overview
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is a PLEXCONCIL in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              PLEXCONCIL registration gives a non-governmental organization a recognized legal identity to operate for lawful charitable or social-welfare objectives. The organization may be structured as a Society, Trust, or Section 8 Company, with its governing documents defining its purpose, members or trustees, management, and rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Plastic raw material exporters, processors, packaging manufacturers, finished plastic product exporters and merchant exporters looking to grow international sales.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Access Export Opportunities:</strong>
                  Properly drafted MOA, Trust Deed, or Society Rules clearly define the PLEXCONCIL's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The legal identity and liability framework depends on whether the PLEXCONCIL is formed as a Society, Trust, or Section 8 Company; the governing documents and applicable law determine the responsibilities of members, trustees, directors, and office bearers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Sector-Specific Export Support:</strong>
                  Registration under the Indian PLEXCONCIL Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow members / trustees in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An PLEXCONCIL is not formed for distributing profits to members. Eligible organizations can pursue donations, grants, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, PLEXCONCIL registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Plastic Export Promotion Council Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              PLEXCONCIL registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the PLEXCONCIL registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our export-compliance desk reviews your IEC/DGFT profile, exporter category and plastic product line, prepares the e-RCMC application and supports submission and clarification handling.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of a PLEXCONCIL
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Trade Leads & Enquiries',
                  desc: 'PLEXCONCIL disseminates trade enquiries and trade leads that can help members identify potential overseas opportunities.'
                },
                {
                  title: 'International Fairs & Exhibitions',
                  desc: 'Members can access discounted participation and promotional opportunities at selected international trade fairs and exhibitions.'
                },
                {
                  title: 'Export Finance Assistance',
                  desc: 'PLEXCONCIL provides support and guidance relating to export financing through institutions and banks.'
                },
                {
                  title: 'Networking & Member Visibility',
                  desc: 'Members can benefit from plastics-industry networking and listing in the PLEXCONCIL member directory.'
                },
                {
                  title: 'Policy & Government Representation',
                  desc: 'PLEXCONCIL represents member trade issues before relevant Government authorities and supports the sector on policy matters.'
                },
                {
                  title: 'Export Certificates & Member Services',
                  desc: 'Member services include Certificate of Origin, Export Turnover Certificate and access to sector publications and resources.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Registering Your PLEXCONCIL
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique PLEXCONCIL Name Selection',
                ...
                {
                  title: 'Clearly Defined PLEXCONCIL Objectives and Governance',
                ...
                },
                {
                  ...
                  desc: 'Clearly state the PLEXCONCIL objectives, governance, membership or trusteeship, powers, duties, meetings, accounts, and dissolution provisions in the governing document.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                PLEXCONCIL Registration Eligibility
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a PLEXCONCIL in India, there must be a minimum of two members / trustees and a maximum of twenty. All members / trustees must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Plastic manufacturers exporting eligible products can apply subject to PLEXCONCIL and DGFT requirements.'
                },
                {
                  title: 'Merchant Exporters',
                  desc: 'Eligible merchant exporters dealing in covered plastic products can also apply for membership / RCMC.'
                },
                {
                  title: 'Valid IEC & DGFT Profile',
                  desc: 'An active IEC and updated DGFT profile are key prerequisites for e-RCMC application.'
                },
                {
                  title: 'Covered Plastic Export Activity',
                  desc: 'Your mainstream business should relate to plastic products represented by the council.'
                },
                {
                  title: 'Correct Applicant & Signatory Details',
                  desc: 'Entity and authorized-signatory information should match IEC, PAN and DGFT records.'
                },
                {
                  title: 'Applicable Membership Category',
                  desc: 'Membership fee and status can vary depending on exporter type, turnover and current council rules.'
                },
                {
                  title: 'Pre-Registration Eligibility Check',
                  desc: 'We review your exporter profile before filing and tell you what is required for the correct route.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Commonly Required for PLEXCONCIL / RCMC
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your PLEXCONCIL registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Active IEC-linked exporter details and DGFT profile information for the e-RCMC process.'
                },
                {
                  title: 'PAN & Business Constitution Details',
                  desc: 'PAN and entity information for proprietorship, partnership, LLP, company or other eligible exporter structure.'
                },
                {
                  title: 'Registered Business Address',
                  desc: 'Current business address and supporting records aligned with the exporter profile.'
                },
                {
                ...
                {
                  title: 'Plastic Product & Export Details',
                  desc: 'Information about product categories, HS codes and export activity relevant to PLEXCONCIL membership.'
                },
                {
                  title: 'Supporting Documents Requested by DGFT / PLEXCONCIL',
                  desc: 'Any declarations, turnover records, manufacturer proof or other supporting documents required for the selected membership category.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step PLEXCONCIL / RCMC Process
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'We review your plastic product line, IEC and exporter category to confirm the likely PLEXCONCIL / RCMC route.'
                },
                {
                  step: 'Step 2',
                  title: 'DGFT Profile & Document Check',
                  desc: 'Verify DGFT access, IEC-linked details, entity documents and signatory readiness before application.'
                },
                {
                  step: 'Step 3',
                  title: 'Select Council / Membership Category',
                  desc: 'Identify PLEXCONCIL and the correct exporter category based on your plastic export activity.'
                },
                {
                  step: 'Step 4',
                  title: 'Prepare & Submit e-RCMC Application',
                  desc: 'Complete the DGFT e-RCMC application and provide the required supporting details and documents.'
                },
                {
                  step: 'Step 5',
                  title: 'Digital Authentication & Clarification Support',
                  desc: 'Complete DSC/Aadhaar e-Sign and address any clarification or correction raised during processing.'
                },
                {
                  step: 'Step 6',
                  title: 'RCMC & Export Growth Guidance',
                  desc: 'After successful registration, receive guidance on PLEXCONCIL member benefits and related export-compliance steps.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an PLEXCONCIL depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the PLEXCONCIL structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate PLEXCONCIL structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, PLEXCONCILs must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Maintain Membership / Subscription',
                  desc: 'Pay applicable membership or subscription charges within the notified schedule to keep member services active.'
                },
                {
                  title: 'Keep RCMC Details Current',
                  desc: 'File renewal or amendment through DGFT e-RCMC when required.'
                },
                {
                  title: 'Update IEC / Business Changes',
                  desc: 'Keep address, entity, branch and authorized-signatory details aligned across IEC, DGFT and export records.'
                },
                {
                  title: 'Use Trade Leads & Fair Opportunities',
                  desc: 'Track PLEXCONCIL trade enquiries, exhibitions and networking opportunities relevant to your target markets.'
                },
                {
                  title: 'Maintain GST / Customs / Banking Compliance',
                  desc: 'PLEXCONCIL membership does not replace GST, customs, AD Code, shipping or banking requirements.'
                },
                {
                  title: 'Use Council Certificates & Member Services',
                  desc: 'Eligible members can use council services such as Certificate of Origin, Export Turnover Certificate and other export support.'
                },
                {
                  title: 'akshayb2bsolutions Ongoing Export Support',
                  desc: 'We can assist with RCMC renewal, IEC, AD Code, GST, EPR and other export-readiness registrations.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                PLEXCONCIL vs Other Business Structures
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on PLEXCONCIL structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for PLEXCONCILs in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              PLEXCONCIL tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on PLEXCONCIL Structure',
                  desc: 'Tax liability and exemptions depend on whether the PLEXCONCIL is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible PLEXCONCILs must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working members / trustees are taxable in the founder / trustee\'s hands but deductible for the PLEXCONCIL, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible PLEXCONCILs should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the PLEXCONCIL structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              PLEXCONCILs generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible PLEXCONCILs may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, PLEXCONCILs may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an PLEXCONCIL; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound PLEXCONCIL deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your PLEXCONCIL with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their PLEXCONCIL with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
