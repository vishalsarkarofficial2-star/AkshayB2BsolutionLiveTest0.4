...
interface MPEDARegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — MPEDA exporter registration focused
const FAQ_ITEMS = [
  { q: 'What is MPEDA Registration?', a: 'MPEDA Registration is the statutory registration required for eligible exporters of marine products in India under the Marine Products Export Development Authority Act, 1972 and applicable MPEDA Rules.' },
  { q: 'Who needs MPEDA Registration?', a: 'Businesses exporting marine products may need to register with MPEDA. Exporter categories include Manufacturer Exporter, Merchant Exporter, Route through Merchant Exporter and Ornamental Fish Exporter, subject to eligibility and documentation.' },
  { q: 'Is IEC required before applying for MPEDA Registration?', a: 'Yes. A valid Importer Exporter Code (IEC) issued by DGFT is a prerequisite for registration as an exporter with MPEDA.' },
  { q: 'What documents are generally required?', a: 'Requirements vary by exporter category but commonly include IEC, PAN/address proof, applicant photograph, bank financial-soundness certificate and category-specific documents such as approved processing or handling facility records and agreements.' },
  { q: 'Can MPEDA issue RCMC for seafood exporters?', a: 'Yes. MPEDA is the designated authority to issue Registration-cum-Membership Certificate (RCMC) for exporters of seafood items. Exporters can apply for RCMC after MPEDA exporter registration.' },
  { q: 'Is MPEDA registration mandatory for commercial marine-product exports?', a: 'MPEDA states that registration as an exporter is mandatory for commercial export of marine products, subject to limited exceptions provided under the applicable rules.' }
]

// Related marine-export and compliance services
const RELATED_SERVICES = [
  {
    title: 'IEC Registration',
    desc: 'Get your Import Export Code from DGFT — the essential first step before MPEDA exporter registration.',
  ...
  },
  {
    ...
    desc: 'Get assistance for Registration-cum-Membership Certificate after completing the required exporter registration.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'EIA Approval Support',
    desc: 'Documentation guidance for seafood processing/export units that need Export Inspection Agency approval.',
    img: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'ICEGATE Registration',
    desc: 'Customs portal registration support for digital filing and export documentation.',
  ...
  },
  {
    ...
    desc: 'GST registration and compliance support for export-oriented businesses in India.',
...
export const MPEDARegistrationPage: React.FC<MPEDARegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('MPEDA Exporter Registration Assistance — Custom Quote');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">MPEDA Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span className="text-white">Pan-India Marine Export Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start your seafood export registration with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Get a custom quote based on your exporter category
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  MPEDA Registration in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an MPEDA may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>4 Exporter Categories</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our marine-export compliance specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your MPEDA registering office, exporter category and document requirements depend on your registered/head-office location and the type of marine-export activity.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get exporter-category guidance, IEC and document review, MPEDA application assistance, deficiency-response support and step-by-step compliance guidance.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>
                                <label className="block text-xs font-bold text-slate-700 mb-1">
                                  Marine Export / Business Activity *
                                </label>
                                <select
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select MPEDA Assistance Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="MPEDA Registration Package (Contact for Price)">MPEDA Registration Package — Contact for Price MPEDA / Govt. Chargess</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Marine Exporter Assistance
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                MPEDA Exporter Registration Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused package designed for seafood exporters who want a guided route from IEC and document readiness to MPEDA registration and connected export-compliance support.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">MPEDA Exporter Launch Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Built for marine-product exporters who want fewer filing errors, clearer documentation and dedicated guidance through the MPEDA registration process.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      ...
                      'MPEDA Online Filing Support',
                      'Basic MPEDA Name Availability Check',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('MPEDA Registration Package (Contact for Price)');
                ...
                >
                  Get Started with MPEDA Exporter Launch Package
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is MPEDA Registration?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              MPEDA registration enables eligible businesses to register as exporters of marine products under the statutory framework administered by the Marine Products Export Development Authority.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for businesses exporting frozen, canned, freeze-dried, live, dried or chilled marine products, ornamental fish and other eligible edible or non-edible marine products.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The correct exporter category matters. MPEDA recognizes Manufacturer Exporter, Merchant Exporter, Route through Merchant Exporter and Ornamental Fish Exporter.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Manufacturer exporters generally operate through approved processing or handling facilities, while merchant exporters use approved surplus processing or handling capacity subject to prescribed agreements and documents.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  MPEDA states that commercial exporters of marine products must be registered with the Authority, subject to the limited exceptions provided in the rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  After exporter registration, eligible seafood exporters can also apply for MPEDA RCMC and access connected export services such as certificates and market-support services.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, MPEDA registration is a key compliance step for marine-product exporters. Our team helps organize documents, identify the right category, file the application and respond to registration queries.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How MPEDA Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              MPEDA exporter registration is completed through the Authority's online registration system. A valid IEC from DGFT is the prerequisite before applying as a marine-products exporter.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              The concerned MPEDA office scrutinizes the documents, raises discrepancies where required and, once the application is found in order and approved by the competent authority, issues the exporter registration certificate.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our marine-export compliance desk helps review IEC, exporter-category documents, processing/handling facility records and supporting KYC before application filing and follow-up.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Benefits of MPEDA Exporter Registration
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Statutory Exporter Registration', desc: 'Complete the core MPEDA registration required for eligible commercial exporters of marine products in India.' },
                { title: 'Correct Exporter Category', desc: 'Get guidance on Manufacturer, Merchant, Route through Merchant or Ornamental Fish Exporter classification.' },
                { title: 'RCMC Eligibility Path', desc: 'After MPEDA exporter registration, eligible seafood exporters can proceed to MPEDA RCMC formalities.' },
                { title: 'Stronger Export Readiness', desc: 'Organised exporter KYC, IEC, processing-facility and bank documents help create a cleaner application file.' },
                { title: 'Connected Export Services', desc: 'Registered exporters can access relevant MPEDA e-services, certificates, market information and export support tools subject to eligibility.' },
                { title: 'Dedicated Filing Support', desc: 'Professional review can reduce preventable mismatches, missing documents and avoidable registration queries.' }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before MPEDA Registration
              </h2>
            </div>

            <div className="space-y-3">
              {[
                { title: 'Valid IEC from DGFT', desc: 'IEC is the prerequisite for registration as an exporter with MPEDA.' },
                { title: 'Choose the Correct Exporter Category', desc: 'Identify whether your application is Manufacturer, Merchant, Route through Merchant or Ornamental Fish Exporter.' },
                { title: 'Marine Product Category', desc: 'Keep the type of marine products you plan to export clearly identified for the application.' },
                { title: 'Applicant Photo & Address Proof', desc: 'Prepare the applicant photograph and accepted proof of address / identity as required.' },
                { title: 'Bank Financial-Soundness Certificate', desc: 'Keep the prescribed certificate from a Scheduled Bank ready where applicable.' },
                { title: 'Processing / Handling Facility Documents', desc: 'Merchant and manufacturer exporters should prepare the relevant approved plant, handling or storage documents required for their category.' },
                { title: 'Category-Specific Agreements / Undertakings', desc: 'Merchant exporters may need agreements, joint undertakings and facility endorsements depending on the application.' },
                { title: 'Pre-Filing Verification', desc: 'Our team checks the document set and exporter category before submission to reduce avoidable deficiencies.' }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for MPEDA Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a MPEDA in India, there must be a minimum of two members / trustees and a maximum of twenty. All members / trustees must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                { title: 'Marine Products Export Activity', desc: 'The applicant should be engaged in, or preparing for, eligible marine-product export activity.' },
                { title: 'Valid IEC', desc: 'A DGFT-issued Importer Exporter Code is required before applying for MPEDA exporter registration.' },
                { title: 'Appropriate Exporter Category', desc: 'Eligibility and documentation differ for Manufacturer, Merchant, Route through Merchant and Ornamental Fish Exporters.' },
                { title: 'Approved Facility Linkage Where Required', desc: 'Manufacturer and merchant applications may require approved processing, handling or storage facility documentation.' },
                { title: 'Business & Applicant KYC', desc: 'Entity information, address proof, applicant details and authorization should be consistent and current.' },
                { title: 'Additional Local / Regulatory Approvals', desc: 'Manufacturer exporters and processing units may require GST, local-body approvals and Pollution Control Board consent as applicable.' },
                { title: 'Application Readiness Review', desc: 'akshayb2bsolutions reviews the application profile and supporting records before filing.' }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your MPEDA registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Importer Exporter Code (IEC)', desc: 'Copy / details of the valid IEC issued by DGFT.' },
                { title: 'Applicant Photograph & Address Proof', desc: 'Passport-size photograph and accepted proof such as PAN, Voter ID or Passport, as applicable.' },
                { title: 'Scheduled Bank Certificate', desc: 'Certificate from a Scheduled Bank showing financial soundness where prescribed.' },
                { title: 'Processing / Handling Facility Records', desc: 'Approved processing plant, handling facility or storage-premises registration records as required by exporter category.' },
                { title: 'Merchant Exporter Agreements', desc: 'Written agreement, joint undertaking and facility endorsement documents where required for Merchant Exporter registration.' },
                { title: 'Additional Category-Specific Documents', desc: 'Purchase orders, DGFT approval for Route through Merchant Exporter, bank guarantee or other prescribed records depending on the application.' }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step MPEDA Registration Process
              </h2>
            </div>

            <div className="space-y-4">
              {[
                { step: 'Step 1', title: 'Obtain / Verify IEC', desc: 'Confirm that the applicant has a valid IEC issued by DGFT before starting the MPEDA exporter application.' },
                { step: 'Step 2', title: 'Select Exporter Category', desc: 'Identify Manufacturer, Merchant, Route through Merchant or Ornamental Fish Exporter based on the business model.' },
                { step: 'Step 3', title: 'Prepare Documents', desc: 'Compile applicant KYC, bank certificate, facility records and category-specific agreements or approvals.' },
                { step: 'Step 4', title: 'Submit Online MPEDA Application', desc: 'Complete the online application with prescribed particulars, documents and applicable official fees.' },
                { step: 'Step 5', title: 'Scrutiny & Clarification', desc: 'The concerned MPEDA office scrutinizes the application and may seek correction or additional information.' },
                { step: 'Step 6', title: 'Approval & Registration Certificate', desc: 'Once the application is found in order and approved by the competent authority, the exporter registration certificate is issued.' }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an MPEDA depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the MPEDA structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate MPEDA structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, MPEDAs must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the MPEDA\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered MPEDA name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual MPEDA Compliance & Tax Filing',
                  desc: 'File the MPEDA\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the MPEDA employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                MPEDA vs Other Business Structures
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on MPEDA structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for MPEDAs in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              MPEDA tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on MPEDA Structure',
                  desc: 'Tax liability and exemptions depend on whether the MPEDA is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible MPEDAs must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working members / trustees are taxable in the founder / trustee\'s hands but deductible for the MPEDA, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible MPEDAs should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the MPEDA structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              MPEDAs generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible MPEDAs may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, MPEDAs may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an MPEDA; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound MPEDA deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Start Your MPEDA Registration with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Turn your seafood export plan into an application-ready file with dedicated document review, exporter-category guidance and end-to-end MPEDA registration support.
            </p>
